...
class AssistantModel:
    ...
    def _chat_single(
        ...
        chat_request = (
            ChatRequest(messages=messages, filter=filter,
                        model=model, json_response=json_response)
            if filter
    ...
    def context(self, query: Optional[str] = None, messages: Union[List[Message], List[RawMessage]] = None, filter: Optional[dict[str, any]] = None):
        """
