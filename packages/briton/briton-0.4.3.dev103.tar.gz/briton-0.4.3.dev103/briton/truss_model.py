...
from briton.proto import LookaheadDecodingConfig, PromptLookupDecodingConfig
...
class Model:
    def __init__(self, **kwargs):
        ...
        self._prompt_lookup_decoding_config = _prompt_lookup_decoding_config(model_metadata)
    ...
    def load(self):
        ...
        self._briton_interactor.load(
            ...
            prompt_lookup_decoding_config=self._prompt_lookup_decoding_config,
        )
    ...
    async def predict(self, model_input: Dict[str, Any], request: fastapi.Request):
        ...
        if not self._lazy_init_done:
            ...
            async with self._lazy_init_lock:
                ...
                # Not sure how monitor will interact with prompt lookup, just disable
...
def _prompt_lookup_decoding_config(model_metadata: dict) -> Optional[PromptLookupDecodingConfig]:
    if "prompt_lookup_decoding_config" in model_metadata:
        return PromptLookupDecodingConfig(**model_metadata["prompt_lookup_decoding_config"])
    return None
