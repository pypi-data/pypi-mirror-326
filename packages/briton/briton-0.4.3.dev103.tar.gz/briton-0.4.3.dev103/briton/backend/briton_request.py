...
from briton.proto import FinishReason, InferenceAnswerPart, InferenceRequest, LookaheadDecodingConfig, PromptLookupDecodingConfig
...
async def model_input_to_briton_request(
    ...
    if model_input.prompt_lookup_decoding_config is not None:
        request.prompt_lookup_decoding_config.CopyFrom(
            PromptLookupDecodingConfig(
                min_ngram_size=model_input.prompt_lookup_decoding_config.min_ngram_size,
                max_ngram_size=model_input.prompt_lookup_decoding_config.max_ngram_size,
                max_draft_tokens=model_input.prompt_lookup_decoding_config.max_draft_tokens,
            )
        )
