...
@typing.final
class PromptLookupDecodingConfig(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    MIN_NGRAM_SIZE_FIELD_NUMBER: builtins.int
    MAX_NGRAM_SIZE_FIELD_NUMBER: builtins.int
    MAX_DRAFT_TOKENS_FIELD_NUMBER: builtins.int
    min_ngram_size: builtins.int
    max_ngram_size: builtins.int
    max_draft_tokens: builtins.int
    def __init__(
        self,
        *,
        min_ngram_size: builtins.int = ...,
    ...
    def ClearField(self, field_name: typing.Literal["max_draft_tokens", b"max_draft_tokens", "max_ngram_size", b"max_ngram_size", "min_ngram_size", b"min_ngram_size"]) -> None: ...

global___PromptLookupDecodingConfig = PromptLookupDecodingConfig
...
class InferenceRequest(google.protobuf.message.Message):
    ...
    PROMPT_LOOKUP_DECODING_CONFIG_FIELD_NUMBER: builtins.int
    ...
    @property
    def prompt_lookup_decoding_config(self) -> global___PromptLookupDecodingConfig: ...
    def __init__(
        self,
        *,
        request_id: builtins.int = ...,
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_prompt_lookup_decoding_config", b"_prompt_lookup_decoding_config"]) -> typing.Literal["prompt_lookup_decoding_config"] | None: ...
    @typing.overload
