...
from briton.proto import AddedTokens, BritonConfig, LookaheadDecodingConfig, PromptLookupDecodingConfig
...
def create_briton_config_pbtxt(
    ...
    prompt_lookup_decoding_config: Optional[PromptLookupDecodingConfig] = None,
):
    briton_config = BritonConfig(
        ...
        prompt_lookup_decoding_config=prompt_lookup_decoding_config,
    )
