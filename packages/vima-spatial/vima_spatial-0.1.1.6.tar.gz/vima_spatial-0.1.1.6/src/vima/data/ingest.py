...
def get_sumstats_nonst(norm_by_negctrls, pixels):
    _, pixels = norm_by_negctrls(pixels)
...
def normalize_allsamples(pixelsdir, masksdir, outdir, sids, get_sumstats=None, normalize=None):
