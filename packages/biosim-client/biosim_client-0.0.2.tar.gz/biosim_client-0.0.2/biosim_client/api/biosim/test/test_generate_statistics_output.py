...
class TestGenerateStatisticsOutput(unittest.TestCase):
    """GenerateStatisticsOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateStatisticsOutput:
        """Test GenerateStatisticsOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GenerateStatisticsOutput`
        """
        model = GenerateStatisticsOutput()
        if include_optional:
            return GenerateStatisticsOutput(
                sims_run_info = [
    ...
    def testGenerateStatisticsOutput(self):
        """Test GenerateStatisticsOutput"""
