...
class TestOmexVerifyWorkflowOutput(unittest.TestCase):
    """OmexVerifyWorkflowOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OmexVerifyWorkflowOutput:
        """Test OmexVerifyWorkflowOutput
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `OmexVerifyWorkflowOutput`
        """
        model = OmexVerifyWorkflowOutput()
        if include_optional:
            return OmexVerifyWorkflowOutput(
                workflow_id = '',
                workflow_input = biosim_client.api.biosim.models.omex_verify_workflow_input.OmexVerifyWorkflowInput(
    ...
    def testOmexVerifyWorkflowOutput(self):
        """Test OmexVerifyWorkflowOutput"""
