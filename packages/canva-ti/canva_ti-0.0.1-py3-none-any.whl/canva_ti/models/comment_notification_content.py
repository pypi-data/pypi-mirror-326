...
class CommentNotificationContent(BaseModel):
    ...
    comment_url: StrictStr = Field(description="A URL to the design, focused on the new comment.")
    comment: CommentEvent
    __properties: ClassVar[List[str]] = ["type", "triggering_user", "receiving_team_user", "design", "comment_url", "comment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "comment": CommentEvent.from_dict(obj["comment"]) if obj.get("comment") is not None else None
        })
        return _obj
