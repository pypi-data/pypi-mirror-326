...
class CustomDesignTypeInput(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr
    width: StrictInt = Field(description="The width of the design (in pixels). Minimum 40px, maximum 8000px.")
    height: StrictInt = Field(description="The height of the design (in pixels). Minimum 40px, maximum 8000px.")
