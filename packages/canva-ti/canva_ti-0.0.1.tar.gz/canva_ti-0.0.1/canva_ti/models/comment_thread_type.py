...
class CommentThreadType(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr
    message: StrictStr = Field(description="The comment's message. Any user mentions are shown in the format `[user_id:team_id]`.")
    mentions: Dict[str, Any] = Field(description="The Canva users mentioned in the comment.")
    assignee: Optional[User] = None
    resolver: Optional[User] = None
    __properties: ClassVar[List[str]] = ["type", "message", "mentions", "assignee", "resolver"]
