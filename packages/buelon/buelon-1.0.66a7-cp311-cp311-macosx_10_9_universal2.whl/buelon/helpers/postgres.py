...
import asyncio
import datetime
from typing import Union, List, Dict, Any, Optional, Callable, Optional, Callable, Dict, List, Union, AsyncGenerator
...
class Postgres:
    ...
    def download_table(self, table_name: str = None, columns='*', suffix='', sql=None, stream=False, callback=None):
        """
        ...
        with psycopg2.connect(
            ...
            if not stream and callback is None:
    ...
    ) -> Union[List[Dict], AsyncGenerator]:
        """
