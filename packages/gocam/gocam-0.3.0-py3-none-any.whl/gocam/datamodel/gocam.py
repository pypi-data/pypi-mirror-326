...
class ProvenanceInfo(ConfiguredBaseModel):
    ...
    contributor: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'alias': 'contributor',
    ...
    provided_by: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'alias': 'provided_by',
         'domain_of': ['ProvenanceInfo'],
