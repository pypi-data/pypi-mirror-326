from os import getenv, uname, path, getlogin
...
SECURE_SSL_REDIRECT = getenvBool("SECURE_SSL_REDIRECT", True)
PIWIK_URL = getenv("PIWIK_URL", '')
PIWIK_SITE_ID = getenv("PIWIK_SITE_ID", '')
SECURE_SSL_REDIRECT = getenvBool("SECURE_SSL_REDIRECT", True)

# [database] section: database settings
DATABASE_NAME = getenv("DATABASE_NAME", 'piprints')
DATABASE_USER = getenv("DATABASE_USER", USERNAME)
DATABASE_PASSWORD = getenv("DATABASE_PASSWORD", '')
DATABASE_HOST = getenv("DATABASE_HOST", '')
DATABASE_PORT = getenv("DATABASE_PORT", '')
DATABASE_ENGINE = getenv("DATABASE_ENGINE", 'postgresql_psycopg2')
