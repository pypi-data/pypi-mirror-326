...
urlpatterns += [
    ...
    path('event/<int:id>/registration', views.event_registration_page),
    path('event/<int:id>/participants', views.event_participants_page),
    path('event/<int:id>/timetable', views.event_timetable_page),
    path('event/<int:id>/speakers', views.event_speakers_page),
    ...
    path('people/<str:model_name>', views.old_people_page),
    path('request/<str:model_name>', views.request_page),
    path('person_requests/<str:model_name>', views.person_requests),
...
if INSTANCE == 'gecogedi':
    urlpatterns += [
        path('research/', views.default_page),
    ]

#router = routers.DefaultRouter()
#router.register(r'papers', api_views.PaperViewSet)
