...
from Mapping.Router import Router28nm
from Mapping.lb2_weight import Weight28nm
...
class Graph28nm():
    ...
    def gen_bin_data(self, download_dir):
        ...
        # weight data dump
        t0 = time.time()
        weight = Weight28nm(self.connection_matrix,
        ...
        # route data dump
        router = Router28nm(self.config, self.neuron_num)
