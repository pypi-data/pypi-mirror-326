...
class DatabasesApi:
    ...
    def v1_databases_id_get(
        ...
        _param = self._v1_databases_id_get_serialize(
            id=id,
    ...
    @validate_call
    def v1_databases_id_get_with_http_info(
        self,
        id: StrictStr,
        notion_version: Optional[StrictStr] = None,
        request_timeout__: Union[
    ...
    @validate_call
    def v1_databases_id_get_without_preload_content(
        self,
        id: StrictStr,
        notion_version: Optional[StrictStr] = None,
        request_timeout__: Union[
    ...
    def _v1_databases_id_get_serialize(
        self,
        id,
        notion_version,
        request_auth__,
    ...
    def v1_databases_id_patch(
        ...
        _param = self._v1_databases_id_patch_serialize(
            id=id,
            notion_version=notion_version,
            body=body,
            request_auth__=request_auth__,
    ...
    @validate_call
    def v1_databases_id_patch_with_http_info(
        self,
        id: StrictStr,
        notion_version: Optional[StrictStr] = None,
        body: Optional[Dict[str, Any]] = None,
    ...
    @validate_call
    def v1_databases_id_patch_without_preload_content(
        self,
        id: StrictStr,
        notion_version: Optional[StrictStr] = None,
        body: Optional[Dict[str, Any]] = None,
    ...
    def _v1_databases_id_patch_serialize(
        self,
        id,
        notion_version,
        body,
    ...
    @validate_call
    def v1_databases_id_query_post(
        self,
        id: StrictStr,
        ...
        _param = self._v1_databases_id_query_post_serialize(
            id=id,
    ...
    @validate_call
    def v1_databases_id_query_post_with_http_info(
        self,
        id: StrictStr,
        authorization: Optional[StrictStr] = None,
        content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def v1_databases_id_query_post_without_preload_content(
        self,
        id: StrictStr,
        authorization: Optional[StrictStr] = None,
        content_type: Optional[StrictStr] = None,
    ...
    def _v1_databases_id_query_post_serialize(
        self,
        id,
        authorization,
        content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/databases/{id}/query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def v1_databases_post(
        ...
        _param = self._v1_databases_post_serialize(
            content_type=content_type,
            notion_version=notion_version,
            body=body,
            request_auth__=request_auth__,
    ...
    @validate_call
    def v1_databases_post_with_http_info(
        self,
        content_type: Optional[StrictStr] = None,
        notion_version: Optional[StrictStr] = None,
        body: Optional[Dict[str, Any]] = None,
    ...
    @validate_call
    def v1_databases_post_without_preload_content(
        self,
        content_type: Optional[StrictStr] = None,
        notion_version: Optional[StrictStr] = None,
        body: Optional[Dict[str, Any]] = None,
    ...
    def _v1_databases_post_serialize(
        self,
        content_type,
        notion_version,
        body,
