...
class PagesApi:
    ...
    def v1_pages_id_get(
        ...
        _param = self._v1_pages_id_get_serialize(
            id=id,
    ...
    @validate_call
    def v1_pages_id_get_with_http_info(
        self,
        id: StrictStr,
        notion_version: Optional[StrictStr] = None,
        : Optional[StrictStr] = None,
    ...
    @validate_call
    def v1_pages_id_get_without_preload_content(
        self,
        id: StrictStr,
        notion_version: Optional[StrictStr] = None,
        : Optional[StrictStr] = None,
    ...
    def _v1_pages_id_get_serialize(
        self,
        id,
        notion_version,
        ,
    ...
    def v1_pages_id_patch(
        ...
        _param = self._v1_pages_id_patch_serialize(
            id=id,
            notion_version=notion_version,
            body=body,
            request_auth__=request_auth__,
    ...
    @validate_call
    def v1_pages_id_patch_with_http_info(
        self,
        id: StrictStr,
        notion_version: Optional[StrictStr] = None,
        body: Optional[Dict[str, Any]] = None,
    ...
    @validate_call
    def v1_pages_id_patch_without_preload_content(
        self,
        id: StrictStr,
        notion_version: Optional[StrictStr] = None,
        body: Optional[Dict[str, Any]] = None,
    ...
    def _v1_pages_id_patch_serialize(
        self,
        id,
        notion_version,
        body,
    ...
    @validate_call
    def v1_pages_page_id_properties_property_id_get(
        self,
        page_id: StrictStr,
        ...
        _param = self._v1_pages_page_id_properties_property_id_get_serialize(
            page_id=page_id,
    ...
    @validate_call
    def v1_pages_page_id_properties_property_id_get_with_http_info(
        self,
        page_id: StrictStr,
        property_id: StrictStr,
        notion_version: Optional[StrictStr] = None,
    ...
    @validate_call
    def v1_pages_page_id_properties_property_id_get_without_preload_content(
        self,
        page_id: StrictStr,
        property_id: StrictStr,
        notion_version: Optional[StrictStr] = None,
    ...
    def _v1_pages_page_id_properties_property_id_get_serialize(
        self,
        page_id,
        property_id,
        notion_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/pages/{page_id}/properties/{property_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
