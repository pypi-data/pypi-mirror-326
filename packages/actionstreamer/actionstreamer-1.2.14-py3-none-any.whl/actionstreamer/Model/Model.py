...
class EventPreset:
    ...
    def __init__(self, deviceID: int = 0, agentTypeID: int = 0, eventTypeID: int = 0, eventParameters: str = '', eventPresetName: str = '', priority: int = 1, maxAttempts: int = 5, expirationEpoch: int = 0, **kwargs):
        self.deviceID = deviceID
        self.agentTypeID = agentTypeID
        self.eventTypeID = eventTypeID
        self.eventParameters = eventParameters
