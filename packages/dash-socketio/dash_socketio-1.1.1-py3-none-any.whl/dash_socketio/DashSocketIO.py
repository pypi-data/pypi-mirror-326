...
- url (string; optional):
    ...
    _type = 'DashSocketIO'
    @_explicitize_args
    def __init__(self, url=Component.UNDEFINED, options=Component.UNDEFINED, eventNames=Component.UNDEFINED, connected=Component.UNDEFINED, socketId=Component.UNDEFINED, id=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'connected', 'eventNames', 'options', 'socketId', 'url']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'connected', 'eventNames', 'options', 'socketId', 'url']
