...
def load(fileName,**kwargs):
	...
	if analyzer=="PhoibosSpin" and scanIdentified==False:
		...
		if is_an_EDC==True:
			...
			loadedSpectrum['Axis'][1]=np.array(sorted([int(ii) for ii in uniqueParameterValues['Step']]))
	...
	if analyzer=="PhoibosSpin" and scanIdentified==False:
		...
		if is_a_spin_image==True:
			...
			loadedSpectrum['Axis'][2]=np.array(sorted([int(ii) for ii in uniqueParameterValues['Step']]))
