...
try:	import scipy
except ImportError: print("\t(ERROR): Couldn't import the scipy module. This is required for basic functionality. Install it with the command 'pip install scipy'")
...
def kwarp(spectrum,Eb_offset=getAnalyzerWorkFunction(), polar_offset=0,tilt_offset=0,hv=0,resolutionDivider=1,corrected_hvAxis=[],beQuiet=False):
