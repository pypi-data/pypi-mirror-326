...
with random_vinkesh_ti.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = random_vinkesh_ti.PetApi(api_client)
    pet = random_vinkesh_ti.Pet() # Pet | Create a new pet in the store
