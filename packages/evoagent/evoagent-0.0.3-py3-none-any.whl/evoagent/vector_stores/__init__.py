...
def QdrantVectorStore(*args, **kwargs):
    ...
    from evoagent.vector_stores.qdrant import QdrantVectorStore as _QdrantVectorStore
    return _QdrantVectorStore(*args, **kwargs)

def QdrantWrapper(*args, **kwargs):
    """Factory function for creating a QdrantWrapper instance."""
    from evoagent.vector_stores.qdrant import QdrantWrapper as _QdrantWrapper
