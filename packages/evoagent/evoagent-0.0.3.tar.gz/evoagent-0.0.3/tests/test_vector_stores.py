from evoagent.vector_stores.qdrant import QdrantVectorStore, QdrantWrapper
...
class TestQdrantVectorStore(unittest.TestCase):
    def setUp(self):
        ...
        with patch('evoagent.vector_stores.qdrant.QdrantWrapper') as mock_wrapper_class:
            mock_wrapper_class.return_value = self.mock_wrapper
            self.vector_store = QdrantVectorStore()

    def test_initialization_default(self):
        """Test initialization with default parameters."""
        with patch('evoagent.vector_stores.qdrant.QdrantWrapper') as mock_wrapper:
    ...
    def test_wrapper_initialization(self):
        ...
        with patch('evoagent.vector_stores.qdrant.QdrantClient') as mock_client:
