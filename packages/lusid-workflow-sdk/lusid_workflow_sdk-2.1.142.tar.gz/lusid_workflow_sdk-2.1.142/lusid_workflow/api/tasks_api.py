...
class TasksApi:
    ...
    @overload
    async def delete_task(self, id : Annotated[constr(strict=True, max_length=36, min_length=36), Field(..., description="The identifier for the Task to be deleted.")], **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...

    @overload
    def delete_task(self, id : Annotated[constr(strict=True, max_length=36, min_length=36), Field(..., description="The identifier for the Task to be deleted.")], async_req: Optional[bool]=True, **kwargs) -> DeletedEntityResponse:  # noqa: E501
        ...

    @validate_arguments
    def delete_task(self, id : Annotated[constr(strict=True, max_length=36, min_length=36), Field(..., description="The identifier for the Task to be deleted.")], async_req: Optional[bool]=None, **kwargs) -> Union[DeletedEntityResponse, Awaitable[DeletedEntityResponse]]:  # noqa: E501
    ...
    @validate_arguments
    def delete_task_with_http_info(self, id : Annotated[constr(strict=True, max_length=36, min_length=36), Field(..., description="The identifier for the Task to be deleted.")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] DeleteTask: Delete a Task  # noqa: E501
