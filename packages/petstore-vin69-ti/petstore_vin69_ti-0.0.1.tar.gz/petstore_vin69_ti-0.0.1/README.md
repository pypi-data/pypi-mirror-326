...
with petstore_vin69_ti.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = petstore_vin69_ti.PetApi(api_client)
    pet = petstore_vin69_ti.Pet() # Pet | Create a new pet in the store
