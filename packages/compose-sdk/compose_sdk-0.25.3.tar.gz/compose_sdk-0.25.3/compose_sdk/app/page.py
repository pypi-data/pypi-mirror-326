...
class Page:
    ...
    def add(
        ...
        if self.__debug:
            if key:
                log_debug("Page", f"add section: {key}")
            else:
                log_debug("Page", "add")
    ...
    def modal(
        ...
        *,
        ...
        if self.__debug:
            if key:
                log_debug("Page", f"modal: {key}")
            else:
                log_debug("Page", "modal")
