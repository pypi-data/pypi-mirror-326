...
class FilesUploadErrorSchema(BaseModel):
    """
    ...
    def error_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['posting_to_general_channel_denied', 'invalid_channel', 'file_uploads_disabled', 'file_upload_size_restricted', 'file_uploads_except_images_disabled', 'storage_limit_reached', 'not_authed', 'invalid_auth', 'account_inactive', 'no_permission', 'invalid_arg_name', 'invalid_array_arg', 'invalid_charset', 'invalid_form_data', 'invalid_post_type', 'missing_post_type', 'team_added_to_org', 'invalid_json', 'json_not_object', 'request_timeout', 'upgrade_required']):
            raise ValueError("must be one of enum values ('posting_to_general_channel_denied', 'invalid_channel', 'file_uploads_disabled', 'file_upload_size_restricted', 'file_uploads_except_images_disabled', 'storage_limit_reached', 'not_authed', 'invalid_auth', 'account_inactive', 'no_permission', 'invalid_arg_name', 'invalid_array_arg', 'invalid_charset', 'invalid_form_data', 'invalid_post_type', 'missing_post_type', 'team_added_to_org', 'invalid_json', 'json_not_object', 'request_timeout', 'upgrade_required')")
        return value
