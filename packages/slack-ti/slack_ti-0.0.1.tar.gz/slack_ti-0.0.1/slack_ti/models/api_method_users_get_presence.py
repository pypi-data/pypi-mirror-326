...
class APIMethodUsersGetPresence(BaseModel):
    ...
    """ # noqa: E501
    auto_away: Optional[StrictBool] = None
    connection_count: Optional[StrictInt] = None
    last_activity: Optional[StrictInt] = None
    manual_away: Optional[StrictBool] = None
    ok: StrictBool
    online: Optional[StrictBool] = None
    presence: StrictStr
    __properties: ClassVar[List[str]] = ["auto_away", "connection_count", "last_activity", "manual_away", "ok", "online", "presence"]
