...
class ObjsUserProfileShort(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["avatar_hash", "display_name", "display_name_normalized", "image_72", "is_restricted", "is_ultra_restricted", "name", "real_name", "real_name_normalized", "team"]
