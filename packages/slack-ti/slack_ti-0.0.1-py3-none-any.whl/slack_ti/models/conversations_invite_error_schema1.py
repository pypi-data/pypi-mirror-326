...
class ConversationsInviteErrorSchema1(BaseModel):
    """
    ...
    errors: Optional[Annotated[List[Dict[str, Any]], Field(min_length=1)]] = None
    needed: Optional[StrictStr] = None
    ok: StrictBool
    provided: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["callstack", "error", "errors", "needed", "ok", "provided"]
