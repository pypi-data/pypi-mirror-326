...
class MigrationExchangeSuccessSchema(BaseModel):
    ...
    """ # noqa: E501
    enterprise_id: StrictStr
    invalid_user_ids: Optional[List[StrictStr]] = None
    ok: StrictBool
    team_id: Annotated[str, Field(strict=True)]
    user_id_map: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["enterprise_id", "invalid_user_ids", "ok", "team_id", "user_id_map"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invalid_user_ids": obj.get("invalid_user_ids"),
            "ok": obj.get("ok"),
            "team_id": obj.get("team_id"),
            "user_id_map": obj.get("user_id_map")
        })
        return _obj
