...
class TestPagesApi(unittest.TestCase):
    ...
    def test_v1_pages_id_get(self) -> None:
        """Test case for v1_pages_id_get

        Retrieve a page
        """
        pass

    def test_v1_pages_id_patch(self) -> None:
        """Test case for v1_pages_id_patch

        Archive a page
        """
        pass

    def test_v1_pages_page_id_properties_property_id_get(self) -> None:
        """Test case for v1_pages_page_id_properties_property_id_get
