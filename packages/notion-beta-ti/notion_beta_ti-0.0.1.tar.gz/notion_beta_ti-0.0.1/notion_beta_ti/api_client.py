...
from notion_beta_ti.api_response import ApiResponse, T as ApiResponseT
import notion_beta_ti.models
from notion_beta_ti import rest
from notion_beta_ti.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(notion_beta_ti.models, klass)
