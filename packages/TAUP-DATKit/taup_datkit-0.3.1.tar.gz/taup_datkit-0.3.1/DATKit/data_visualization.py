...
def generate_linechart(df, filename='linechart.svg'):
    ...
    # Plot the linechart
    plot_linechart(spectra, x, names, name=filename)


def generate_heatmap(df, metric='correlation', filename='heatmap.svg'):
    """
    ...
    # Plot the heatmap
    plot_heatmap(similarity_matrix, names, metric=metric, name=filename)
...
def generate_heatmap_list(df_list, data_groups, metric='correlation', filename='***_heatmap.svg'):
    """
    ...
    try:
        for data_group, df in zip(data_groups, df_list):
            ...
            # Plot the heatmap
            plot_heatmap(similarity_matrix, names, metric=metric, filename=filename.replace('***', data_group), title=data_group+' Heatmap')
