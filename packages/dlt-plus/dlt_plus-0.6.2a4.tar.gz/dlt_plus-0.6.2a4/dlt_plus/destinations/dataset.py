...
class WritableDataset(ReadableDBAPIDataset):
    ...
    def save(self, data: Any, table_name: str) -> LoadInfo:
        ...
        """
        resource = self.data_to_resource(data, table_name=table_name)
    ...
    def data_to_resource(self, data: Any, table_name: str) -> DltResource:
        ...
        if table_schema:
            ...
            hints = dlt.mark.make_hints(table_name=table_name)
