...
from .code_mappings import RoborockDockTypeCode, RoborockMopIntensityCode
...
class RoborockClient:
    ...
    def __init__(self, endpoint: str, device_info: DeviceData, queue_timeout: int = 4) -> None:
        ...
        self._mop_intensity_type: type[RoborockMopIntensityCode] = ModelMopIntensity.get(self.device_info.model, RoborockMopIntensityS8MaxVUltra)
    ...
    async def get_water_box_mode(self) -> RoborockMopIntensityCode | None:
        """Gets current water box mode."""
        water_box_mode = self._mop_intensity_type(RoborockMopIntensityCode(await self.cache[CacheableAttribute.water_box_mode].async_value()))
        return water_box_mode
