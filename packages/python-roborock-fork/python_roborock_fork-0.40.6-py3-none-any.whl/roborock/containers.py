...
class S7MaxVStatus(Status):
    fan_power: RoborockFanSpeedS7MaxV | None = None
    water_box_mode: RoborockMopIntensityS7 | None = None
    mop_mode: RoborockMopModeS7MaxV | None = None
...
ModelMopIntensity: dict[str, type[RoborockMopIntensityCode]] = {
    ROBOROCK_S8_MAXV_ULTRA: RoborockMopIntensityS8MaxVUltra,
    ROBOROCK_S7_MAXV: RoborockMopIntensityS7,
}
