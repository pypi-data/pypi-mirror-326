...
{cmdColor2}'vj','view journal','vwjrnl','bj','bank journal','bnk jrnl'{Style.reset} - {expColor}View Cash changes Logs{Style.reset}
{cmdColor2}'vjp','view journal paged','vwjrnlpgd','bjp','bank journal paged','bnk jrnl pgd'{Style.reset} - {expColor}View Cash Pool changes Logs with user interupts{Style.reset}
