...
\newcommand{\programlongname}{Intro Fellowship}
\newcommand{\timeperiod}{Spring 2024}
\newcommand{\chroninfo}{WEEK 5}
\newcommand{\maintitle}{Model internals}
\newcommand{\mainsubtitle}{READINGS}
