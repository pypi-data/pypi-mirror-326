...
from malevich_app.export.abstract.abstract import Init, InputCollections, AppFunctionsInfo, FunMetadata, InitRun, LogsResult, \
    LogsOperation, GetAppInfo, Run, Collection, Objects, InitPipeline, RunPipeline
...
async def put_objects(request: Request, operationId: Optional[str] = None, runId: Optional[str] = None, asset: bool = False):
