from malevich_app.export.secondary.const import CORE_HOST_PORT
...
# core
DOCS_COLLECTION = f"{CORE_HOST_PORT}/internal/run/collection/data"
OUTSIDE_COLLECTION = f"{CORE_HOST_PORT}/internal/run/collection/outside"
QUERY = f"{CORE_HOST_PORT}/internal/run/collection/query"
MAPPING_SCHEMES_NAMES = f"{CORE_HOST_PORT}/internal/run/mapping/schemes/names"
MAPPING_SCHEMES_RAW = f"{CORE_HOST_PORT}/internal/run/mapping/schemes/raw"
RUN_SCHEME = f"{CORE_HOST_PORT}/internal/run/schemes"
CREDENTIALS = f"{CORE_HOST_PORT}/internal/run/credentials"
