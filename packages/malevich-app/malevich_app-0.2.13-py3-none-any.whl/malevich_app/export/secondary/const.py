import os
import aiohttp
__core_port = os.environ.get("CORE_PORT", "8080")
__core_host = os.environ.get("CORE_HOST", "julius-core")
...
__dag_manager_index = os.environ.get("DAG_MANAGER_INDEX")
...
ENV = {"CORE_PORT": __core_port, "CORE_HOST": __core_host, "KAFKA_HOST": __kafka_host, "KAFKA_PORT": __kafka_port, "DAG_MANAGER_PORT": __dag_manager_port}
...
CORE_HOST_PORT = f"http://{__core_host}:{__core_port}"
DAG_HOST_PORT = lambda host: f"http://{host}:{__dag_manager_port}" if not IS_EXTERNAL else f"{CORE_HOST_PORT}/{__CORE_PROXY_PREFIX}/{__dag_manager_index}"
