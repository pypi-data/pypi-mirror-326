...
def ai_cell_types_by_comparison(gene_lists: list[list[str]],
    ...
    cell_types
        A list of cell types to provide context to the LLM. Each entry corresponds to a gene list in ``gene_lists``.

    tissues
        A list of tissues of origin to provide context to the LLM. Each entry corresponds to a gene list in ``gene_lists``.
...
def ai_annotate_cell_type_by_comparison(adata: AnnData,
groupby: str,
n_top_genes: int,
*,
...
**kwargs
    ...
    """
    return ai_annotate_by_comparison(func=ai_cell_types_by_comparison, adata=adata, groupby=groupby, n_top_genes=n_top_genes, new_label_column=new_label_column, cell_type=adt_key, cell_type_of_origin_col=cell_type_of_origin_col, tissue_of_origin_col=tissue_of_origin_col, **kwargs)
