...
class WatsonxEmbedding(BaseModel, BaseEmbedding):
    ...
    **Example**
    ...
    .. code-block:: python
        ...
        from labrador.embeddings import WatsonxEmbedding
    ...
    def get_query_embedding(self, query: str) -> Embedding:
        ...
        **Example**
        ...
        .. code-block:: python
            ...
            embedded_query = watsonx_embedding.get_query_embedding("Labrador is a data framework to build context-aware AI applications")
        """
