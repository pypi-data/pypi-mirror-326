...
class Assistant(BaseModel):
    ...
    updated_at: StrictStr = Field(description="The last time the assistant was updated")
    name: StrictStr = Field(description="The name of the assistant")
    __properties: ClassVar[List[str]] = ["assistant_id", "graph_id", "config", "created_at", "metadata", "version", "updated_at", "name"]
