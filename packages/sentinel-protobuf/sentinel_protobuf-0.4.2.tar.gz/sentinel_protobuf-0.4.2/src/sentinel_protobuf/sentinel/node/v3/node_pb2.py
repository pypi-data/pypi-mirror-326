...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 1, '', 'sentinel/node/v3/node.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_NODE']._serialized_end = 497