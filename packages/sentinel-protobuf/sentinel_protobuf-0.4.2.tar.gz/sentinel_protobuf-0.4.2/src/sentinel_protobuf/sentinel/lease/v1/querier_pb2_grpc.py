...
def add_QueryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {'QueryLeases': grpc.unary_unary_rpc_method_handler(servicer.QueryLeases, request_deserializer=sentinel_dot_lease_dot_v1_dot_querier__pb2.QueryLeasesRequest.FromString, response_serializer=sentinel_dot_lease_dot_v1_dot_querier__pb2.QueryLeasesResponse.SerializeToString), 'QueryLeasesForProvider': grpc.unary_unary_rpc_method_handler(servicer.QueryLeasesForProvider, request_deserializer=sentinel_dot_lease_dot_v1_dot_querier__pb2.QueryLeasesForProviderRequest.FromString, response_serializer=sentinel_dot_lease_dot_v1_dot_querier__pb2.QueryLeasesForProviderResponse.SerializeToString), 'QueryLeasesForNode': grpc.unary_unary_rpc_method_handler(servicer.QueryLeasesForNode, request_deserializer=sentinel_dot_lease_dot_v1_dot_querier__pb2.QueryLeasesForNodeRequest.FromString, response_serializer=sentinel_dot_lease_dot_v1_dot_querier__pb2.QueryLeasesForNodeResponse.SerializeToString), 'QueryLease': grpc.unary_unary_rpc_method_handler(servicer.QueryLease, request_deserializer=sentinel_dot_lease_dot_v1_dot_querier__pb2.QueryLeaseRequest.FromString, response_serializer=sentinel_dot_lease_dot_v1_dot_querier__pb2.QueryLeaseResponse.SerializeToString), 'QueryParams': grpc.unary_unary_rpc_method_handler(servicer.QueryParams, request_deserializer=sentinel_dot_lease_dot_v1_dot_querier__pb2.QueryParamsRequest.FromString, response_serializer=sentinel_dot_lease_dot_v1_dot_querier__pb2.QueryParamsResponse.SerializeToString)}
