...
class QuotaAdjusterSettings(_message.Message):
    __slots__ = ('name', 'enablement', 'update_time', 'etag')
    ...
    def __init__(self, name: _Optional[str]=..., enablement: _Optional[_Union[QuotaAdjusterSettings.Enablement, str]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., etag: _Optional[str]=...) -> None:
        ...