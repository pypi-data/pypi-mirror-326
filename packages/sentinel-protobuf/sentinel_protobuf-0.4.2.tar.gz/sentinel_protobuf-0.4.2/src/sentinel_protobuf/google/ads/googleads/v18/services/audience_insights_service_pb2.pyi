...
from google.ads.googleads.v18.common import dates_pb2 as _dates_pb2
from google.ads.googleads.v18.enums import audience_insights_dimension_pb2 as _audience_insights_dimension_pb2
from google.ads.googleads.v18.enums import audience_insights_marketing_objective_pb2 as _audience_insights_marketing_objective_pb2
...
class AudienceInsightsAttributeMetadata(_message.Message):
    __slots__ = ("dimension", "attribute", "display_name", "display_info", "potential_youtube_reach", "youtube_channel_metadata", "dynamic_attribute_metadata", "location_attribute_metadata", "user_interest_attribute_metadata")
    DIMENSION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, dimension: _Optional[_Union[_audience_insights_dimension_pb2.AudienceInsightsDimensionEnum.AudienceInsightsDimension, str]] = ..., attribute: _Optional[_Union[AudienceInsightsAttribute, _Mapping]] = ..., display_name: _Optional[str] = ..., display_info: _Optional[str] = ..., potential_youtube_reach: _Optional[int] = ..., youtube_channel_metadata: _Optional[_Union[YouTubeChannelAttributeMetadata, _Mapping]] = ..., dynamic_attribute_metadata: _Optional[_Union[DynamicLineupAttributeMetadata, _Mapping]] = ..., location_attribute_metadata: _Optional[_Union[LocationAttributeMetadata, _Mapping]] = ..., user_interest_attribute_metadata: _Optional[_Union[UserInterestAttributeMetadata, _Mapping]] = ...) -> None: ...
