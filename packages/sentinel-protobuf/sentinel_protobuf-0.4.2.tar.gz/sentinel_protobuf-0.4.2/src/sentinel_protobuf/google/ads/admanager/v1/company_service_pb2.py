...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/admanager/v1/company_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\033com.google.ads.admanager.v1B\023CompanyServiceProtoP\001Z@google.golang.org/genproto/googleapis/ads/admanager/v1;admanager\252\002\027Google.Ads.AdManager.V1\312\002\027Google\\Ads\\AdManager\\V1\352\002\032Google::Ads::AdManager::V1'
  _globals['_GETCOMPANYREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETCOMPANYREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A\"\n admanager.googleapis.com/Company'
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A\"\n admanager.googleapis.com/Network'
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['filter']._loaded_options = None
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['filter']._serialized_options = b'\340A\001'
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['order_by']._loaded_options = None
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['order_by']._serialized_options = b'\340A\001'
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['skip']._loaded_options = None
  _globals['_LISTCOMPANIESREQUEST'].fields_by_name['skip']._serialized_options = b'\340A\001'
  _globals['_COMPANYSERVICE']._loaded_options = None
  _globals['_COMPANYSERVICE']._serialized_options = b'\312A\030admanager.googleapis.com'
  _globals['_COMPANYSERVICE'].methods_by_name['GetCompany']._loaded_options = None
  _globals['_COMPANYSERVICE'].methods_by_name['GetCompany']._serialized_options = b'\332A\004name\202\323\344\223\002#\022!/v1/{name=networks/*/companies/*}'
  _globals['_COMPANYSERVICE'].methods_by_name['ListCompanies']._loaded_options = None
  _globals['_COMPANYSERVICE'].methods_by_name['ListCompanies']._serialized_options = b'\332A\006parent\202\323\344\223\002#\022!/v1/{parent=networks/*}/companies'
  ...
  _globals['_COMPANYSERVICE']._serialized_end=986
