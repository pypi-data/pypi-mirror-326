...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 1, '', 'google/ads/googleads/v17/services/local_services_lead_service.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_LOCALSERVICESLEADSERVICE'].methods_by_name['AppendLeadConversation']._serialized_options = b'\xdaA\x19customer_id,conversations\x82\xd3\xe4\x93\x02H"C/v17/customers/{customer_id=*}/localServices:appendLeadConversation:\x01*'
