...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/searchads360/v0/resources/conversion_action.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CONVERSIONACTION_FLOODLIGHTSETTINGS'].fields_by_name['activity_group_tag']._serialized_options = b'\340A\003'
  _globals['_CONVERSIONACTION_FLOODLIGHTSETTINGS'].fields_by_name['activity_tag']._loaded_options = None
  _globals['_CONVERSIONACTION_FLOODLIGHTSETTINGS'].fields_by_name['activity_tag']._serialized_options = b'\340A\003'
  _globals['_CONVERSIONACTION_FLOODLIGHTSETTINGS'].fields_by_name['activity_id']._loaded_options = None
  _globals['_CONVERSIONACTION_FLOODLIGHTSETTINGS'].fields_by_name['activity_id']._serialized_options = b'\340A\003'
  ...
  _globals['_CONVERSIONACTION'].fields_by_name['creation_time']._serialized_options = b'\340A\003'
  ...
  _globals['_CONVERSIONACTION'].fields_by_name['include_in_conversions_metric']._serialized_options = b'\340A\003'
  _globals['_CONVERSIONACTION'].fields_by_name['floodlight_settings']._loaded_options = None
  _globals['_CONVERSIONACTION'].fields_by_name['floodlight_settings']._serialized_options = b'\340A\003'
  _globals['_CONVERSIONACTION']._loaded_options = None
  _globals['_CONVERSIONACTION']._serialized_options = b'\352An\n,searchads360.googleapis.com/ConversionAction\022>customers/{customer_id}/conversionActions/{conversion_type_id}'
