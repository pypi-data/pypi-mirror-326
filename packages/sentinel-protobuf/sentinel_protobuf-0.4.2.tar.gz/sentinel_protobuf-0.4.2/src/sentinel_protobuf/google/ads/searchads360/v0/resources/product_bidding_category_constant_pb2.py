...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/searchads360/v0/resources/product_bidding_category_constant.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['resource_name']._serialized_options = b'\340A\003\372A<\n:searchads360.googleapis.com/ProductBiddingCategoryConstant'
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['id']._loaded_options = None
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['id']._serialized_options = b'\340A\003'
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['country_code']._loaded_options = None
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['country_code']._serialized_options = b'\340A\003'
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['product_bidding_category_constant_parent']._loaded_options = None
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['product_bidding_category_constant_parent']._serialized_options = b'\340A\003\372A<\n:searchads360.googleapis.com/ProductBiddingCategoryConstant'
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['level']._loaded_options = None
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['level']._serialized_options = b'\340A\003'
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['status']._loaded_options = None
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['status']._serialized_options = b'\340A\003'
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['language_code']._loaded_options = None
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['language_code']._serialized_options = b'\340A\003'
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['localized_name']._loaded_options = None
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT'].fields_by_name['localized_name']._serialized_options = b'\340A\003'
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT']._loaded_options = None
  _globals['_PRODUCTBIDDINGCATEGORYCONSTANT']._serialized_options = b'\352A\206\001\n:searchads360.googleapis.com/ProductBiddingCategoryConstant\022HproductBiddingCategoryConstants/{country_code}~{level}~{canonical_value}'
