...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/googleads/v18/resources/shopping_product.proto'
)
...
from google.ads.googleads.v18.enums import product_availability_pb2 as google_dot_ads_dot_googleads_dot_v18_dot_enums_dot_product__availability__pb2
...
from google.ads.googleads.v18.enums import product_issue_severity_pb2 as google_dot_ads_dot_googleads_dot_v18_dot_enums_dot_product__issue__severity__pb2
from google.ads.googleads.v18.enums import product_status_pb2 as google_dot_ads_dot_googleads_dot_v18_dot_enums_dot_product__status__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ads.googleads.v18.resources.shopping_product_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.google.ads.googleads.v18.resourcesB\024ShoppingProductProtoP\001ZKgoogle.golang.org/genproto/googleapis/ads/googleads/v18/resources;resources\242\002\003GAA\252\002\"Google.Ads.GoogleAds.V18.Resources\312\002\"Google\\Ads\\GoogleAds\\V18\\Resources\352\002&Google::Ads::GoogleAds::V18::Resources'
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['error_code']._loaded_options = None
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['error_code']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['ads_severity']._loaded_options = None
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['ads_severity']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['attribute_name']._loaded_options = None
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['attribute_name']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['description']._loaded_options = None
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['description']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['detail']._loaded_options = None
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['detail']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['documentation']._loaded_options = None
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['documentation']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['affected_regions']._loaded_options = None
  _globals['_SHOPPINGPRODUCT_PRODUCTISSUE'].fields_by_name['affected_regions']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['resource_name']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['resource_name']._serialized_options = b'\340A\003\372A*\n(googleads.googleapis.com/ShoppingProduct'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['merchant_center_id']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['merchant_center_id']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['channel']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['channel']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['language_code']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['language_code']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['feed_label']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['feed_label']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['item_id']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['item_id']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['multi_client_account_id']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['multi_client_account_id']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['title']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['title']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['brand']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['brand']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['price_micros']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['price_micros']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['currency_code']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['currency_code']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['channel_exclusivity']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['channel_exclusivity']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['condition']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['condition']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['availability']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['availability']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['target_countries']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['target_countries']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['custom_attribute0']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['custom_attribute0']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['custom_attribute1']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['custom_attribute1']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['custom_attribute2']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['custom_attribute2']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['custom_attribute3']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['custom_attribute3']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['custom_attribute4']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['custom_attribute4']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['category_level1']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['category_level1']._serialized_options = b'\340A\003\372A2\n0googleads.googleapis.com/ProductCategoryConstant'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['category_level2']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['category_level2']._serialized_options = b'\340A\003\372A2\n0googleads.googleapis.com/ProductCategoryConstant'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['category_level3']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['category_level3']._serialized_options = b'\340A\003\372A2\n0googleads.googleapis.com/ProductCategoryConstant'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['category_level4']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['category_level4']._serialized_options = b'\340A\003\372A2\n0googleads.googleapis.com/ProductCategoryConstant'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['category_level5']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['category_level5']._serialized_options = b'\340A\003\372A2\n0googleads.googleapis.com/ProductCategoryConstant'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['product_type_level1']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['product_type_level1']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['product_type_level2']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['product_type_level2']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['product_type_level3']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['product_type_level3']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['product_type_level4']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['product_type_level4']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['product_type_level5']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['product_type_level5']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['effective_max_cpc_micros']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['effective_max_cpc_micros']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['status']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['status']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['issues']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['issues']._serialized_options = b'\340A\003'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['campaign']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['campaign']._serialized_options = b'\340A\003\372A#\n!googleads.googleapis.com/Campaign'
  _globals['_SHOPPINGPRODUCT'].fields_by_name['ad_group']._loaded_options = None
  _globals['_SHOPPINGPRODUCT'].fields_by_name['ad_group']._serialized_options = b'\340A\003\372A\"\n googleads.googleapis.com/AdGroup'
  _globals['_SHOPPINGPRODUCT']._loaded_options = None
  _globals['_SHOPPINGPRODUCT']._serialized_options = b'\352A\275\001\n(googleads.googleapis.com/ShoppingProduct\022ncustomers/{customer_id}/shoppingProducts/{merchant_center_id}~{channel}~{language_code}~{feed_label}~{item_id}*\020shoppingProducts2\017shoppingProduct'
