...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/ads/searchads360/v0/resources/search_ads360_field.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SEARCHADS360FIELD'].fields_by_name['resource_name']._serialized_options = b'\340A\003\372A/\n-searchads360.googleapis.com/SearchAds360Field'
  _globals['_SEARCHADS360FIELD'].fields_by_name['name']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['category']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['category']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['selectable']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['selectable']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['filterable']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['filterable']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['sortable']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['sortable']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['selectable_with']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['selectable_with']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['attribute_resources']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['attribute_resources']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['metrics']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['metrics']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['segments']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['segments']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['enum_values']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['enum_values']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['data_type']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['data_type']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['type_url']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['type_url']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD'].fields_by_name['is_repeated']._loaded_options = None
  _globals['_SEARCHADS360FIELD'].fields_by_name['is_repeated']._serialized_options = b'\340A\003'
  _globals['_SEARCHADS360FIELD']._loaded_options = None
  _globals['_SEARCHADS360FIELD']._serialized_options = b'\352AZ\n-searchads360.googleapis.com/SearchAds360Field\022)searchAds360Fields/{search_ads_360_field}'
