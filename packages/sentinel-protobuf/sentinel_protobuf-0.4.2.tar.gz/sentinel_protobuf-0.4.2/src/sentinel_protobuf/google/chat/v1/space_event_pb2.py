...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/chat/v1/space_event.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\022com.google.chat.v1B\017SpaceEventProtoP\001Z,cloud.google.com/go/chat/apiv1/chatpb;chatpb\252\002\023Google.Apps.Chat.V1\312\002\023Google\\Apps\\Chat\\V1\352\002\026Google::Apps::Chat::V1'
  _globals['_SPACEEVENT']._loaded_options = None
  _globals['_SPACEEVENT']._serialized_options = b'\352AJ\n\036chat.googleapis.com/SpaceEvent\022(spaces/{space}/spaceEvents/{space_event}'
  _globals['_GETSPACEEVENTREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETSPACEEVENTREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A \n\036chat.googleapis.com/SpaceEvent'
  _globals['_LISTSPACEEVENTSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTSPACEEVENTSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A \022\036chat.googleapis.com/SpaceEvent'
  _globals['_LISTSPACEEVENTSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTSPACEEVENTSREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTSPACEEVENTSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTSPACEEVENTSREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_LISTSPACEEVENTSREQUEST'].fields_by_name['filter']._loaded_options = None
  _globals['_LISTSPACEEVENTSREQUEST'].fields_by_name['filter']._serialized_options = b'\340A\002'
