...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\037com.google.cloud.retail.v2alphaB\021ImportConfigProtoP\001Z7cloud.google.com/go/retail/apiv2alpha/retailpb;retailpb\242\002\006RETAIL\252\002\033Google.Cloud.Retail.V2Alpha\312\002\033Google\\Cloud\\Retail\\V2alpha\352\002\036Google::Cloud::Retail::V2alpha'
  ...
  _globals['_PRODUCTINLINESOURCE'].fields_by_name['products']._serialized_options = b'\340A\002'
  _globals['_USEREVENTINLINESOURCE'].fields_by_name['user_events']._loaded_options = None
  _globals['_USEREVENTINLINESOURCE'].fields_by_name['user_events']._serialized_options = b'\340A\002'
  _globals['_IMPORTPRODUCTSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_IMPORTPRODUCTSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A\036\n\034retail.googleapis.com/Branch'
  _globals['_IMPORTPRODUCTSREQUEST'].fields_by_name['request_id']._loaded_options = None
  _globals['_IMPORTPRODUCTSREQUEST'].fields_by_name['request_id']._serialized_options = b'\030\001'
  _globals['_IMPORTPRODUCTSREQUEST'].fields_by_name['input_config']._loaded_options = None
  _globals['_IMPORTPRODUCTSREQUEST'].fields_by_name['input_config']._serialized_options = b'\340A\002'
  _globals['_IMPORTUSEREVENTSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_IMPORTUSEREVENTSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A\037\n\035retail.googleapis.com/Catalog'
  _globals['_IMPORTUSEREVENTSREQUEST'].fields_by_name['input_config']._loaded_options = None
  _globals['_IMPORTUSEREVENTSREQUEST'].fields_by_name['input_config']._serialized_options = b'\340A\002'
  _globals['_IMPORTCOMPLETIONDATAREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_IMPORTCOMPLETIONDATAREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A\037\n\035retail.googleapis.com/Catalog'
  _globals['_IMPORTCOMPLETIONDATAREQUEST'].fields_by_name['input_config']._loaded_options = None
  _globals['_IMPORTCOMPLETIONDATAREQUEST'].fields_by_name['input_config']._serialized_options = b'\340A\002'
  _globals['_USEREVENTINPUTCONFIG'].fields_by_name['user_event_inline_source']._loaded_options = None
  _globals['_USEREVENTINPUTCONFIG'].fields_by_name['user_event_inline_source']._serialized_options = b'\340A\002'
  _globals['_USEREVENTINPUTCONFIG'].fields_by_name['gcs_source']._loaded_options = None
  _globals['_USEREVENTINPUTCONFIG'].fields_by_name['gcs_source']._serialized_options = b'\340A\002'
  _globals['_USEREVENTINPUTCONFIG'].fields_by_name['big_query_source']._loaded_options = None
  _globals['_USEREVENTINPUTCONFIG'].fields_by_name['big_query_source']._serialized_options = b'\340A\002'
  _globals['_COMPLETIONDATAINPUTCONFIG'].fields_by_name['big_query_source']._loaded_options = None
  _globals['_COMPLETIONDATAINPUTCONFIG'].fields_by_name['big_query_source']._serialized_options = b'\340A\002'
  _globals['_IMPORTMETADATA'].fields_by_name['request_id']._loaded_options = None
  _globals['_IMPORTMETADATA'].fields_by_name['request_id']._serialized_options = b'\030\001'
