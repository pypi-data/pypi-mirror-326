...
class Conversation(_message.Message):
    __slots__ = ("name", "lifecycle_state", "conversation_profile", "phone_number", "conversation_stage", "start_time", "end_time", "telephony_connection_info")
