...
class PipelineJob(_message.Message):
    __slots__ = ('name', 'display_name', 'create_time', 'start_time', 'end_time', 'update_time', 'pipeline_spec', 'state', 'job_detail', 'error', 'labels', 'runtime_config', 'encryption_spec', 'service_account', 'network', 'reserved_ip_ranges', 'template_uri', 'template_metadata', 'schedule_name', 'preflight_validations')
...
class PipelineTaskDetail(_message.Message):
    __slots__ = ('task_id', 'parent_task_id', 'task_name', 'create_time', 'start_time', 'end_time', 'executor_detail', 'state', 'execution', 'error', 'pipeline_task_status', 'inputs', 'outputs')
