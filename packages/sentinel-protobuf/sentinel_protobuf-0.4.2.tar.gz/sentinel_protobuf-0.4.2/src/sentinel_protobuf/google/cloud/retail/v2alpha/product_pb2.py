...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\037com.google.cloud.retail.v2alphaB\014ProductProtoP\001Z7cloud.google.com/go/retail/apiv2alpha/retailpb;retailpb\242\002\006RETAIL\252\002\033Google.Cloud.Retail.V2Alpha\312\002\033Google\\Cloud\\Retail\\V2alpha\352\002\036Google::Cloud::Retail::V2alpha'
  ...
  _globals['_PRODUCT'].fields_by_name['ttl']._serialized_options = b'\340A\004'
  _globals['_PRODUCT'].fields_by_name['name']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['name']._serialized_options = b'\340A\005'
  _globals['_PRODUCT'].fields_by_name['id']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['id']._serialized_options = b'\340A\005'
  _globals['_PRODUCT'].fields_by_name['type']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['type']._serialized_options = b'\340A\005'
  _globals['_PRODUCT'].fields_by_name['title']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['title']._serialized_options = b'\340A\002'
  _globals['_PRODUCT'].fields_by_name['retrievable_fields']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['retrievable_fields']._serialized_options = b'\030\001'
  _globals['_PRODUCT'].fields_by_name['variants']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['variants']._serialized_options = b'\340A\003'
  _globals['_PRODUCT'].fields_by_name['local_inventories']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['local_inventories']._serialized_options = b'\340A\003'
  _globals['_PRODUCT']._loaded_options = None
  _globals['_PRODUCT']._serialized_options = b'\352A\200\001\n\035retail.googleapis.com/Product\022_projects/{project}/locations/{location}/catalogs/{catalog}/branches/{branch}/products/{product}'
