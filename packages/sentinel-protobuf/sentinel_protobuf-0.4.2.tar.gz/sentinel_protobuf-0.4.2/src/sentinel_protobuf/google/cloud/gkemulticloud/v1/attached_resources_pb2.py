...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n!com.google.cloud.gkemulticloud.v1B\026AttachedResourcesProtoP\001ZGcloud.google.com/go/gkemulticloud/apiv1/gkemulticloudpb;gkemulticloudpb\252\002\035Google.Cloud.GkeMultiCloud.V1\312\002\035Google\\Cloud\\GkeMultiCloud\\V1\352\002 Google::Cloud::GkeMultiCloud::V1'
  _globals['_ATTACHEDCLUSTER_ANNOTATIONSENTRY']._loaded_options = None
  _globals['_ATTACHEDCLUSTER_ANNOTATIONSENTRY']._serialized_options = b'8\001'
  _globals['_ATTACHEDCLUSTER_TAGSENTRY']._loaded_options = None
  _globals['_ATTACHEDCLUSTER_TAGSENTRY']._serialized_options = b'8\001'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['description']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['description']._serialized_options = b'\340A\001'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['oidc_config']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['oidc_config']._serialized_options = b'\340A\002'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['platform_version']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['platform_version']._serialized_options = b'\340A\002'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['distribution']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['distribution']._serialized_options = b'\340A\002'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['cluster_region']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['cluster_region']._serialized_options = b'\340A\003'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['fleet']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['fleet']._serialized_options = b'\340A\002'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['state']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['state']._serialized_options = b'\340A\003'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['uid']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['uid']._serialized_options = b'\340A\003'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['reconciling']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['reconciling']._serialized_options = b'\340A\003'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['create_time']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['update_time']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['kubernetes_version']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['kubernetes_version']._serialized_options = b'\340A\003'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['annotations']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['annotations']._serialized_options = b'\340A\001'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['workload_identity_config']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['workload_identity_config']._serialized_options = b'\340A\003'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['logging_config']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['logging_config']._serialized_options = b'\340A\001'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['errors']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['errors']._serialized_options = b'\340A\003'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['authorization']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['authorization']._serialized_options = b'\340A\001'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['monitoring_config']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['monitoring_config']._serialized_options = b'\340A\001'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['proxy_config']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['proxy_config']._serialized_options = b'\340A\001'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['binary_authorization']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['binary_authorization']._serialized_options = b'\340A\001'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['security_posture_config']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['security_posture_config']._serialized_options = b'\340A\001'
  _globals['_ATTACHEDCLUSTER'].fields_by_name['tags']._loaded_options = None
  _globals['_ATTACHEDCLUSTER'].fields_by_name['tags']._serialized_options = b'\340A\001\340A\004'
  _globals['_ATTACHEDCLUSTER']._loaded_options = None
  _globals['_ATTACHEDCLUSTER']._serialized_options = b'\352A{\n,gkemulticloud.googleapis.com/AttachedCluster\022Kprojects/{project}/locations/{location}/attachedClusters/{attached_cluster}'
  _globals['_ATTACHEDCLUSTERSAUTHORIZATION'].fields_by_name['admin_users']._loaded_options = None
  _globals['_ATTACHEDCLUSTERSAUTHORIZATION'].fields_by_name['admin_users']._serialized_options = b'\340A\001'
  _globals['_ATTACHEDCLUSTERSAUTHORIZATION'].fields_by_name['admin_groups']._loaded_options = None
  _globals['_ATTACHEDCLUSTERSAUTHORIZATION'].fields_by_name['admin_groups']._serialized_options = b'\340A\001'
  _globals['_ATTACHEDCLUSTERUSER'].fields_by_name['username']._loaded_options = None
  _globals['_ATTACHEDCLUSTERUSER'].fields_by_name['username']._serialized_options = b'\340A\002'
  _globals['_ATTACHEDCLUSTERGROUP'].fields_by_name['group']._loaded_options = None
  _globals['_ATTACHEDCLUSTERGROUP'].fields_by_name['group']._serialized_options = b'\340A\002'
  _globals['_ATTACHEDOIDCCONFIG'].fields_by_name['jwks']._loaded_options = None
  _globals['_ATTACHEDOIDCCONFIG'].fields_by_name['jwks']._serialized_options = b'\340A\001'
  _globals['_ATTACHEDSERVERCONFIG']._loaded_options = None
  _globals['_ATTACHEDSERVERCONFIG']._serialized_options = b'\352Aq\n1gkemulticloud.googleapis.com/AttachedServerConfig\022<projects/{project}/locations/{location}/attachedServerConfig'
