...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/cloud/retail/v2alpha/prediction_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\037com.google.cloud.retail.v2alphaB\026PredictionServiceProtoP\001Z7cloud.google.com/go/retail/apiv2alpha/retailpb;retailpb\242\002\006RETAIL\252\002\033Google.Cloud.Retail.V2Alpha\312\002\033Google\\Cloud\\Retail\\V2alpha\352\002\036Google::Cloud::Retail::V2alpha'
  ...
  _globals['_PREDICTREQUEST_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_PREDICTREQUEST'].fields_by_name['placement']._loaded_options = None
  _globals['_PREDICTREQUEST'].fields_by_name['placement']._serialized_options = b'\340A\002'
  _globals['_PREDICTREQUEST'].fields_by_name['user_event']._loaded_options = None
  _globals['_PREDICTREQUEST'].fields_by_name['user_event']._serialized_options = b'\340A\002'
  _globals['_PREDICTREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_PREDICTREQUEST'].fields_by_name['page_token']._serialized_options = b'\030\001'
  _globals['_PREDICTRESPONSE_PREDICTIONRESULT_METADATAENTRY']._loaded_options = None
  _globals['_PREDICTRESPONSE_PREDICTIONRESULT_METADATAENTRY']._serialized_options = b'8\001'
  _globals['_PREDICTIONSERVICE']._loaded_options = None
  _globals['_PREDICTIONSERVICE']._serialized_options = b'\312A\025retail.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platform'
  _globals['_PREDICTIONSERVICE'].methods_by_name['Predict']._loaded_options = None
  _globals['_PREDICTIONSERVICE'].methods_by_name['Predict']._serialized_options = b'\202\323\344\223\002\246\001\"K/v2alpha/{placement=projects/*/locations/*/catalogs/*/placements/*}:predict:\001*ZT\"O/v2alpha/{placement=projects/*/locations/*/catalogs/*/servingConfigs/*}:predict:\001*'
