...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n#com.google.cloud.aiplatform.v1beta1B\014FeatureProtoP\001ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\252\002\037Google.Cloud.AIPlatform.V1Beta1\312\002\037Google\\Cloud\\AIPlatform\\V1beta1\352\002\"Google::Cloud::AIPlatform::V1beta1'
  _globals['_FEATURE_MONITORINGSTATSANOMALY'].fields_by_name['objective']._loaded_options = None
  _globals['_FEATURE_MONITORINGSTATSANOMALY'].fields_by_name['objective']._serialized_options = b'\340A\003'
  _globals['_FEATURE_MONITORINGSTATSANOMALY'].fields_by_name['feature_stats_anomaly']._loaded_options = None
  _globals['_FEATURE_MONITORINGSTATSANOMALY'].fields_by_name['feature_stats_anomaly']._serialized_options = b'\340A\003'
  ...
  _globals['_FEATURE'].fields_by_name['name']._serialized_options = b'\340A\005'
  _globals['_FEATURE'].fields_by_name['value_type']._loaded_options = None
  _globals['_FEATURE'].fields_by_name['value_type']._serialized_options = b'\340A\005'
  ...
  _globals['_FEATURE'].fields_by_name['labels']._serialized_options = b'\340A\001'
  _globals['_FEATURE'].fields_by_name['monitoring_config']._loaded_options = None
  _globals['_FEATURE'].fields_by_name['monitoring_config']._serialized_options = b'\030\001\340A\001'
  _globals['_FEATURE'].fields_by_name['disable_monitoring']._loaded_options = None
  _globals['_FEATURE'].fields_by_name['disable_monitoring']._serialized_options = b'\340A\001'
  _globals['_FEATURE'].fields_by_name['monitoring_stats']._loaded_options = None
  _globals['_FEATURE'].fields_by_name['monitoring_stats']._serialized_options = b'\340A\003'
  _globals['_FEATURE'].fields_by_name['monitoring_stats_anomalies']._loaded_options = None
  _globals['_FEATURE'].fields_by_name['monitoring_stats_anomalies']._serialized_options = b'\340A\003'
  _globals['_FEATURE'].fields_by_name['feature_stats_and_anomaly']._loaded_options = None
  _globals['_FEATURE'].fields_by_name['feature_stats_and_anomaly']._serialized_options = b'\340A\003'
  _globals['_FEATURE']._loaded_options = None
  _globals['_FEATURE']._serialized_options = b'\352A\203\002\n!aiplatform.googleapis.com/Feature\022qprojects/{project}/locations/{location}/featurestores/{featurestore}/entityTypes/{entity_type}/features/{feature}\022Xprojects/{project}/locations/{location}/featureGroups/{feature_group}/features/{feature}*\010features2\007feature'
