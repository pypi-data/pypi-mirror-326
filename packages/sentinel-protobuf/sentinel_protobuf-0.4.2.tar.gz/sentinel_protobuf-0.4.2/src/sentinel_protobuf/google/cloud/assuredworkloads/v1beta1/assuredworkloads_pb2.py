...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n)com.google.cloud.assuredworkloads.v1beta1B\025AssuredworkloadsProtoP\001ZUcloud.google.com/go/assuredworkloads/apiv1beta1/assuredworkloadspb;assuredworkloadspb\252\002%Google.Cloud.AssuredWorkloads.V1Beta1\312\002%Google\\Cloud\\AssuredWorkloads\\V1beta1\352\002(Google::Cloud::AssuredWorkloads::V1beta1\352A]\n(assuredworkloads.googleapis.com/Location\0221organizations/{organization}/locations/{location}'
  ...
  _globals['_ANALYZEWORKLOADMOVEREQUEST'].fields_by_name['target']._serialized_options = b'\340A\002'
  ...
  _globals['_WORKLOAD_IL4SETTINGS'].fields_by_name['kms_settings']._serialized_options = b'\340A\004\340A\005'
  _globals['_WORKLOAD_IL4SETTINGS']._loaded_options = None
  _globals['_WORKLOAD_IL4SETTINGS']._serialized_options = b'\030\001'
  _globals['_WORKLOAD_CJISSETTINGS'].fields_by_name['kms_settings']._loaded_options = None
  _globals['_WORKLOAD_CJISSETTINGS'].fields_by_name['kms_settings']._serialized_options = b'\340A\004\340A\005'
  _globals['_WORKLOAD_CJISSETTINGS']._loaded_options = None
  _globals['_WORKLOAD_CJISSETTINGS']._serialized_options = b'\030\001'
  _globals['_WORKLOAD_FEDRAMPHIGHSETTINGS'].fields_by_name['kms_settings']._loaded_options = None
  _globals['_WORKLOAD_FEDRAMPHIGHSETTINGS'].fields_by_name['kms_settings']._serialized_options = b'\340A\004\340A\005'
  _globals['_WORKLOAD_FEDRAMPHIGHSETTINGS']._loaded_options = None
  _globals['_WORKLOAD_FEDRAMPHIGHSETTINGS']._serialized_options = b'\030\001'
  _globals['_WORKLOAD_FEDRAMPMODERATESETTINGS'].fields_by_name['kms_settings']._loaded_options = None
  _globals['_WORKLOAD_FEDRAMPMODERATESETTINGS'].fields_by_name['kms_settings']._serialized_options = b'\340A\004\340A\005'
  _globals['_WORKLOAD_FEDRAMPMODERATESETTINGS']._loaded_options = None
  _globals['_WORKLOAD_FEDRAMPMODERATESETTINGS']._serialized_options = b'\030\001'
  ...
  _globals['_WORKLOAD'].fields_by_name['billing_account']._serialized_options = b'\340A\003'
  _globals['_WORKLOAD'].fields_by_name['il4_settings']._loaded_options = None
  _globals['_WORKLOAD'].fields_by_name['il4_settings']._serialized_options = b'\030\001\340A\004\340A\005'
  _globals['_WORKLOAD'].fields_by_name['cjis_settings']._loaded_options = None
  _globals['_WORKLOAD'].fields_by_name['cjis_settings']._serialized_options = b'\030\001\340A\004\340A\005'
  _globals['_WORKLOAD'].fields_by_name['fedramp_high_settings']._loaded_options = None
  _globals['_WORKLOAD'].fields_by_name['fedramp_high_settings']._serialized_options = b'\030\001\340A\004\340A\005'
  _globals['_WORKLOAD'].fields_by_name['fedramp_moderate_settings']._loaded_options = None
  _globals['_WORKLOAD'].fields_by_name['fedramp_moderate_settings']._serialized_options = b'\030\001\340A\004\340A\005'
  ...
  _globals['_CREATEWORKLOADOPERATIONMETADATA'].fields_by_name['resource_settings']._serialized_options = b'\340A\001'
