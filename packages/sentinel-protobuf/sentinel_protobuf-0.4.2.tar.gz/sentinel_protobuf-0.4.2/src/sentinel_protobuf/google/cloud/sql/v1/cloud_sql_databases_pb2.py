...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\027com.google.cloud.sql.v1B\026CloudSqlDatabasesProtoP\001Z)cloud.google.com/go/sql/apiv1/sqlpb;sqlpb'
  ...
  _globals['_SQLDATABASESSERVICE'].methods_by_name['Delete']._serialized_options = b'\202\323\344\223\002B*@/v1/projects/{project}/instances/{instance}/databases/{database}'
  _globals['_SQLDATABASESSERVICE'].methods_by_name['Get']._loaded_options = None
  _globals['_SQLDATABASESSERVICE'].methods_by_name['Get']._serialized_options = b'\202\323\344\223\002B\022@/v1/projects/{project}/instances/{instance}/databases/{database}'
  _globals['_SQLDATABASESSERVICE'].methods_by_name['Insert']._loaded_options = None
  _globals['_SQLDATABASESSERVICE'].methods_by_name['Insert']._serialized_options = b'\202\323\344\223\002=\"5/v1/projects/{project}/instances/{instance}/databases:\004body'
  _globals['_SQLDATABASESSERVICE'].methods_by_name['List']._loaded_options = None
  _globals['_SQLDATABASESSERVICE'].methods_by_name['List']._serialized_options = b'\202\323\344\223\0027\0225/v1/projects/{project}/instances/{instance}/databases'
  _globals['_SQLDATABASESSERVICE'].methods_by_name['Patch']._loaded_options = None
  _globals['_SQLDATABASESSERVICE'].methods_by_name['Patch']._serialized_options = b'\202\323\344\223\002H2@/v1/projects/{project}/instances/{instance}/databases/{database}:\004body'
  _globals['_SQLDATABASESSERVICE'].methods_by_name['Update']._loaded_options = None
  _globals['_SQLDATABASESSERVICE'].methods_by_name['Update']._serialized_options = b'\202\323\344\223\002H\032@/v1/projects/{project}/instances/{instance}/databases/{database}:\004body'
