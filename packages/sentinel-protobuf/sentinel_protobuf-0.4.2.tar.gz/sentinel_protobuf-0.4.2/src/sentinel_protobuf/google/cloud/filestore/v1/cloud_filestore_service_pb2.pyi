...
class Instance(_message.Message):
    __slots__ = ('name', 'description', 'state', 'status_message', 'create_time', 'tier', 'labels', 'file_shares', 'networks', 'etag', 'satisfies_pzs', 'satisfies_pzi', 'kms_key_name', 'suspension_reasons')
...
class Backup(_message.Message):
    __slots__ = ('name', 'description', 'state', 'create_time', 'labels', 'capacity_gb', 'storage_bytes', 'source_instance', 'source_file_share', 'source_instance_tier', 'download_bytes', 'satisfies_pzs', 'satisfies_pzi', 'kms_key')
