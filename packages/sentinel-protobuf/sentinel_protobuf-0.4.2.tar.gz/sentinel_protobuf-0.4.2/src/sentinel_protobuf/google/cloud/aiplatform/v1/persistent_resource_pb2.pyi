...
class PersistentResource(_message.Message):
    __slots__ = ("name", "display_name", "resource_pools", "state", "error", "create_time", "start_time", "update_time", "labels", "network", "encryption_spec", "resource_runtime_spec", "resource_runtime", "reserved_ip_ranges")
