...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n)com.google.cloud.bigquery.datatransfer.v1B\rTransferProtoP\001ZMcloud.google.com/go/bigquery/datatransfer/apiv1/datatransferpb;datatransferpb\242\002\005GCBDT\252\002%Google.Cloud.BigQuery.DataTransfer.V1\312\002%Google\\Cloud\\BigQuery\\DataTransfer\\V1\352\002)Google::Cloud::Bigquery::DataTransfer::V1'
  _globals['_TRANSFERTYPE']._loaded_options = None
  _globals['_TRANSFERTYPE']._serialized_options = b'\030\001'
  _globals['_TRANSFERCONFIG'].fields_by_name['name']._loaded_options = None
  _globals['_TRANSFERCONFIG'].fields_by_name['name']._serialized_options = b'\340A\010'
  _globals['_TRANSFERCONFIG'].fields_by_name['update_time']._loaded_options = None
  _globals['_TRANSFERCONFIG'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_TRANSFERCONFIG'].fields_by_name['next_run_time']._loaded_options = None
  _globals['_TRANSFERCONFIG'].fields_by_name['next_run_time']._serialized_options = b'\340A\003'
  _globals['_TRANSFERCONFIG'].fields_by_name['state']._loaded_options = None
  _globals['_TRANSFERCONFIG'].fields_by_name['state']._serialized_options = b'\340A\003'
  _globals['_TRANSFERCONFIG'].fields_by_name['dataset_region']._loaded_options = None
  _globals['_TRANSFERCONFIG'].fields_by_name['dataset_region']._serialized_options = b'\340A\003'
  _globals['_TRANSFERCONFIG'].fields_by_name['owner_info']._loaded_options = None
  _globals['_TRANSFERCONFIG'].fields_by_name['owner_info']._serialized_options = b'\340A\003'
  _globals['_TRANSFERCONFIG'].fields_by_name['error']._loaded_options = None
  _globals['_TRANSFERCONFIG'].fields_by_name['error']._serialized_options = b'\340A\003'
  _globals['_TRANSFERCONFIG']._loaded_options = None
  _globals['_TRANSFERCONFIG']._serialized_options = b'\352A\265\001\n2bigquerydatatransfer.googleapis.com/TransferConfig\0224projects/{project}/transferConfigs/{transfer_config}\022Iprojects/{project}/locations/{location}/transferConfigs/{transfer_config}'
  _globals['_TRANSFERRUN'].fields_by_name['name']._loaded_options = None
  _globals['_TRANSFERRUN'].fields_by_name['name']._serialized_options = b'\340A\010'
  _globals['_TRANSFERRUN'].fields_by_name['start_time']._loaded_options = None
  _globals['_TRANSFERRUN'].fields_by_name['start_time']._serialized_options = b'\340A\003'
  _globals['_TRANSFERRUN'].fields_by_name['end_time']._loaded_options = None
  _globals['_TRANSFERRUN'].fields_by_name['end_time']._serialized_options = b'\340A\003'
  _globals['_TRANSFERRUN'].fields_by_name['update_time']._loaded_options = None
  _globals['_TRANSFERRUN'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_TRANSFERRUN'].fields_by_name['params']._loaded_options = None
  _globals['_TRANSFERRUN'].fields_by_name['params']._serialized_options = b'\340A\003'
  _globals['_TRANSFERRUN'].fields_by_name['destination_dataset_id']._loaded_options = None
  _globals['_TRANSFERRUN'].fields_by_name['destination_dataset_id']._serialized_options = b'\340A\003'
  _globals['_TRANSFERRUN'].fields_by_name['data_source_id']._loaded_options = None
  _globals['_TRANSFERRUN'].fields_by_name['data_source_id']._serialized_options = b'\340A\003'
  _globals['_TRANSFERRUN'].fields_by_name['schedule']._loaded_options = None
  _globals['_TRANSFERRUN'].fields_by_name['schedule']._serialized_options = b'\340A\003'
  _globals['_TRANSFERRUN'].fields_by_name['notification_pubsub_topic']._loaded_options = None
  _globals['_TRANSFERRUN'].fields_by_name['notification_pubsub_topic']._serialized_options = b'\340A\003'
  _globals['_TRANSFERRUN'].fields_by_name['email_preferences']._loaded_options = None
  _globals['_TRANSFERRUN'].fields_by_name['email_preferences']._serialized_options = b'\340A\003'
  _globals['_TRANSFERRUN']._loaded_options = None
  _globals['_TRANSFERRUN']._serialized_options = b'\352A\300\001\n\'bigquerydatatransfer.googleapis.com/Run\022?projects/{project}/transferConfigs/{transfer_config}/runs/{run}\022Tprojects/{project}/locations/{location}/transferConfigs/{transfer_config}/runs/{run}'
