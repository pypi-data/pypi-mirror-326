...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n3google/cloud/batch/v1alpha/resource_allowance.proto\x12\x1agoogle.cloud.batch.v1alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/api/field_info.proto\x1a\x19google/api/resource.proto\x1a-google/cloud/batch/v1alpha/notification.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1agoogle/type/interval.proto\"\xd0\x04\n\x11ResourceAllowance\x12V\n\x18usage_resource_allowance\x18\x04 \x01(\x0b\x32\x32.google.cloud.batch.v1alpha.UsageResourceAllowanceH\x00\x12\x11\n\x04name\x18\x01 \x01(\tB\x03\xe0\x41\x08\x12\x18\n\x03uid\x18\x02 \x01(\tB\x0b\xe0\x41\x03\xe2\x8c\xcf\xd7\x08\x02\x08\x01\x12\x34\n\x0b\x63reate_time\x18\x03 \x01(\x0b\x32\x1a.google.protobuf.TimestampB\x03\xe0\x41\x03\x12N\n\x06labels\x18\x05 \x03(\x0b\x32\x39.google.cloud.batch.v1alpha.ResourceAllowance.LabelsEntryB\x03\xe0\x41\x01\x12\x44\n\rnotifications\x18\x06 \x03(\x0b\x32(.google.cloud.batch.v1alpha.NotificationB\x03\xe0\x41\x01\x1a-\n\x0bLabelsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t:\x02\x38\x01:\xa4\x01\xea\x41\xa0\x01\n&batch.googleapis.com/ResourceAllowance\x12Oprojects/{project}/locations/{location}/resourceAllowances/{resource_allowance}*\x12resourceAllowances2\x11resourceAllowanceB\x14\n\x12resource_allowance\"\xb2\x01\n\x16UsageResourceAllowance\x12I\n\x04spec\x18\x01 \x01(\x0b\x32\x36.google.cloud.batch.v1alpha.UsageResourceAllowanceSpecB\x03\xe0\x41\x02\x12M\n\x06status\x18\x02 \x01(\x0b\x32\x38.google.cloud.batch.v1alpha.UsageResourceAllowanceStatusB\x03\xe0\x41\x03\"\x86\x02\n\x1aUsageResourceAllowanceSpec\x12\x11\n\x04type\x18\x01 \x01(\tB\x03\xe0\x41\x02\x12P\n\x05limit\x18\x02 \x01(\x0b\x32<.google.cloud.batch.v1alpha.UsageResourceAllowanceSpec.LimitB\x03\xe0\x41\x02\x1a\x82\x01\n\x05Limit\x12J\n\x0f\x63\x61lendar_period\x18\x01 \x01(\x0e\x32*.google.cloud.batch.v1alpha.CalendarPeriodB\x03\xe0\x41\x01H\x00\x12\x17\n\x05limit\x18\x02 \x01(\x01\x42\x03\xe0\x41\x02H\x01\x88\x01\x01\x42\n\n\x08\x64urationB\x08\n\x06_limit\"\xee\x06\n\x1cUsageResourceAllowanceStatus\x12\x46\n\x05state\x18\x01 \x01(\x0e\x32\x32.google.cloud.batch.v1alpha.ResourceAllowanceStateB\x03\xe0\x41\x03\x12_\n\x0climit_status\x18\x02 \x01(\x0b\x32\x44.google.cloud.batch.v1alpha.UsageResourceAllowanceStatus.LimitStatusB\x03\xe0\x41\x03\x12_\n\x06report\x18\x03 \x01(\x0b\x32J.google.cloud.batch.v1alpha.UsageResourceAllowanceStatus.ConsumptionReportB\x03\xe0\x41\x03\x1a\x93\x01\n\x0bLimitStatus\x12\x38\n\x14\x63onsumption_interval\x18\x01 \x01(\x0b\x32\x15.google.type.IntervalB\x03\xe0\x41\x03\x12\x17\n\x05limit\x18\x02 \x01(\x01\x42\x03\xe0\x41\x03H\x00\x88\x01\x01\x12\x1a\n\x08\x63onsumed\x18\x03 \x01(\x01\x42\x03\xe0\x41\x03H\x01\x88\x01\x01\x42\x08\n\x06_limitB\x0b\n\t_consumed\x1av\n\x11PeriodConsumption\x12\x38\n\x14\x63onsumption_interval\x18\x01 \x01(\x0b\x32\x15.google.type.IntervalB\x03\xe0\x41\x03\x12\x1a\n\x08\x63onsumed\x18\x02 \x01(\x01\x42\x03\xe0\x41\x03H\x00\x88\x01\x01\x42\x0b\n\t_consumed\x1a\xb5\x02\n\x11\x43onsumptionReport\x12\x91\x01\n\x1alatest_period_consumptions\x18\x01 \x03(\x0b\x32h.google.cloud.batch.v1alpha.UsageResourceAllowanceStatus.ConsumptionReport.LatestPeriodConsumptionsEntryB\x03\xe0\x41\x03\x1a\x8b\x01\n\x1dLatestPeriodConsumptionsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12Y\n\x05value\x18\x02 \x01(\x0b\x32J.google.cloud.batch.v1alpha.UsageResourceAllowanceStatus.PeriodConsumption:\x02\x38\x01*f\n\x0e\x43\x61lendarPeriod\x12\x1f\n\x1b\x43\x41LENDAR_PERIOD_UNSPECIFIED\x10\x00\x12\t\n\x05MONTH\x10\x01\x12\x0b\n\x07QUARTER\x10\x02\x12\x08\n\x04YEAR\x10\x03\x12\x08\n\x04WEEK\x10\x04\x12\x07\n\x03\x44\x41Y\x10\x05*\x82\x01\n\x16ResourceAllowanceState\x12(\n$RESOURCE_ALLOWANCE_STATE_UNSPECIFIED\x10\x00\x12\x1d\n\x19RESOURCE_ALLOWANCE_ACTIVE\x10\x01\x12\x1f\n\x1bRESOURCE_ALLOWANCE_DEPLETED\x10\x02\x42\xd0\x01\n\x1e\x63om.google.cloud.batch.v1alphaB\x16ResourceAllowanceProtoP\x01Z4cloud.google.com/go/batch/apiv1alpha/batchpb;batchpb\xa2\x02\x03GCB\xaa\x02\x1aGoogle.Cloud.Batch.V1Alpha\xca\x02\x1aGoogle\\Cloud\\Batch\\V1alpha\xea\x02\x1dGoogle::Cloud::Batch::V1alphab\x06proto3')
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\036com.google.cloud.batch.v1alphaB\026ResourceAllowanceProtoP\001Z4cloud.google.com/go/batch/apiv1alpha/batchpb;batchpb\242\002\003GCB\252\002\032Google.Cloud.Batch.V1Alpha\312\002\032Google\\Cloud\\Batch\\V1alpha\352\002\035Google::Cloud::Batch::V1alpha'
  _globals['_RESOURCEALLOWANCE_LABELSENTRY']._loaded_options = None
  _globals['_RESOURCEALLOWANCE_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_RESOURCEALLOWANCE'].fields_by_name['name']._loaded_options = None
  _globals['_RESOURCEALLOWANCE'].fields_by_name['name']._serialized_options = b'\340A\010'
  _globals['_RESOURCEALLOWANCE'].fields_by_name['uid']._loaded_options = None
  _globals['_RESOURCEALLOWANCE'].fields_by_name['uid']._serialized_options = b'\340A\003\342\214\317\327\010\002\010\001'
  _globals['_RESOURCEALLOWANCE'].fields_by_name['create_time']._loaded_options = None
  _globals['_RESOURCEALLOWANCE'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_RESOURCEALLOWANCE'].fields_by_name['labels']._loaded_options = None
  _globals['_RESOURCEALLOWANCE'].fields_by_name['labels']._serialized_options = b'\340A\001'
  _globals['_RESOURCEALLOWANCE'].fields_by_name['notifications']._loaded_options = None
  _globals['_RESOURCEALLOWANCE'].fields_by_name['notifications']._serialized_options = b'\340A\001'
  _globals['_RESOURCEALLOWANCE']._loaded_options = None
  _globals['_RESOURCEALLOWANCE']._serialized_options = b'\352A\240\001\n&batch.googleapis.com/ResourceAllowance\022Oprojects/{project}/locations/{location}/resourceAllowances/{resource_allowance}*\022resourceAllowances2\021resourceAllowance'
  _globals['_USAGERESOURCEALLOWANCE'].fields_by_name['spec']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCE'].fields_by_name['spec']._serialized_options = b'\340A\002'
  _globals['_USAGERESOURCEALLOWANCE'].fields_by_name['status']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCE'].fields_by_name['status']._serialized_options = b'\340A\003'
  _globals['_USAGERESOURCEALLOWANCESPEC_LIMIT'].fields_by_name['calendar_period']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESPEC_LIMIT'].fields_by_name['calendar_period']._serialized_options = b'\340A\001'
  _globals['_USAGERESOURCEALLOWANCESPEC_LIMIT'].fields_by_name['limit']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESPEC_LIMIT'].fields_by_name['limit']._serialized_options = b'\340A\002'
  _globals['_USAGERESOURCEALLOWANCESPEC'].fields_by_name['type']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESPEC'].fields_by_name['type']._serialized_options = b'\340A\002'
  _globals['_USAGERESOURCEALLOWANCESPEC'].fields_by_name['limit']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESPEC'].fields_by_name['limit']._serialized_options = b'\340A\002'
  _globals['_USAGERESOURCEALLOWANCESTATUS_LIMITSTATUS'].fields_by_name['consumption_interval']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESTATUS_LIMITSTATUS'].fields_by_name['consumption_interval']._serialized_options = b'\340A\003'
  _globals['_USAGERESOURCEALLOWANCESTATUS_LIMITSTATUS'].fields_by_name['limit']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESTATUS_LIMITSTATUS'].fields_by_name['limit']._serialized_options = b'\340A\003'
  _globals['_USAGERESOURCEALLOWANCESTATUS_LIMITSTATUS'].fields_by_name['consumed']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESTATUS_LIMITSTATUS'].fields_by_name['consumed']._serialized_options = b'\340A\003'
  _globals['_USAGERESOURCEALLOWANCESTATUS_PERIODCONSUMPTION'].fields_by_name['consumption_interval']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESTATUS_PERIODCONSUMPTION'].fields_by_name['consumption_interval']._serialized_options = b'\340A\003'
  _globals['_USAGERESOURCEALLOWANCESTATUS_PERIODCONSUMPTION'].fields_by_name['consumed']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESTATUS_PERIODCONSUMPTION'].fields_by_name['consumed']._serialized_options = b'\340A\003'
  _globals['_USAGERESOURCEALLOWANCESTATUS_CONSUMPTIONREPORT_LATESTPERIODCONSUMPTIONSENTRY']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESTATUS_CONSUMPTIONREPORT_LATESTPERIODCONSUMPTIONSENTRY']._serialized_options = b'8\001'
  _globals['_USAGERESOURCEALLOWANCESTATUS_CONSUMPTIONREPORT'].fields_by_name['latest_period_consumptions']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESTATUS_CONSUMPTIONREPORT'].fields_by_name['latest_period_consumptions']._serialized_options = b'\340A\003'
  _globals['_USAGERESOURCEALLOWANCESTATUS'].fields_by_name['state']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESTATUS'].fields_by_name['state']._serialized_options = b'\340A\003'
  _globals['_USAGERESOURCEALLOWANCESTATUS'].fields_by_name['limit_status']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESTATUS'].fields_by_name['limit_status']._serialized_options = b'\340A\003'
  _globals['_USAGERESOURCEALLOWANCESTATUS'].fields_by_name['report']._loaded_options = None
  _globals['_USAGERESOURCEALLOWANCESTATUS'].fields_by_name['report']._serialized_options = b'\340A\003'
