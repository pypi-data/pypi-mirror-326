...
class SearchRequest(_message.Message):
    __slots__ = ("serving_config", "branch", "query", "image_query", "page_size", "page_token", "offset", "data_store_specs", "filter", "canonical_filter", "order_by", "user_info", "language_code", "region_code", "facet_specs", "boost_spec", "params", "query_expansion_spec", "spell_correction_spec", "user_pseudo_id", "content_search_spec", "embedding_spec", "ranking_expression", "safe_search", "user_labels", "natural_language_query_understanding_spec", "search_as_you_type_spec", "custom_fine_tuning_spec", "session", "session_spec", "relevance_threshold")
...
class SearchResponse(_message.Message):
    ...
    class SearchResult(_message.Message):
        __slots__ = ("id", "document", "chunk", "model_scores")
        ...
        def __init__(self, id: _Optional[str] = ..., document: _Optional[_Union[_document_pb2.Document, _Mapping]] = ..., chunk: _Optional[_Union[_chunk_pb2.Chunk, _Mapping]] = ..., model_scores: _Optional[_Mapping[str, _common_pb2.DoubleList]] = ...) -> None: ...
