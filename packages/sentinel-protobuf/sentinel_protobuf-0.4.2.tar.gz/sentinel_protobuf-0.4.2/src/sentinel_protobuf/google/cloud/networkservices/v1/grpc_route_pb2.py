...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/cloud/networkservices/v1/grpc_route.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n#com.google.cloud.networkservices.v1B\016GrpcRouteProtoP\001ZMcloud.google.com/go/networkservices/apiv1/networkservicespb;networkservicespb\252\002\037Google.Cloud.NetworkServices.V1\312\002\037Google\\Cloud\\NetworkServices\\V1\352\002\"Google::Cloud::NetworkServices::V1'
  _globals['_GRPCROUTE_METHODMATCH'].fields_by_name['type']._loaded_options = None
  _globals['_GRPCROUTE_METHODMATCH'].fields_by_name['type']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE_METHODMATCH'].fields_by_name['grpc_service']._loaded_options = None
  _globals['_GRPCROUTE_METHODMATCH'].fields_by_name['grpc_service']._serialized_options = b'\340A\002'
  _globals['_GRPCROUTE_METHODMATCH'].fields_by_name['grpc_method']._loaded_options = None
  _globals['_GRPCROUTE_METHODMATCH'].fields_by_name['grpc_method']._serialized_options = b'\340A\002'
  _globals['_GRPCROUTE_METHODMATCH'].fields_by_name['case_sensitive']._loaded_options = None
  _globals['_GRPCROUTE_METHODMATCH'].fields_by_name['case_sensitive']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE_HEADERMATCH'].fields_by_name['type']._loaded_options = None
  _globals['_GRPCROUTE_HEADERMATCH'].fields_by_name['type']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE_HEADERMATCH'].fields_by_name['key']._loaded_options = None
  _globals['_GRPCROUTE_HEADERMATCH'].fields_by_name['key']._serialized_options = b'\340A\002'
  _globals['_GRPCROUTE_HEADERMATCH'].fields_by_name['value']._loaded_options = None
  _globals['_GRPCROUTE_HEADERMATCH'].fields_by_name['value']._serialized_options = b'\340A\002'
  _globals['_GRPCROUTE_ROUTEMATCH'].fields_by_name['method']._loaded_options = None
  _globals['_GRPCROUTE_ROUTEMATCH'].fields_by_name['method']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE_ROUTEMATCH'].fields_by_name['headers']._loaded_options = None
  _globals['_GRPCROUTE_ROUTEMATCH'].fields_by_name['headers']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE_DESTINATION'].fields_by_name['service_name']._loaded_options = None
  _globals['_GRPCROUTE_DESTINATION'].fields_by_name['service_name']._serialized_options = b'\340A\002\372A\'\n%compute.googleapis.com/BackendService'
  _globals['_GRPCROUTE_DESTINATION'].fields_by_name['weight']._loaded_options = None
  _globals['_GRPCROUTE_DESTINATION'].fields_by_name['weight']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE_ROUTEACTION'].fields_by_name['destinations']._loaded_options = None
  _globals['_GRPCROUTE_ROUTEACTION'].fields_by_name['destinations']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE_ROUTEACTION'].fields_by_name['fault_injection_policy']._loaded_options = None
  _globals['_GRPCROUTE_ROUTEACTION'].fields_by_name['fault_injection_policy']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE_ROUTEACTION'].fields_by_name['timeout']._loaded_options = None
  _globals['_GRPCROUTE_ROUTEACTION'].fields_by_name['timeout']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE_ROUTEACTION'].fields_by_name['retry_policy']._loaded_options = None
  _globals['_GRPCROUTE_ROUTEACTION'].fields_by_name['retry_policy']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE_ROUTERULE'].fields_by_name['matches']._loaded_options = None
  _globals['_GRPCROUTE_ROUTERULE'].fields_by_name['matches']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE_ROUTERULE'].fields_by_name['action']._loaded_options = None
  _globals['_GRPCROUTE_ROUTERULE'].fields_by_name['action']._serialized_options = b'\340A\002'
  _globals['_GRPCROUTE_LABELSENTRY']._loaded_options = None
  _globals['_GRPCROUTE_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_GRPCROUTE'].fields_by_name['name']._loaded_options = None
  _globals['_GRPCROUTE'].fields_by_name['name']._serialized_options = b'\340A\002'
  _globals['_GRPCROUTE'].fields_by_name['self_link']._loaded_options = None
  _globals['_GRPCROUTE'].fields_by_name['self_link']._serialized_options = b'\340A\003'
  _globals['_GRPCROUTE'].fields_by_name['create_time']._loaded_options = None
  _globals['_GRPCROUTE'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_GRPCROUTE'].fields_by_name['update_time']._loaded_options = None
  _globals['_GRPCROUTE'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_GRPCROUTE'].fields_by_name['labels']._loaded_options = None
  _globals['_GRPCROUTE'].fields_by_name['labels']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE'].fields_by_name['description']._loaded_options = None
  _globals['_GRPCROUTE'].fields_by_name['description']._serialized_options = b'\340A\001'
  _globals['_GRPCROUTE'].fields_by_name['hostnames']._loaded_options = None
  _globals['_GRPCROUTE'].fields_by_name['hostnames']._serialized_options = b'\340A\002'
  _globals['_GRPCROUTE'].fields_by_name['meshes']._loaded_options = None
  _globals['_GRPCROUTE'].fields_by_name['meshes']._serialized_options = b'\340A\001\372A%\n#networkservices.googleapis.com/Mesh'
  _globals['_GRPCROUTE'].fields_by_name['gateways']._loaded_options = None
  _globals['_GRPCROUTE'].fields_by_name['gateways']._serialized_options = b'\340A\001\372A(\n&networkservices.googleapis.com/Gateway'
  _globals['_GRPCROUTE'].fields_by_name['rules']._loaded_options = None
  _globals['_GRPCROUTE'].fields_by_name['rules']._serialized_options = b'\340A\002'
  _globals['_GRPCROUTE']._loaded_options = None
  _globals['_GRPCROUTE']._serialized_options = b'\352Ak\n(networkservices.googleapis.com/GrpcRoute\022?projects/{project}/locations/{location}/grpcRoutes/{grpc_route}'
  _globals['_LISTGRPCROUTESREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTGRPCROUTESREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A*\022(networkservices.googleapis.com/GrpcRoute'
  _globals['_GETGRPCROUTEREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETGRPCROUTEREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A*\n(networkservices.googleapis.com/GrpcRoute'
  _globals['_CREATEGRPCROUTEREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_CREATEGRPCROUTEREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A*\022(networkservices.googleapis.com/GrpcRoute'
  _globals['_CREATEGRPCROUTEREQUEST'].fields_by_name['grpc_route_id']._loaded_options = None
  _globals['_CREATEGRPCROUTEREQUEST'].fields_by_name['grpc_route_id']._serialized_options = b'\340A\002'
  _globals['_CREATEGRPCROUTEREQUEST'].fields_by_name['grpc_route']._loaded_options = None
  _globals['_CREATEGRPCROUTEREQUEST'].fields_by_name['grpc_route']._serialized_options = b'\340A\002'
  _globals['_UPDATEGRPCROUTEREQUEST'].fields_by_name['update_mask']._loaded_options = None
  _globals['_UPDATEGRPCROUTEREQUEST'].fields_by_name['update_mask']._serialized_options = b'\340A\001'
  _globals['_UPDATEGRPCROUTEREQUEST'].fields_by_name['grpc_route']._loaded_options = None
  _globals['_UPDATEGRPCROUTEREQUEST'].fields_by_name['grpc_route']._serialized_options = b'\340A\002'
  _globals['_DELETEGRPCROUTEREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_DELETEGRPCROUTEREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A*\n(networkservices.googleapis.com/GrpcRoute'
  _globals['_GRPCROUTE']._serialized_start=245
  _globals['_GRPCROUTE']._serialized_end=2689
  ...
  _globals['_GRPCROUTE_RETRYPOLICY']._serialized_start=1969
  _globals['_GRPCROUTE_RETRYPOLICY']._serialized_end=2029
  _globals['_GRPCROUTE_ROUTEACTION']._serialized_start=2032
  _globals['_GRPCROUTE_ROUTEACTION']._serialized_end=2362
  _globals['_GRPCROUTE_ROUTERULE']._serialized_start=2365
  _globals['_GRPCROUTE_ROUTERULE']._serialized_end=2530
  _globals['_GRPCROUTE_LABELSENTRY']._serialized_start=2532
  _globals['_GRPCROUTE_LABELSENTRY']._serialized_end=2577
  _globals['_LISTGRPCROUTESREQUEST']._serialized_start=2692
  _globals['_LISTGRPCROUTESREQUEST']._serialized_end=2820
  _globals['_LISTGRPCROUTESRESPONSE']._serialized_start=2822
  _globals['_LISTGRPCROUTESRESPONSE']._serialized_end=2936
  _globals['_GETGRPCROUTEREQUEST']._serialized_start=2938
  _globals['_GETGRPCROUTEREQUEST']._serialized_end=3023
  _globals['_CREATEGRPCROUTEREQUEST']._serialized_start=3026
  _globals['_CREATEGRPCROUTEREQUEST']._serialized_end=3213
  _globals['_UPDATEGRPCROUTEREQUEST']._serialized_start=3216
  _globals['_UPDATEGRPCROUTEREQUEST']._serialized_end=3363
  _globals['_DELETEGRPCROUTEREQUEST']._serialized_start=3365
  _globals['_DELETEGRPCROUTEREQUEST']._serialized_end=3453
