...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_USEREVENT'].fields_by_name['panels']._serialized_options = b'\340A\001'
  ...
  _globals['_PANELINFO'].fields_by_name['documents']._serialized_options = b'\340A\001'
