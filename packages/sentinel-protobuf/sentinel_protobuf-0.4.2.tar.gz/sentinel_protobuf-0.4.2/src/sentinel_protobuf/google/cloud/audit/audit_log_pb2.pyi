...
class AuthorizationInfo(_message.Message):
    ...
    def __init__(self, resource: _Optional[str]=..., permission: _Optional[str]=..., granted: bool=..., resource_attributes: _Optional[_Union[_attribute_context_pb2.AttributeContext.Resource, _Mapping]]=...) -> None:
        ...
