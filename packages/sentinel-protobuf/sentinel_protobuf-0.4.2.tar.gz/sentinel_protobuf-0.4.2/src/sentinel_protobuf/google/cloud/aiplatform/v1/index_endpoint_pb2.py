...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 1, '', 'google/cloud/aiplatform/v1/index_endpoint.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DEPLOYEDINDEX']._serialized_end = 1976
    _globals['_DEPLOYEDINDEXAUTHCONFIG']._serialized_start = 1979
    _globals['_DEPLOYEDINDEXAUTHCONFIG']._serialized_end = 2153
    _globals['_DEPLOYEDINDEXAUTHCONFIG_AUTHPROVIDER']._serialized_start = 2095
    _globals['_DEPLOYEDINDEXAUTHCONFIG_AUTHPROVIDER']._serialized_end = 2153
    _globals['_INDEXPRIVATEENDPOINTS']._serialized_start = 2156
    _globals['_INDEXPRIVATEENDPOINTS']._serialized_end = 2334