...
class Repository(_message.Message):
    __slots__ = ('name', 'display_name', 'git_remote_settings', 'npmrc_environment_variables_secret_version', 'workspace_compilation_overrides', 'labels', 'set_authenticated_user_admin', 'service_account')
    ...
    def __init__(self, name: _Optional[str]=..., display_name: _Optional[str]=..., git_remote_settings: _Optional[_Union[Repository.GitRemoteSettings, _Mapping]]=..., npmrc_environment_variables_secret_version: _Optional[str]=..., workspace_compilation_overrides: _Optional[_Union[Repository.WorkspaceCompilationOverrides, _Mapping]]=..., labels: _Optional[_Mapping[str, str]]=..., set_authenticated_user_admin: bool=..., service_account: _Optional[str]=...) -> None:
        ...
...
class ReleaseConfig(_message.Message):
    __slots__ = ('name', 'git_commitish', 'code_compilation_config', 'cron_schedule', 'time_zone', 'recent_scheduled_release_records', 'release_compilation_result')

    class ScheduledReleaseRecord(_message.Message):
        __slots__ = ('release_time', 'compilation_result', 'error_status')
        ...
        def __init__(self, release_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., compilation_result: _Optional[str]=..., error_status: _Optional[_Union[_status_pb2.Status, _Mapping]]=...) -> None:
            ...
    NAME_FIELD_NUMBER: _ClassVar[int]
...
class CompilationResult(_message.Message):
    __slots__ = ('name', 'git_commitish', 'workspace', 'release_config', 'code_compilation_config', 'resolved_git_commit_sha', 'dataform_core_version', 'compilation_errors')
    ...
    def __init__(self, name: _Optional[str]=..., git_commitish: _Optional[str]=..., workspace: _Optional[str]=..., release_config: _Optional[str]=..., code_compilation_config: _Optional[_Union[CodeCompilationConfig, _Mapping]]=..., resolved_git_commit_sha: _Optional[str]=..., dataform_core_version: _Optional[str]=..., compilation_errors: _Optional[_Iterable[_Union[CompilationResult.CompilationError, _Mapping]]]=...) -> None:
        ...
...
class WorkflowConfig(_message.Message):
    __slots__ = ('name', 'release_config', 'invocation_config', 'cron_schedule', 'time_zone', 'recent_scheduled_execution_records')

    class ScheduledExecutionRecord(_message.Message):
        __slots__ = ('execution_time', 'workflow_invocation', 'error_status')
        ...
        def __init__(self, execution_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., workflow_invocation: _Optional[str]=..., error_status: _Optional[_Union[_status_pb2.Status, _Mapping]]=...) -> None:
            ...
    NAME_FIELD_NUMBER: _ClassVar[int]
    RELEASE_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str]=..., release_config: _Optional[str]=..., invocation_config: _Optional[_Union[InvocationConfig, _Mapping]]=..., cron_schedule: _Optional[str]=..., time_zone: _Optional[str]=..., recent_scheduled_execution_records: _Optional[_Iterable[_Union[WorkflowConfig.ScheduledExecutionRecord, _Mapping]]]=...) -> None:
        ...
...
class WorkflowInvocation(_message.Message):
    __slots__ = ('name', 'compilation_result', 'workflow_config', 'invocation_config', 'state', 'invocation_timing')
    ...
    def __init__(self, name: _Optional[str]=..., compilation_result: _Optional[str]=..., workflow_config: _Optional[str]=..., invocation_config: _Optional[_Union[InvocationConfig, _Mapping]]=..., state: _Optional[_Union[WorkflowInvocation.State, str]]=..., invocation_timing: _Optional[_Union[_interval_pb2.Interval, _Mapping]]=...) -> None:
        ...
