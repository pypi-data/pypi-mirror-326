...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 1, '', 'google/cloud/security/publicca/v1/resources.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'\n%com.google.cloud.security.publicca.v1B\x0eResourcesProtoP\x01ZAcloud.google.com/go/security/publicca/apiv1/publiccapb;publiccapb\xf8\x01\x01\xaa\x02!Google.Cloud.Security.PublicCA.V1\xca\x02!Google\\Cloud\\Security\\PublicCA\\V1\xea\x02%Google::Cloud::Security::PublicCA::V1'
