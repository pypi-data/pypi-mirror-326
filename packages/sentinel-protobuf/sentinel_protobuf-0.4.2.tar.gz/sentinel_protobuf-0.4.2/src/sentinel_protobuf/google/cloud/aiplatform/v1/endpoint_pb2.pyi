...
class DeployedModel(_message.Message):
    __slots__ = ("dedicated_resources", "automatic_resources", "shared_resources", "id", "model", "model_version_id", "display_name", "create_time", "explanation_spec", "disable_explanations", "service_account", "disable_container_logging", "enable_access_logging", "private_endpoints", "faster_deployment_config", "status", "system_labels", "speculative_decoding_spec")
