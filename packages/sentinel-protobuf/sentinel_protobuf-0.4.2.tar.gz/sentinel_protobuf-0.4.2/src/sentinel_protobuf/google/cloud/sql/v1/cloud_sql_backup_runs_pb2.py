...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\027com.google.cloud.sql.v1B\027CloudSqlBackupRunsProtoP\001Z)cloud.google.com/go/sql/apiv1/sqlpb;sqlpb'
  _globals['_BACKUPRUN'].fields_by_name['max_chargeable_bytes']._loaded_options = None
  _globals['_BACKUPRUN'].fields_by_name['max_chargeable_bytes']._serialized_options = b'\340A\003'
  ...
  _globals['_SQLBACKUPRUNSSERVICE'].methods_by_name['Delete']._serialized_options = b'\202\323\344\223\002=*;/v1/projects/{project}/instances/{instance}/backupRuns/{id}'
  _globals['_SQLBACKUPRUNSSERVICE'].methods_by_name['Get']._loaded_options = None
  _globals['_SQLBACKUPRUNSSERVICE'].methods_by_name['Get']._serialized_options = b'\202\323\344\223\002=\022;/v1/projects/{project}/instances/{instance}/backupRuns/{id}'
  _globals['_SQLBACKUPRUNSSERVICE'].methods_by_name['Insert']._loaded_options = None
  _globals['_SQLBACKUPRUNSSERVICE'].methods_by_name['Insert']._serialized_options = b'\202\323\344\223\002>\"6/v1/projects/{project}/instances/{instance}/backupRuns:\004body'
  _globals['_SQLBACKUPRUNSSERVICE'].methods_by_name['List']._loaded_options = None
  _globals['_SQLBACKUPRUNSSERVICE'].methods_by_name['List']._serialized_options = b'\202\323\344\223\0028\0226/v1/projects/{project}/instances/{instance}/backupRuns'
