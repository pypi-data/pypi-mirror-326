...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/cloud/discoveryengine/v1beta/grounded_generation_service.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GROUNDEDGENERATIONSERVICE'].methods_by_name['StreamGenerateGroundedContent']._serialized_options = b'\202\323\344\223\002L\"G/v1beta/{location=projects/*/locations/*}:streamGenerateGroundedContent:\001*'
  _globals['_GROUNDEDGENERATIONSERVICE'].methods_by_name['GenerateGroundedContent']._loaded_options = None
  _globals['_GROUNDEDGENERATIONSERVICE'].methods_by_name['GenerateGroundedContent']._serialized_options = b'\202\323\344\223\002F\"A/v1beta/{location=projects/*/locations/*}:generateGroundedContent:\001*'
  _globals['_GROUNDEDGENERATIONSERVICE'].methods_by_name['CheckGrounding']._loaded_options = None
  _globals['_GROUNDEDGENERATIONSERVICE'].methods_by_name['CheckGrounding']._serialized_options = b'\202\323\344\223\002O\"J/v1beta/{grounding_config=projects/*/locations/*/groundingConfigs/*}:check:\001*'
