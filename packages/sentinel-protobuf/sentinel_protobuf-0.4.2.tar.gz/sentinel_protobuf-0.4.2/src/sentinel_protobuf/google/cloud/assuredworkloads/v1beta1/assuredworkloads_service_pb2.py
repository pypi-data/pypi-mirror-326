...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n)com.google.cloud.assuredworkloads.v1beta1B\034AssuredworkloadsServiceProtoP\001ZUcloud.google.com/go/assuredworkloads/apiv1beta1/assuredworkloadspb;assuredworkloadspb\252\002%Google.Cloud.AssuredWorkloads.V1Beta1\312\002%Google\\Cloud\\AssuredWorkloads\\V1beta1\352\002(Google::Cloud::AssuredWorkloads::V1beta1'
  ...
  _globals['_ASSUREDWORKLOADSSERVICE'].methods_by_name['UpdateWorkload']._serialized_options = b'\332A\024workload,update_mask'
  _globals['_ASSUREDWORKLOADSSERVICE'].methods_by_name['RestrictAllowedResources']._loaded_options = None
  _globals['_ASSUREDWORKLOADSSERVICE'].methods_by_name['RestrictAllowedResources']._serialized_options = b'\202\323\344\223\002U\"P/v1beta1/{name=organizations/*/locations/*/workloads/*}:restrictAllowedResources:\001*'
  _globals['_ASSUREDWORKLOADSSERVICE'].methods_by_name['DeleteWorkload']._loaded_options = None
  _globals['_ASSUREDWORKLOADSSERVICE'].methods_by_name['DeleteWorkload']._serialized_options = b'\332A\004name\202\323\344\223\0029*7/v1beta1/{name=organizations/*/locations/*/workloads/*}'
  _globals['_ASSUREDWORKLOADSSERVICE'].methods_by_name['GetWorkload']._loaded_options = None
  _globals['_ASSUREDWORKLOADSSERVICE'].methods_by_name['GetWorkload']._serialized_options = b'\332A\004name'
  _globals['_ASSUREDWORKLOADSSERVICE'].methods_by_name['AnalyzeWorkloadMove']._loaded_options = None
  _globals['_ASSUREDWORKLOADSSERVICE'].methods_by_name['AnalyzeWorkloadMove']._serialized_options = b'\332A\016project,target'
  _globals['_ASSUREDWORKLOADSSERVICE'].methods_by_name['ListWorkloads']._loaded_options = None
  _globals['_ASSUREDWORKLOADSSERVICE'].methods_by_name['ListWorkloads']._serialized_options = b'\332A\006parent'
