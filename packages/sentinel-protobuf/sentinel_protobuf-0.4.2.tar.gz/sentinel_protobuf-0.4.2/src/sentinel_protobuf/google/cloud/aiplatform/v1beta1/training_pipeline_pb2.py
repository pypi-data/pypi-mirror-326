...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n#com.google.cloud.aiplatform.v1beta1B\025TrainingPipelineProtoP\001ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\252\002\037Google.Cloud.AIPlatform.V1Beta1\312\002\037Google\\Cloud\\AIPlatform\\V1beta1\352\002\"Google::Cloud::AIPlatform::V1beta1'
  _globals['_TRAININGPIPELINE_LABELSENTRY']._loaded_options = None
  _globals['_TRAININGPIPELINE_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_TRAININGPIPELINE'].fields_by_name['name']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_TRAININGPIPELINE'].fields_by_name['display_name']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['display_name']._serialized_options = b'\340A\002'
  _globals['_TRAININGPIPELINE'].fields_by_name['training_task_definition']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['training_task_definition']._serialized_options = b'\340A\002'
  _globals['_TRAININGPIPELINE'].fields_by_name['training_task_inputs']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['training_task_inputs']._serialized_options = b'\340A\002'
  _globals['_TRAININGPIPELINE'].fields_by_name['training_task_metadata']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['training_task_metadata']._serialized_options = b'\340A\003'
  _globals['_TRAININGPIPELINE'].fields_by_name['model_id']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['model_id']._serialized_options = b'\340A\001'
  _globals['_TRAININGPIPELINE'].fields_by_name['parent_model']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['parent_model']._serialized_options = b'\340A\001'
  _globals['_TRAININGPIPELINE'].fields_by_name['state']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['state']._serialized_options = b'\340A\003'
  _globals['_TRAININGPIPELINE'].fields_by_name['error']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['error']._serialized_options = b'\340A\003'
  _globals['_TRAININGPIPELINE'].fields_by_name['create_time']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_TRAININGPIPELINE'].fields_by_name['start_time']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['start_time']._serialized_options = b'\340A\003'
  _globals['_TRAININGPIPELINE'].fields_by_name['end_time']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['end_time']._serialized_options = b'\340A\003'
  _globals['_TRAININGPIPELINE'].fields_by_name['update_time']._loaded_options = None
  _globals['_TRAININGPIPELINE'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_TRAININGPIPELINE']._loaded_options = None
  _globals['_TRAININGPIPELINE']._serialized_options = b'\352A{\n*aiplatform.googleapis.com/TrainingPipeline\022Mprojects/{project}/locations/{location}/trainingPipelines/{training_pipeline}'
  _globals['_INPUTDATACONFIG'].fields_by_name['dataset_id']._loaded_options = None
  _globals['_INPUTDATACONFIG'].fields_by_name['dataset_id']._serialized_options = b'\340A\002'
  _globals['_FILTERSPLIT'].fields_by_name['training_filter']._loaded_options = None
  _globals['_FILTERSPLIT'].fields_by_name['training_filter']._serialized_options = b'\340A\002'
  _globals['_FILTERSPLIT'].fields_by_name['validation_filter']._loaded_options = None
  _globals['_FILTERSPLIT'].fields_by_name['validation_filter']._serialized_options = b'\340A\002'
  _globals['_FILTERSPLIT'].fields_by_name['test_filter']._loaded_options = None
  _globals['_FILTERSPLIT'].fields_by_name['test_filter']._serialized_options = b'\340A\002'
  _globals['_PREDEFINEDSPLIT'].fields_by_name['key']._loaded_options = None
  _globals['_PREDEFINEDSPLIT'].fields_by_name['key']._serialized_options = b'\340A\002'
  _globals['_TIMESTAMPSPLIT'].fields_by_name['key']._loaded_options = None
  _globals['_TIMESTAMPSPLIT'].fields_by_name['key']._serialized_options = b'\340A\002'
  _globals['_STRATIFIEDSPLIT'].fields_by_name['key']._loaded_options = None
  _globals['_STRATIFIEDSPLIT'].fields_by_name['key']._serialized_options = b'\340A\002'
