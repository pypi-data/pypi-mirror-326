...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/cloud/aiplatform/v1beta1/nas_job.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n#com.google.cloud.aiplatform.v1beta1B\013NasJobProtoP\001ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\252\002\037Google.Cloud.AIPlatform.V1Beta1\312\002\037Google\\Cloud\\AIPlatform\\V1beta1\352\002\"Google::Cloud::AIPlatform::V1beta1'
  _globals['_NASJOB_LABELSENTRY']._loaded_options = None
  _globals['_NASJOB_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_NASJOB'].fields_by_name['name']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_NASJOB'].fields_by_name['display_name']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['display_name']._serialized_options = b'\340A\002'
  _globals['_NASJOB'].fields_by_name['nas_job_spec']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['nas_job_spec']._serialized_options = b'\340A\002'
  _globals['_NASJOB'].fields_by_name['nas_job_output']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['nas_job_output']._serialized_options = b'\340A\003'
  _globals['_NASJOB'].fields_by_name['state']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['state']._serialized_options = b'\340A\003'
  _globals['_NASJOB'].fields_by_name['create_time']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_NASJOB'].fields_by_name['start_time']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['start_time']._serialized_options = b'\340A\003'
  _globals['_NASJOB'].fields_by_name['end_time']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['end_time']._serialized_options = b'\340A\003'
  _globals['_NASJOB'].fields_by_name['update_time']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_NASJOB'].fields_by_name['error']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['error']._serialized_options = b'\340A\003'
  _globals['_NASJOB'].fields_by_name['enable_restricted_image_training']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['enable_restricted_image_training']._serialized_options = b'\030\001\340A\001'
  _globals['_NASJOB'].fields_by_name['satisfies_pzs']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['satisfies_pzs']._serialized_options = b'\340A\003'
  _globals['_NASJOB'].fields_by_name['satisfies_pzi']._loaded_options = None
  _globals['_NASJOB'].fields_by_name['satisfies_pzi']._serialized_options = b'\340A\003'
  _globals['_NASJOB']._loaded_options = None
  _globals['_NASJOB']._serialized_options = b'\352A]\n aiplatform.googleapis.com/NasJob\0229projects/{project}/locations/{location}/nasJobs/{nas_job}'
  _globals['_NASTRIALDETAIL'].fields_by_name['name']._loaded_options = None
  _globals['_NASTRIALDETAIL'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_NASTRIALDETAIL']._loaded_options = None
  _globals['_NASTRIALDETAIL']._serialized_options = b'\352A\210\001\n(aiplatform.googleapis.com/NasTrialDetail\022\\projects/{project}/locations/{location}/nasJobs/{nas_job}/nasTrialDetails/{nas_trial_detail}'
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_METRICSPEC'].fields_by_name['metric_id']._loaded_options = None
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_METRICSPEC'].fields_by_name['metric_id']._serialized_options = b'\340A\002'
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_METRICSPEC'].fields_by_name['goal']._loaded_options = None
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_METRICSPEC'].fields_by_name['goal']._serialized_options = b'\340A\002'
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_SEARCHTRIALSPEC'].fields_by_name['search_trial_job_spec']._loaded_options = None
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_SEARCHTRIALSPEC'].fields_by_name['search_trial_job_spec']._serialized_options = b'\340A\002'
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_SEARCHTRIALSPEC'].fields_by_name['max_trial_count']._loaded_options = None
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_SEARCHTRIALSPEC'].fields_by_name['max_trial_count']._serialized_options = b'\340A\002'
  ...
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_SEARCHTRIALSPEC'].fields_by_name['max_parallel_trial_count']._serialized_options = b'\340A\002'
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_TRAINTRIALSPEC'].fields_by_name['train_trial_job_spec']._loaded_options = None
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_TRAINTRIALSPEC'].fields_by_name['train_trial_job_spec']._serialized_options = b'\340A\002'
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_TRAINTRIALSPEC'].fields_by_name['max_parallel_trial_count']._loaded_options = None
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_TRAINTRIALSPEC'].fields_by_name['max_parallel_trial_count']._serialized_options = b'\340A\002'
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_TRAINTRIALSPEC'].fields_by_name['frequency']._loaded_options = None
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC_TRAINTRIALSPEC'].fields_by_name['frequency']._serialized_options = b'\340A\002'
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC'].fields_by_name['search_trial_spec']._loaded_options = None
  _globals['_NASJOBSPEC_MULTITRIALALGORITHMSPEC'].fields_by_name['search_trial_spec']._serialized_options = b'\340A\002'
  _globals['_NASJOBOUTPUT_MULTITRIALJOBOUTPUT'].fields_by_name['search_trials']._loaded_options = None
  _globals['_NASJOBOUTPUT_MULTITRIALJOBOUTPUT'].fields_by_name['search_trials']._serialized_options = b'\340A\003'
  _globals['_NASJOBOUTPUT_MULTITRIALJOBOUTPUT'].fields_by_name['train_trials']._loaded_options = None
  _globals['_NASJOBOUTPUT_MULTITRIALJOBOUTPUT'].fields_by_name['train_trials']._serialized_options = b'\340A\003'
  _globals['_NASJOBOUTPUT'].fields_by_name['multi_trial_job_output']._loaded_options = None
  _globals['_NASJOBOUTPUT'].fields_by_name['multi_trial_job_output']._serialized_options = b'\340A\003'
  _globals['_NASTRIAL'].fields_by_name['id']._loaded_options = None
  _globals['_NASTRIAL'].fields_by_name['id']._serialized_options = b'\340A\003'
  _globals['_NASTRIAL'].fields_by_name['state']._loaded_options = None
  _globals['_NASTRIAL'].fields_by_name['state']._serialized_options = b'\340A\003'
  _globals['_NASTRIAL'].fields_by_name['final_measurement']._loaded_options = None
  _globals['_NASTRIAL'].fields_by_name['final_measurement']._serialized_options = b'\340A\003'
  _globals['_NASTRIAL'].fields_by_name['start_time']._loaded_options = None
  _globals['_NASTRIAL'].fields_by_name['start_time']._serialized_options = b'\340A\003'
  _globals['_NASTRIAL'].fields_by_name['end_time']._loaded_options = None
  _globals['_NASTRIAL'].fields_by_name['end_time']._serialized_options = b'\340A\003'
