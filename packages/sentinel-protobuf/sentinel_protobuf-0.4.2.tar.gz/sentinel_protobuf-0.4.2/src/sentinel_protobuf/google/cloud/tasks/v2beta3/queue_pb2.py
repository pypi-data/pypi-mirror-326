...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\036com.google.cloud.tasks.v2beta3B\nQueueProtoP\001ZCcloud.google.com/go/cloudtasks/apiv2beta3/cloudtaskspb;cloudtaskspb'
  _globals['_QUEUE'].fields_by_name['type']._loaded_options = None
  _globals['_QUEUE'].fields_by_name['type']._serialized_options = b'\340A\005'
  _globals['_QUEUE'].fields_by_name['stats']._loaded_options = None
  _globals['_QUEUE'].fields_by_name['stats']._serialized_options = b'\340A\003'
  _globals['_QUEUE']._loaded_options = None
  _globals['_QUEUE']._serialized_options = b'\352AY\n\037cloudtasks.googleapis.com/Queue\0226projects/{project}/locations/{location}/queues/{queue}'
  _globals['_QUEUESTATS'].fields_by_name['tasks_count']._loaded_options = None
  _globals['_QUEUESTATS'].fields_by_name['tasks_count']._serialized_options = b'\340A\003'
  _globals['_QUEUESTATS'].fields_by_name['oldest_estimated_arrival_time']._loaded_options = None
  _globals['_QUEUESTATS'].fields_by_name['oldest_estimated_arrival_time']._serialized_options = b'\340A\003'
  _globals['_QUEUESTATS'].fields_by_name['executed_last_minute_count']._loaded_options = None
  _globals['_QUEUESTATS'].fields_by_name['executed_last_minute_count']._serialized_options = b'\340A\003'
  _globals['_QUEUESTATS'].fields_by_name['concurrent_dispatches_count']._loaded_options = None
  _globals['_QUEUESTATS'].fields_by_name['concurrent_dispatches_count']._serialized_options = b'\340A\003'
  _globals['_QUEUESTATS'].fields_by_name['effective_execution_rate']._loaded_options = None
  _globals['_QUEUESTATS'].fields_by_name['effective_execution_rate']._serialized_options = b'\340A\003'
