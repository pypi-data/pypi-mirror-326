...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n com.google.cloud.optimization.v1B\021FleetRoutingProtoP\001ZDcloud.google.com/go/optimization/apiv1/optimizationpb;optimizationpb'
  ...
  _globals['_OPTIMIZETOURSREQUEST'].fields_by_name['populate_travel_step_polylines']._serialized_options = b'\030\001'
  ...
  _globals['_OPTIMIZETOURSRESPONSE'].fields_by_name['total_cost']._serialized_options = b'\030\001'
  ...
  _globals['_SHIPMENTMODEL_BREAKRULE_BREAKREQUEST'].fields_by_name['earliest_start_time']._serialized_options = b'\340A\002'
  _globals['_SHIPMENTMODEL_BREAKRULE_BREAKREQUEST'].fields_by_name['latest_start_time']._loaded_options = None
  _globals['_SHIPMENTMODEL_BREAKRULE_BREAKREQUEST'].fields_by_name['latest_start_time']._serialized_options = b'\340A\002'
  _globals['_SHIPMENTMODEL_BREAKRULE_BREAKREQUEST'].fields_by_name['min_duration']._loaded_options = None
  _globals['_SHIPMENTMODEL_BREAKRULE_BREAKREQUEST'].fields_by_name['min_duration']._serialized_options = b'\340A\002'
  _globals['_SHIPMENTMODEL_BREAKRULE_FREQUENCYCONSTRAINT'].fields_by_name['min_break_duration']._loaded_options = None
  _globals['_SHIPMENTMODEL_BREAKRULE_FREQUENCYCONSTRAINT'].fields_by_name['min_break_duration']._serialized_options = b'\340A\002'
  _globals['_SHIPMENTMODEL_BREAKRULE_FREQUENCYCONSTRAINT'].fields_by_name['max_inter_break_duration']._loaded_options = None
  _globals['_SHIPMENTMODEL_BREAKRULE_FREQUENCYCONSTRAINT'].fields_by_name['max_inter_break_duration']._serialized_options = b'\340A\002'
  _globals['_SHIPMENTMODEL_BREAKRULE']._loaded_options = None
  _globals['_SHIPMENTMODEL_BREAKRULE']._serialized_options = b'\030\001'
  _globals['_SHIPMENTMODEL'].fields_by_name['break_rules']._loaded_options = None
  _globals['_SHIPMENTMODEL'].fields_by_name['break_rules']._serialized_options = b'\030\001'
  ...
  _globals['_SHIPMENT_VISITREQUEST'].fields_by_name['demands']._serialized_options = b'\030\001'
  ...
  _globals['_SHIPMENT'].fields_by_name['demands']._serialized_options = b'\030\001'
  ...
  _globals['_VEHICLE'].fields_by_name['route_modifiers']._serialized_options = b'\340A\001'
  _globals['_VEHICLE'].fields_by_name['break_rule_indices']._loaded_options = None
  _globals['_VEHICLE'].fields_by_name['break_rule_indices']._serialized_options = b'\030\001'
  _globals['_VEHICLE'].fields_by_name['capacities']._loaded_options = None
  _globals['_VEHICLE'].fields_by_name['capacities']._serialized_options = b'\030\001'
  _globals['_VEHICLE'].fields_by_name['start_load_intervals']._loaded_options = None
  _globals['_VEHICLE'].fields_by_name['start_load_intervals']._serialized_options = b'\030\001'
  _globals['_VEHICLE'].fields_by_name['end_load_intervals']._loaded_options = None
  _globals['_VEHICLE'].fields_by_name['end_load_intervals']._serialized_options = b'\030\001'
  _globals['_CAPACITYQUANTITY']._loaded_options = None
  _globals['_CAPACITYQUANTITY']._serialized_options = b'\030\001'
  _globals['_CAPACITYQUANTITYINTERVAL']._loaded_options = None
  _globals['_CAPACITYQUANTITYINTERVAL']._serialized_options = b'\030\001'
  ...
  _globals['_SHIPMENTROUTE_DELAY']._serialized_options = b'\030\001'
  ...
  _globals['_SHIPMENTROUTE_VISIT'].fields_by_name['arrival_loads']._serialized_options = b'\030\001'
  _globals['_SHIPMENTROUTE_VISIT'].fields_by_name['delay_before_start']._loaded_options = None
  _globals['_SHIPMENTROUTE_VISIT'].fields_by_name['delay_before_start']._serialized_options = b'\030\001'
  _globals['_SHIPMENTROUTE_VISIT'].fields_by_name['demands']._loaded_options = None
  _globals['_SHIPMENTROUTE_VISIT'].fields_by_name['demands']._serialized_options = b'\030\001'
  ...
  _globals['_SHIPMENTROUTE_TRANSITION'].fields_by_name['loads']._serialized_options = b'\030\001'
  _globals['_SHIPMENTROUTE_TRAVELSTEP']._loaded_options = None
  _globals['_SHIPMENTROUTE_TRAVELSTEP']._serialized_options = b'\030\001'
  ...
  _globals['_SHIPMENTROUTE'].fields_by_name['end_loads']._serialized_options = b'\030\001'
  _globals['_SHIPMENTROUTE'].fields_by_name['travel_steps']._loaded_options = None
  _globals['_SHIPMENTROUTE'].fields_by_name['travel_steps']._serialized_options = b'\030\001'
  _globals['_SHIPMENTROUTE'].fields_by_name['vehicle_detour']._loaded_options = None
  _globals['_SHIPMENTROUTE'].fields_by_name['vehicle_detour']._serialized_options = b'\030\001'
  _globals['_SHIPMENTROUTE'].fields_by_name['delay_before_vehicle_end']._loaded_options = None
  _globals['_SHIPMENTROUTE'].fields_by_name['delay_before_vehicle_end']._serialized_options = b'\030\001'
  ...
  _globals['_AGGREGATEDMETRICS_COSTSENTRY']._serialized_options = b'8\001'
  _globals['_AGGREGATEDMETRICS'].fields_by_name['costs']._loaded_options = None
  _globals['_AGGREGATEDMETRICS'].fields_by_name['costs']._serialized_options = b'\030\001'
  _globals['_AGGREGATEDMETRICS'].fields_by_name['total_cost']._loaded_options = None
  _globals['_AGGREGATEDMETRICS'].fields_by_name['total_cost']._serialized_options = b'\030\001'
  _globals['_FLEETROUTING']._loaded_options = None
  _globals['_FLEETROUTING']._serialized_options = b'\312A cloudoptimization.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platform'
  _globals['_FLEETROUTING'].methods_by_name['OptimizeTours']._loaded_options = None
  _globals['_FLEETROUTING'].methods_by_name['OptimizeTours']._serialized_options = b'\202\323\344\223\002b\"1/v1/{parent=projects/*/locations/*}:optimizeTours:\001*Z*\"%/v1/{parent=projects/*}:optimizeTours:\001*'
  _globals['_FLEETROUTING'].methods_by_name['BatchOptimizeTours']._loaded_options = None
  _globals['_FLEETROUTING'].methods_by_name['BatchOptimizeTours']._serialized_options = b'\312A0\n\032BatchOptimizeToursResponse\022\022AsyncModelMetadata\202\323\344\223\002l\"6/v1/{parent=projects/*/locations/*}:batchOptimizeTours:\001*Z/\"*/v1/{parent=projects/*}:batchOptimizeTours:\001*'
