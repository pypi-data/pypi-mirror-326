...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n$com.google.cloud.bigquery.storage.v1B\013StreamProtoP\001Z>cloud.google.com/go/bigquery/storage/apiv1/storagepb;storagepb\252\002 Google.Cloud.BigQuery.Storage.V1\312\002 Google\\Cloud\\BigQuery\\Storage\\V1'
  _globals['_READSESSION_TABLEREADOPTIONS'].fields_by_name['arrow_serialization_options']._loaded_options = None
  _globals['_READSESSION_TABLEREADOPTIONS'].fields_by_name['arrow_serialization_options']._serialized_options = b'\340A\001'
  _globals['_READSESSION_TABLEREADOPTIONS'].fields_by_name['avro_serialization_options']._loaded_options = None
  _globals['_READSESSION_TABLEREADOPTIONS'].fields_by_name['avro_serialization_options']._serialized_options = b'\340A\001'
  _globals['_READSESSION_TABLEREADOPTIONS'].fields_by_name['sample_percentage']._loaded_options = None
  _globals['_READSESSION_TABLEREADOPTIONS'].fields_by_name['sample_percentage']._serialized_options = b'\340A\001'
  _globals['_READSESSION_TABLEREADOPTIONS'].fields_by_name['response_compression_codec']._loaded_options = None
  _globals['_READSESSION_TABLEREADOPTIONS'].fields_by_name['response_compression_codec']._serialized_options = b'\340A\001'
  _globals['_READSESSION'].fields_by_name['name']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_READSESSION'].fields_by_name['expire_time']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['expire_time']._serialized_options = b'\340A\003'
  _globals['_READSESSION'].fields_by_name['data_format']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['data_format']._serialized_options = b'\340A\005'
  _globals['_READSESSION'].fields_by_name['avro_schema']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['avro_schema']._serialized_options = b'\340A\003'
  _globals['_READSESSION'].fields_by_name['arrow_schema']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['arrow_schema']._serialized_options = b'\340A\003'
  _globals['_READSESSION'].fields_by_name['table']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['table']._serialized_options = b'\340A\005\372A\037\n\035bigquery.googleapis.com/Table'
  _globals['_READSESSION'].fields_by_name['table_modifiers']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['table_modifiers']._serialized_options = b'\340A\001'
  _globals['_READSESSION'].fields_by_name['read_options']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['read_options']._serialized_options = b'\340A\001'
  _globals['_READSESSION'].fields_by_name['streams']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['streams']._serialized_options = b'\340A\003'
  _globals['_READSESSION'].fields_by_name['estimated_total_bytes_scanned']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['estimated_total_bytes_scanned']._serialized_options = b'\340A\003'
  _globals['_READSESSION'].fields_by_name['estimated_total_physical_file_size']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['estimated_total_physical_file_size']._serialized_options = b'\340A\003'
  _globals['_READSESSION'].fields_by_name['estimated_row_count']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['estimated_row_count']._serialized_options = b'\340A\003'
  _globals['_READSESSION'].fields_by_name['trace_id']._loaded_options = None
  _globals['_READSESSION'].fields_by_name['trace_id']._serialized_options = b'\340A\001'
  _globals['_READSESSION']._loaded_options = None
  _globals['_READSESSION']._serialized_options = b'\352Ah\n*bigquerystorage.googleapis.com/ReadSession\022:projects/{project}/locations/{location}/sessions/{session}'
  _globals['_READSTREAM'].fields_by_name['name']._loaded_options = None
  _globals['_READSTREAM'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_READSTREAM']._loaded_options = None
  _globals['_READSTREAM']._serialized_options = b'\352Ax\n)bigquerystorage.googleapis.com/ReadStream\022Kprojects/{project}/locations/{location}/sessions/{session}/streams/{stream}'
  _globals['_WRITESTREAM'].fields_by_name['name']._loaded_options = None
  _globals['_WRITESTREAM'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_WRITESTREAM'].fields_by_name['type']._loaded_options = None
  _globals['_WRITESTREAM'].fields_by_name['type']._serialized_options = b'\340A\005'
  _globals['_WRITESTREAM'].fields_by_name['create_time']._loaded_options = None
  _globals['_WRITESTREAM'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_WRITESTREAM'].fields_by_name['commit_time']._loaded_options = None
  _globals['_WRITESTREAM'].fields_by_name['commit_time']._serialized_options = b'\340A\003'
  _globals['_WRITESTREAM'].fields_by_name['table_schema']._loaded_options = None
  _globals['_WRITESTREAM'].fields_by_name['table_schema']._serialized_options = b'\340A\003'
  _globals['_WRITESTREAM'].fields_by_name['write_mode']._loaded_options = None
  _globals['_WRITESTREAM'].fields_by_name['write_mode']._serialized_options = b'\340A\005'
  _globals['_WRITESTREAM'].fields_by_name['location']._loaded_options = None
  _globals['_WRITESTREAM'].fields_by_name['location']._serialized_options = b'\340A\005'
  _globals['_WRITESTREAM']._loaded_options = None
  _globals['_WRITESTREAM']._serialized_options = b'\352As\n*bigquerystorage.googleapis.com/WriteStream\022Eprojects/{project}/datasets/{dataset}/tables/{table}/streams/{stream}'
