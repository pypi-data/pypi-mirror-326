...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\032com.google.cloud.retail.v2B\023CatalogServiceProtoP\001Z2cloud.google.com/go/retail/apiv2/retailpb;retailpb\242\002\006RETAIL\252\002\026Google.Cloud.Retail.V2\312\002\026Google\\Cloud\\Retail\\V2\352\002\031Google::Cloud::Retail::V2'
  ...
  _globals['_CATALOGSERVICE'].methods_by_name['ListCatalogs']._serialized_options = b'\332A\006parent\202\323\344\223\002.\022,/v2/{parent=projects/*/locations/*}/catalogs'
  _globals['_CATALOGSERVICE'].methods_by_name['UpdateCatalog']._loaded_options = None
  _globals['_CATALOGSERVICE'].methods_by_name['UpdateCatalog']._serialized_options = b'\332A\023catalog,update_mask\202\323\344\223\002?24/v2/{catalog.name=projects/*/locations/*/catalogs/*}:\007catalog'
  _globals['_CATALOGSERVICE'].methods_by_name['SetDefaultBranch']._loaded_options = None
  _globals['_CATALOGSERVICE'].methods_by_name['SetDefaultBranch']._serialized_options = b'\332A\007catalog\202\323\344\223\002E\"@/v2/{catalog=projects/*/locations/*/catalogs/*}:setDefaultBranch:\001*'
  _globals['_CATALOGSERVICE'].methods_by_name['GetDefaultBranch']._loaded_options = None
  _globals['_CATALOGSERVICE'].methods_by_name['GetDefaultBranch']._serialized_options = b'\332A\007catalog\202\323\344\223\002B\022@/v2/{catalog=projects/*/locations/*/catalogs/*}:getDefaultBranch'
  _globals['_CATALOGSERVICE'].methods_by_name['GetCompletionConfig']._loaded_options = None
  _globals['_CATALOGSERVICE'].methods_by_name['GetCompletionConfig']._serialized_options = b'\332A\004name\202\323\344\223\002?\022=/v2/{name=projects/*/locations/*/catalogs/*/completionConfig}'
  _globals['_CATALOGSERVICE'].methods_by_name['UpdateCompletionConfig']._loaded_options = None
  _globals['_CATALOGSERVICE'].methods_by_name['UpdateCompletionConfig']._serialized_options = b'\332A\035completion_config,update_mask\202\323\344\223\002d2O/v2/{completion_config.name=projects/*/locations/*/catalogs/*/completionConfig}:\021completion_config'
  _globals['_CATALOGSERVICE'].methods_by_name['GetAttributesConfig']._loaded_options = None
  _globals['_CATALOGSERVICE'].methods_by_name['GetAttributesConfig']._serialized_options = b'\332A\004name\202\323\344\223\002?\022=/v2/{name=projects/*/locations/*/catalogs/*/attributesConfig}'
  _globals['_CATALOGSERVICE'].methods_by_name['UpdateAttributesConfig']._loaded_options = None
  _globals['_CATALOGSERVICE'].methods_by_name['UpdateAttributesConfig']._serialized_options = b'\332A\035attributes_config,update_mask\202\323\344\223\002d2O/v2/{attributes_config.name=projects/*/locations/*/catalogs/*/attributesConfig}:\021attributes_config'
  _globals['_CATALOGSERVICE'].methods_by_name['AddCatalogAttribute']._loaded_options = None
  _globals['_CATALOGSERVICE'].methods_by_name['AddCatalogAttribute']._serialized_options = b'\202\323\344\223\002c\"^/v2/{attributes_config=projects/*/locations/*/catalogs/*/attributesConfig}:addCatalogAttribute:\001*'
  _globals['_CATALOGSERVICE'].methods_by_name['RemoveCatalogAttribute']._loaded_options = None
  _globals['_CATALOGSERVICE'].methods_by_name['RemoveCatalogAttribute']._serialized_options = b'\202\323\344\223\002f\"a/v2/{attributes_config=projects/*/locations/*/catalogs/*/attributesConfig}:removeCatalogAttribute:\001*'
  _globals['_CATALOGSERVICE'].methods_by_name['ReplaceCatalogAttribute']._loaded_options = None
  _globals['_CATALOGSERVICE'].methods_by_name['ReplaceCatalogAttribute']._serialized_options = b'\202\323\344\223\002g\"b/v2/{attributes_config=projects/*/locations/*/catalogs/*/attributesConfig}:replaceCatalogAttribute:\001*'
