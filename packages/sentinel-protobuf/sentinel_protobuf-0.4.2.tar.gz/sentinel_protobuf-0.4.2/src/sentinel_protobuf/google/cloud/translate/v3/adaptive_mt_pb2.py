...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\035com.google.cloud.translate.v3B\017AdaptiveMtProtoP\001Z;cloud.google.com/go/translate/apiv3/translatepb;translatepb\370\001\001\252\002\031Google.Cloud.Translate.V3\312\002\031Google\\Cloud\\Translate\\V3\352\002\034Google::Cloud::Translate::V3'
  _globals['_ADAPTIVEMTDATASET'].fields_by_name['name']._loaded_options = None
  _globals['_ADAPTIVEMTDATASET'].fields_by_name['name']._serialized_options = b'\340A\002\372A,\n*translate.googleapis.com/AdaptiveMtDataset'
  _globals['_ADAPTIVEMTDATASET'].fields_by_name['create_time']._loaded_options = None
  _globals['_ADAPTIVEMTDATASET'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_ADAPTIVEMTDATASET'].fields_by_name['update_time']._loaded_options = None
  _globals['_ADAPTIVEMTDATASET'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_ADAPTIVEMTDATASET']._loaded_options = None
  _globals['_ADAPTIVEMTDATASET']._serialized_options = b'\352Ar\n*translate.googleapis.com/AdaptiveMtDataset\022Dprojects/{project}/locations/{location}/adaptiveMtDatasets/{dataset}'
  _globals['_CREATEADAPTIVEMTDATASETREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_CREATEADAPTIVEMTDATASETREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A#\n!locations.googleapis.com/Location'
  _globals['_CREATEADAPTIVEMTDATASETREQUEST'].fields_by_name['adaptive_mt_dataset']._loaded_options = None
  _globals['_CREATEADAPTIVEMTDATASETREQUEST'].fields_by_name['adaptive_mt_dataset']._serialized_options = b'\340A\002'
  _globals['_DELETEADAPTIVEMTDATASETREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_DELETEADAPTIVEMTDATASETREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A,\n*translate.googleapis.com/AdaptiveMtDataset'
  _globals['_GETADAPTIVEMTDATASETREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETADAPTIVEMTDATASETREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A,\n*translate.googleapis.com/AdaptiveMtDataset'
  _globals['_LISTADAPTIVEMTDATASETSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTADAPTIVEMTDATASETSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A#\n!locations.googleapis.com/Location'
  _globals['_LISTADAPTIVEMTDATASETSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTADAPTIVEMTDATASETSREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTADAPTIVEMTDATASETSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTADAPTIVEMTDATASETSREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_LISTADAPTIVEMTDATASETSREQUEST'].fields_by_name['filter']._loaded_options = None
  _globals['_LISTADAPTIVEMTDATASETSREQUEST'].fields_by_name['filter']._serialized_options = b'\340A\001'
  _globals['_LISTADAPTIVEMTDATASETSRESPONSE'].fields_by_name['adaptive_mt_datasets']._loaded_options = None
  _globals['_LISTADAPTIVEMTDATASETSRESPONSE'].fields_by_name['adaptive_mt_datasets']._serialized_options = b'\340A\003'
  _globals['_LISTADAPTIVEMTDATASETSRESPONSE'].fields_by_name['next_page_token']._loaded_options = None
  _globals['_LISTADAPTIVEMTDATASETSRESPONSE'].fields_by_name['next_page_token']._serialized_options = b'\340A\001'
  _globals['_ADAPTIVEMTTRANSLATEREQUEST_GLOSSARYCONFIG'].fields_by_name['glossary']._loaded_options = None
  _globals['_ADAPTIVEMTTRANSLATEREQUEST_GLOSSARYCONFIG'].fields_by_name['glossary']._serialized_options = b'\340A\002\372A#\n!translate.googleapis.com/Glossary'
  _globals['_ADAPTIVEMTTRANSLATEREQUEST_GLOSSARYCONFIG'].fields_by_name['ignore_case']._loaded_options = None
  _globals['_ADAPTIVEMTTRANSLATEREQUEST_GLOSSARYCONFIG'].fields_by_name['ignore_case']._serialized_options = b'\340A\001'
  _globals['_ADAPTIVEMTTRANSLATEREQUEST_GLOSSARYCONFIG'].fields_by_name['contextual_translation_enabled']._loaded_options = None
  _globals['_ADAPTIVEMTTRANSLATEREQUEST_GLOSSARYCONFIG'].fields_by_name['contextual_translation_enabled']._serialized_options = b'\340A\001'
  _globals['_ADAPTIVEMTTRANSLATEREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_ADAPTIVEMTTRANSLATEREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A#\n!locations.googleapis.com/Location'
  _globals['_ADAPTIVEMTTRANSLATEREQUEST'].fields_by_name['dataset']._loaded_options = None
  _globals['_ADAPTIVEMTTRANSLATEREQUEST'].fields_by_name['dataset']._serialized_options = b'\340A\002\372A,\n*translate.googleapis.com/AdaptiveMtDataset'
  _globals['_ADAPTIVEMTTRANSLATEREQUEST'].fields_by_name['content']._loaded_options = None
  _globals['_ADAPTIVEMTTRANSLATEREQUEST'].fields_by_name['content']._serialized_options = b'\340A\002'
  _globals['_ADAPTIVEMTTRANSLATEREQUEST'].fields_by_name['glossary_config']._loaded_options = None
  _globals['_ADAPTIVEMTTRANSLATEREQUEST'].fields_by_name['glossary_config']._serialized_options = b'\340A\001'
  _globals['_ADAPTIVEMTTRANSLATION'].fields_by_name['translated_text']._loaded_options = None
  _globals['_ADAPTIVEMTTRANSLATION'].fields_by_name['translated_text']._serialized_options = b'\340A\003'
  _globals['_ADAPTIVEMTTRANSLATERESPONSE'].fields_by_name['translations']._loaded_options = None
  _globals['_ADAPTIVEMTTRANSLATERESPONSE'].fields_by_name['translations']._serialized_options = b'\340A\003'
  _globals['_ADAPTIVEMTTRANSLATERESPONSE'].fields_by_name['language_code']._loaded_options = None
  _globals['_ADAPTIVEMTTRANSLATERESPONSE'].fields_by_name['language_code']._serialized_options = b'\340A\003'
  _globals['_ADAPTIVEMTFILE'].fields_by_name['name']._loaded_options = None
  _globals['_ADAPTIVEMTFILE'].fields_by_name['name']._serialized_options = b'\340A\002\372A)\n\'translate.googleapis.com/AdaptiveMtFile'
  _globals['_ADAPTIVEMTFILE'].fields_by_name['create_time']._loaded_options = None
  _globals['_ADAPTIVEMTFILE'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_ADAPTIVEMTFILE'].fields_by_name['update_time']._loaded_options = None
  _globals['_ADAPTIVEMTFILE'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_ADAPTIVEMTFILE']._loaded_options = None
  _globals['_ADAPTIVEMTFILE']._serialized_options = b'\352A\247\001\n\'translate.googleapis.com/AdaptiveMtFile\022[projects/{project}/locations/{location}/adaptiveMtDatasets/{dataset}/adaptiveMtFiles/{file}*\017adaptiveMtFiles2\016adaptiveMtFile'
  _globals['_GETADAPTIVEMTFILEREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETADAPTIVEMTFILEREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A)\n\'translate.googleapis.com/AdaptiveMtFile'
  _globals['_DELETEADAPTIVEMTFILEREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_DELETEADAPTIVEMTFILEREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A)\n\'translate.googleapis.com/AdaptiveMtFile'
  _globals['_IMPORTADAPTIVEMTFILEREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_IMPORTADAPTIVEMTFILEREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A,\n*translate.googleapis.com/AdaptiveMtDataset'
  _globals['_IMPORTADAPTIVEMTFILERESPONSE'].fields_by_name['adaptive_mt_file']._loaded_options = None
  _globals['_IMPORTADAPTIVEMTFILERESPONSE'].fields_by_name['adaptive_mt_file']._serialized_options = b'\340A\003'
  _globals['_LISTADAPTIVEMTFILESREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTADAPTIVEMTFILESREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A,\n*translate.googleapis.com/AdaptiveMtDataset'
  _globals['_LISTADAPTIVEMTFILESREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTADAPTIVEMTFILESREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTADAPTIVEMTFILESREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTADAPTIVEMTFILESREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_LISTADAPTIVEMTFILESRESPONSE'].fields_by_name['adaptive_mt_files']._loaded_options = None
  _globals['_LISTADAPTIVEMTFILESRESPONSE'].fields_by_name['adaptive_mt_files']._serialized_options = b'\340A\003'
  _globals['_LISTADAPTIVEMTFILESRESPONSE'].fields_by_name['next_page_token']._loaded_options = None
  _globals['_LISTADAPTIVEMTFILESRESPONSE'].fields_by_name['next_page_token']._serialized_options = b'\340A\001'
  _globals['_ADAPTIVEMTSENTENCE'].fields_by_name['name']._loaded_options = None
  _globals['_ADAPTIVEMTSENTENCE'].fields_by_name['name']._serialized_options = b'\340A\002\372A-\n+translate.googleapis.com/AdaptiveMtSentence'
  _globals['_ADAPTIVEMTSENTENCE'].fields_by_name['source_sentence']._loaded_options = None
  _globals['_ADAPTIVEMTSENTENCE'].fields_by_name['source_sentence']._serialized_options = b'\340A\002'
  _globals['_ADAPTIVEMTSENTENCE'].fields_by_name['target_sentence']._loaded_options = None
  _globals['_ADAPTIVEMTSENTENCE'].fields_by_name['target_sentence']._serialized_options = b'\340A\002'
  _globals['_ADAPTIVEMTSENTENCE'].fields_by_name['create_time']._loaded_options = None
  _globals['_ADAPTIVEMTSENTENCE'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_ADAPTIVEMTSENTENCE'].fields_by_name['update_time']._loaded_options = None
  _globals['_ADAPTIVEMTSENTENCE'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_ADAPTIVEMTSENTENCE']._loaded_options = None
  _globals['_ADAPTIVEMTSENTENCE']._serialized_options = b'\352A\322\001\n+translate.googleapis.com/AdaptiveMtSentence\022zprojects/{project}/locations/{location}/adaptiveMtDatasets/{dataset}/adaptiveMtFiles/{file}/adaptiveMtSentences/{sentence}*\023adaptiveMtSentences2\022adaptiveMtSentence'
  _globals['_LISTADAPTIVEMTSENTENCESREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTADAPTIVEMTSENTENCESREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A)\n\'translate.googleapis.com/AdaptiveMtFile'
  _globals['_LISTADAPTIVEMTSENTENCESRESPONSE'].fields_by_name['adaptive_mt_sentences']._loaded_options = None
  _globals['_LISTADAPTIVEMTSENTENCESRESPONSE'].fields_by_name['adaptive_mt_sentences']._serialized_options = b'\340A\003'
  _globals['_LISTADAPTIVEMTSENTENCESRESPONSE'].fields_by_name['next_page_token']._loaded_options = None
  _globals['_LISTADAPTIVEMTSENTENCESRESPONSE'].fields_by_name['next_page_token']._serialized_options = b'\340A\001'
