...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CREATEREADSESSIONREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A-\n+cloudresourcemanager.googleapis.com/Project'
  _globals['_CREATEREADSESSIONREQUEST'].fields_by_name['read_session']._loaded_options = None
  _globals['_CREATEREADSESSIONREQUEST'].fields_by_name['read_session']._serialized_options = b'\340A\002'
  _globals['_READROWSREQUEST'].fields_by_name['read_stream']._loaded_options = None
  _globals['_READROWSREQUEST'].fields_by_name['read_stream']._serialized_options = b'\340A\002\372A+\n)bigquerystorage.googleapis.com/ReadStream'
  _globals['_READROWSRESPONSE'].fields_by_name['avro_schema']._loaded_options = None
  _globals['_READROWSRESPONSE'].fields_by_name['avro_schema']._serialized_options = b'\340A\003'
  _globals['_READROWSRESPONSE'].fields_by_name['arrow_schema']._loaded_options = None
  _globals['_READROWSRESPONSE'].fields_by_name['arrow_schema']._serialized_options = b'\340A\003'
  _globals['_READROWSRESPONSE'].fields_by_name['uncompressed_byte_size']._loaded_options = None
  _globals['_READROWSRESPONSE'].fields_by_name['uncompressed_byte_size']._serialized_options = b'\340A\001'
  _globals['_SPLITREADSTREAMREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_SPLITREADSTREAMREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A+\n)bigquerystorage.googleapis.com/ReadStream'
  _globals['_CREATEWRITESTREAMREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_CREATEWRITESTREAMREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A\037\n\035bigquery.googleapis.com/Table'
  _globals['_CREATEWRITESTREAMREQUEST'].fields_by_name['write_stream']._loaded_options = None
  _globals['_CREATEWRITESTREAMREQUEST'].fields_by_name['write_stream']._serialized_options = b'\340A\002'
  _globals['_APPENDROWSREQUEST_MISSINGVALUEINTERPRETATIONSENTRY']._loaded_options = None
  _globals['_APPENDROWSREQUEST_MISSINGVALUEINTERPRETATIONSENTRY']._serialized_options = b'8\001'
  _globals['_APPENDROWSREQUEST'].fields_by_name['write_stream']._loaded_options = None
  _globals['_APPENDROWSREQUEST'].fields_by_name['write_stream']._serialized_options = b'\340A\002\372A,\n*bigquerystorage.googleapis.com/WriteStream'
  _globals['_APPENDROWSREQUEST'].fields_by_name['default_missing_value_interpretation']._loaded_options = None
  _globals['_APPENDROWSREQUEST'].fields_by_name['default_missing_value_interpretation']._serialized_options = b'\340A\001'
  _globals['_GETWRITESTREAMREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETWRITESTREAMREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A,\n*bigquerystorage.googleapis.com/WriteStream'
  _globals['_BATCHCOMMITWRITESTREAMSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_BATCHCOMMITWRITESTREAMSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A\037\n\035bigquery.googleapis.com/Table'
  _globals['_BATCHCOMMITWRITESTREAMSREQUEST'].fields_by_name['write_streams']._loaded_options = None
  _globals['_BATCHCOMMITWRITESTREAMSREQUEST'].fields_by_name['write_streams']._serialized_options = b'\340A\002'
  _globals['_FINALIZEWRITESTREAMREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_FINALIZEWRITESTREAMREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A,\n*bigquerystorage.googleapis.com/WriteStream'
  _globals['_FLUSHROWSREQUEST'].fields_by_name['write_stream']._loaded_options = None
  _globals['_FLUSHROWSREQUEST'].fields_by_name['write_stream']._serialized_options = b'\340A\002\372A,\n*bigquerystorage.googleapis.com/WriteStream'
  _globals['_BIGQUERYREAD']._loaded_options = None
  _globals['_BIGQUERYREAD']._serialized_options = b'\312A\036bigquerystorage.googleapis.com\322AWhttps://www.googleapis.com/auth/bigquery,https://www.googleapis.com/auth/cloud-platform'
  _globals['_BIGQUERYREAD'].methods_by_name['CreateReadSession']._loaded_options = None
  _globals['_BIGQUERYREAD'].methods_by_name['CreateReadSession']._serialized_options = b'\332A$parent,read_session,max_stream_count\202\323\344\223\002<\"7/v1/{read_session.table=projects/*/datasets/*/tables/*}:\001*'
  _globals['_BIGQUERYREAD'].methods_by_name['ReadRows']._loaded_options = None
  _globals['_BIGQUERYREAD'].methods_by_name['ReadRows']._serialized_options = b'\332A\022read_stream,offset\202\323\344\223\002?\022=/v1/{read_stream=projects/*/locations/*/sessions/*/streams/*}'
  _globals['_BIGQUERYREAD'].methods_by_name['SplitReadStream']._loaded_options = None
  _globals['_BIGQUERYREAD'].methods_by_name['SplitReadStream']._serialized_options = b'\202\323\344\223\0028\0226/v1/{name=projects/*/locations/*/sessions/*/streams/*}'
  _globals['_BIGQUERYWRITE']._loaded_options = None
  _globals['_BIGQUERYWRITE']._serialized_options = b'\312A\036bigquerystorage.googleapis.com\322A\213\001https://www.googleapis.com/auth/bigquery,https://www.googleapis.com/auth/bigquery.insertdata,https://www.googleapis.com/auth/cloud-platform'
  _globals['_BIGQUERYWRITE'].methods_by_name['CreateWriteStream']._loaded_options = None
  _globals['_BIGQUERYWRITE'].methods_by_name['CreateWriteStream']._serialized_options = b'\332A\023parent,write_stream\202\323\344\223\002;\"+/v1/{parent=projects/*/datasets/*/tables/*}:\014write_stream'
  _globals['_BIGQUERYWRITE'].methods_by_name['AppendRows']._loaded_options = None
  _globals['_BIGQUERYWRITE'].methods_by_name['AppendRows']._serialized_options = b'\332A\014write_stream\202\323\344\223\002@\";/v1/{write_stream=projects/*/datasets/*/tables/*/streams/*}:\001*'
  _globals['_BIGQUERYWRITE'].methods_by_name['GetWriteStream']._loaded_options = None
  _globals['_BIGQUERYWRITE'].methods_by_name['GetWriteStream']._serialized_options = b'\332A\004name\202\323\344\223\0028\"3/v1/{name=projects/*/datasets/*/tables/*/streams/*}:\001*'
  _globals['_BIGQUERYWRITE'].methods_by_name['FinalizeWriteStream']._loaded_options = None
  _globals['_BIGQUERYWRITE'].methods_by_name['FinalizeWriteStream']._serialized_options = b'\332A\004name\202\323\344\223\0028\"3/v1/{name=projects/*/datasets/*/tables/*/streams/*}:\001*'
  _globals['_BIGQUERYWRITE'].methods_by_name['BatchCommitWriteStreams']._loaded_options = None
  _globals['_BIGQUERYWRITE'].methods_by_name['BatchCommitWriteStreams']._serialized_options = b'\332A\006parent\202\323\344\223\002-\022+/v1/{parent=projects/*/datasets/*/tables/*}'
  _globals['_BIGQUERYWRITE'].methods_by_name['FlushRows']._loaded_options = None
  _globals['_BIGQUERYWRITE'].methods_by_name['FlushRows']._serialized_options = b'\332A\014write_stream\202\323\344\223\002@\";/v1/{write_stream=projects/*/datasets/*/tables/*/streams/*}:\001*'
