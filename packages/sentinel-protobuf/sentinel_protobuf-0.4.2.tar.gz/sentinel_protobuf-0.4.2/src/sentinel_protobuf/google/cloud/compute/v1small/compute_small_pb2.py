...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/cloud/compute/v1small/compute_small.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ADDRESSAGGREGATEDLIST_ITEMSENTRY']._serialized_options = b'8\001'
  _globals['_AGGREGATEDLISTADDRESSESREQUEST'].fields_by_name['project']._loaded_options = None
  _globals['_AGGREGATEDLISTADDRESSESREQUEST'].fields_by_name['project']._serialized_options = b'\340A\002'
  _globals['_DELETEADDRESSREQUEST'].fields_by_name['address']._loaded_options = None
  _globals['_DELETEADDRESSREQUEST'].fields_by_name['address']._serialized_options = b'\340A\002'
  _globals['_DELETEADDRESSREQUEST'].fields_by_name['project']._loaded_options = None
  _globals['_DELETEADDRESSREQUEST'].fields_by_name['project']._serialized_options = b'\340A\002\362G\007project'
  _globals['_DELETEADDRESSREQUEST'].fields_by_name['region']._loaded_options = None
  _globals['_DELETEADDRESSREQUEST'].fields_by_name['region']._serialized_options = b'\340A\002\362G\006region'
  _globals['_GETREGIONOPERATIONREQUEST'].fields_by_name['operation']._loaded_options = None
  _globals['_GETREGIONOPERATIONREQUEST'].fields_by_name['operation']._serialized_options = b'\340A\002\372G\004name'
  _globals['_GETREGIONOPERATIONREQUEST'].fields_by_name['project']._loaded_options = None
  _globals['_GETREGIONOPERATIONREQUEST'].fields_by_name['project']._serialized_options = b'\340A\002'
  _globals['_GETREGIONOPERATIONREQUEST'].fields_by_name['region']._loaded_options = None
  _globals['_GETREGIONOPERATIONREQUEST'].fields_by_name['region']._serialized_options = b'\340A\002'
  _globals['_INSERTADDRESSREQUEST'].fields_by_name['address_resource']._loaded_options = None
  _globals['_INSERTADDRESSREQUEST'].fields_by_name['address_resource']._serialized_options = b'\340A\002'
  _globals['_INSERTADDRESSREQUEST'].fields_by_name['project']._loaded_options = None
  _globals['_INSERTADDRESSREQUEST'].fields_by_name['project']._serialized_options = b'\340A\002\362G\007project'
  _globals['_INSERTADDRESSREQUEST'].fields_by_name['region']._loaded_options = None
  _globals['_INSERTADDRESSREQUEST'].fields_by_name['region']._serialized_options = b'\340A\002\362G\006region'
  _globals['_LISTADDRESSESREQUEST'].fields_by_name['order_by']._loaded_options = None
  _globals['_LISTADDRESSESREQUEST'].fields_by_name['order_by']._serialized_options = b'\340A\002'
  _globals['_LISTADDRESSESREQUEST'].fields_by_name['project']._loaded_options = None
  _globals['_LISTADDRESSESREQUEST'].fields_by_name['project']._serialized_options = b'\340A\002'
  _globals['_LISTADDRESSESREQUEST'].fields_by_name['region']._loaded_options = None
  _globals['_LISTADDRESSESREQUEST'].fields_by_name['region']._serialized_options = b'\340A\002'
  _globals['_OPERATION'].fields_by_name['http_error_message']._loaded_options = None
  _globals['_OPERATION'].fields_by_name['http_error_message']._serialized_options = b'\350G\004'
  _globals['_OPERATION'].fields_by_name['http_error_status_code']._loaded_options = None
  _globals['_OPERATION'].fields_by_name['http_error_status_code']._serialized_options = b'\350G\003'
  _globals['_OPERATION'].fields_by_name['name']._loaded_options = None
  _globals['_OPERATION'].fields_by_name['name']._serialized_options = b'\350G\001'
  _globals['_OPERATION'].fields_by_name['status']._loaded_options = None
  _globals['_OPERATION'].fields_by_name['status']._serialized_options = b'\350G\002'
  _globals['_WAITREGIONOPERATIONREQUEST'].fields_by_name['operation']._loaded_options = None
  _globals['_WAITREGIONOPERATIONREQUEST'].fields_by_name['operation']._serialized_options = b'\340A\002'
  _globals['_WAITREGIONOPERATIONREQUEST'].fields_by_name['project']._loaded_options = None
  _globals['_WAITREGIONOPERATIONREQUEST'].fields_by_name['project']._serialized_options = b'\340A\002'
  _globals['_WAITREGIONOPERATIONREQUEST'].fields_by_name['region']._loaded_options = None
  _globals['_WAITREGIONOPERATIONREQUEST'].fields_by_name['region']._serialized_options = b'\340A\002'
  _globals['_ADDRESSES']._loaded_options = None
  _globals['_ADDRESSES']._serialized_options = b'\312A\026compute.googleapis.com\322AVhttps://www.googleapis.com/auth/compute,https://www.googleapis.com/auth/cloud-platform'
  _globals['_ADDRESSES'].methods_by_name['AggregatedList']._loaded_options = None
  _globals['_ADDRESSES'].methods_by_name['AggregatedList']._serialized_options = b'\332A\007project\202\323\344\223\0025\0223/compute/v1/projects/{project}/aggregated/addresses'
  _globals['_ADDRESSES'].methods_by_name['Delete']._loaded_options = None
  _globals['_ADDRESSES'].methods_by_name['Delete']._serialized_options = b'\332A\026project,region,address\212N\020RegionOperations\202\323\344\223\002E*C/compute/v1/projects/{project}/regions/{region}/addresses/{address}'
  _globals['_ADDRESSES'].methods_by_name['Insert']._loaded_options = None
  _globals['_ADDRESSES'].methods_by_name['Insert']._serialized_options = b'\332A\037project,region,address_resource\212N\020RegionOperations\202\323\344\223\002M\"9/compute/v1/projects/{project}/regions/{region}/addresses:\020address_resource'
  _globals['_ADDRESSES'].methods_by_name['List']._loaded_options = None
  _globals['_ADDRESSES'].methods_by_name['List']._serialized_options = b'\332A\027project,region,order_by\202\323\344\223\002;\0229/compute/v1/projects/{project}/regions/{region}/addresses'
  _globals['_REGIONOPERATIONS']._loaded_options = None
  _globals['_REGIONOPERATIONS']._serialized_options = b'\312A\026compute.googleapis.com\322A\207\001https://www.googleapis.com/auth/compute.readonly,https://www.googleapis.com/auth/compute,https://www.googleapis.com/auth/cloud-platform'
  _globals['_REGIONOPERATIONS'].methods_by_name['Get']._loaded_options = None
  _globals['_REGIONOPERATIONS'].methods_by_name['Get']._serialized_options = b'\332A\030project,region,operation\220N\001\202\323\344\223\002H\022F/compute/v1/projects/{project}/regions/{region}/operations/{operation}'
  _globals['_REGIONOPERATIONS'].methods_by_name['Wait']._loaded_options = None
  _globals['_REGIONOPERATIONS'].methods_by_name['Wait']._serialized_options = b'\332A\030project,region,operation\202\323\344\223\002V\"T/compute/v1/projects/projects/{project}/regions/{region}/operations/{operation}/wait'
