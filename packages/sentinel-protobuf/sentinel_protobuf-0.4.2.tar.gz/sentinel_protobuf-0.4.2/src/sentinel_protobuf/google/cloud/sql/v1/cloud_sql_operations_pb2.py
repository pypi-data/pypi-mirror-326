...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\027com.google.cloud.sql.v1B\027CloudSqlOperationsProtoP\001Z)cloud.google.com/go/sql/apiv1/sqlpb;sqlpb'
  ...
  _globals['_SQLOPERATIONSSERVICE'].methods_by_name['Get']._serialized_options = b'\202\323\344\223\002/\022-/v1/projects/{project}/operations/{operation}'
  _globals['_SQLOPERATIONSSERVICE'].methods_by_name['List']._loaded_options = None
  _globals['_SQLOPERATIONSSERVICE'].methods_by_name['List']._serialized_options = b'\202\323\344\223\002#\022!/v1/projects/{project}/operations'
  _globals['_SQLOPERATIONSSERVICE'].methods_by_name['Cancel']._loaded_options = None
  _globals['_SQLOPERATIONSSERVICE'].methods_by_name['Cancel']._serialized_options = b'\202\323\344\223\0026\"4/v1/projects/{project}/operations/{operation}/cancel'
