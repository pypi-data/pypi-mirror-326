...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n#com.google.cloud.aiplatform.v1beta1B\034HyperparameterTuningJobProtoP\001ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\252\002\037Google.Cloud.AIPlatform.V1Beta1\312\002\037Google\\Cloud\\AIPlatform\\V1beta1\352\002\"Google::Cloud::AIPlatform::V1beta1'
  _globals['_HYPERPARAMETERTUNINGJOB_LABELSENTRY']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['name']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['display_name']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['display_name']._serialized_options = b'\340A\002'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['study_spec']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['study_spec']._serialized_options = b'\340A\002'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['max_trial_count']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['max_trial_count']._serialized_options = b'\340A\002'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['parallel_trial_count']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['parallel_trial_count']._serialized_options = b'\340A\002'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['trial_job_spec']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['trial_job_spec']._serialized_options = b'\340A\002'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['trials']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['trials']._serialized_options = b'\340A\003'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['state']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['state']._serialized_options = b'\340A\003'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['create_time']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['start_time']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['start_time']._serialized_options = b'\340A\003'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['end_time']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['end_time']._serialized_options = b'\340A\003'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['update_time']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['error']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['error']._serialized_options = b'\340A\003'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['satisfies_pzs']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['satisfies_pzs']._serialized_options = b'\340A\003'
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['satisfies_pzi']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB'].fields_by_name['satisfies_pzi']._serialized_options = b'\340A\003'
  _globals['_HYPERPARAMETERTUNINGJOB']._loaded_options = None
  _globals['_HYPERPARAMETERTUNINGJOB']._serialized_options = b'\352A\221\001\n1aiplatform.googleapis.com/HyperparameterTuningJob\022\\projects/{project}/locations/{location}/hyperparameterTuningJobs/{hyperparameter_tuning_job}'
