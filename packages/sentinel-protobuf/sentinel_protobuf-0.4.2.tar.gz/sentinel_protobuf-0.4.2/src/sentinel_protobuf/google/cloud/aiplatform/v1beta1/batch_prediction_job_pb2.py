...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n#com.google.cloud.aiplatform.v1beta1B\027BatchPredictionJobProtoP\001ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\252\002\037Google.Cloud.AIPlatform.V1Beta1\312\002\037Google\\Cloud\\AIPlatform\\V1beta1\352\002\"Google::Cloud::AIPlatform::V1beta1'
  _globals['_BATCHPREDICTIONJOB_INPUTCONFIG'].fields_by_name['instances_format']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB_INPUTCONFIG'].fields_by_name['instances_format']._serialized_options = b'\340A\002'
  _globals['_BATCHPREDICTIONJOB_OUTPUTCONFIG'].fields_by_name['predictions_format']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB_OUTPUTCONFIG'].fields_by_name['predictions_format']._serialized_options = b'\340A\002'
  _globals['_BATCHPREDICTIONJOB_OUTPUTINFO'].fields_by_name['gcs_output_directory']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB_OUTPUTINFO'].fields_by_name['gcs_output_directory']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB_OUTPUTINFO'].fields_by_name['bigquery_output_dataset']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB_OUTPUTINFO'].fields_by_name['bigquery_output_dataset']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB_OUTPUTINFO'].fields_by_name['bigquery_output_table']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB_OUTPUTINFO'].fields_by_name['bigquery_output_table']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB_LABELSENTRY']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB_LABELSENTRY']._serialized_options = b'8\001'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['name']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['display_name']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['display_name']._serialized_options = b'\340A\002'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['model']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['model']._serialized_options = b'\372A!\n\037aiplatform.googleapis.com/Model'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['model_version_id']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['model_version_id']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['input_config']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['input_config']._serialized_options = b'\340A\002'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['output_config']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['output_config']._serialized_options = b'\340A\002'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['manual_batch_tuning_parameters']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['manual_batch_tuning_parameters']._serialized_options = b'\340A\005'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['output_info']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['output_info']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['state']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['state']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['error']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['error']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['partial_failures']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['partial_failures']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['resources_consumed']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['resources_consumed']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['completion_stats']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['completion_stats']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['create_time']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['start_time']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['start_time']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['end_time']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['end_time']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['update_time']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['update_time']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['model_monitoring_status']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['model_monitoring_status']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['satisfies_pzs']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['satisfies_pzs']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['satisfies_pzi']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB'].fields_by_name['satisfies_pzi']._serialized_options = b'\340A\003'
  _globals['_BATCHPREDICTIONJOB']._loaded_options = None
  _globals['_BATCHPREDICTIONJOB']._serialized_options = b'\352A\202\001\n,aiplatform.googleapis.com/BatchPredictionJob\022Rprojects/{project}/locations/{location}/batchPredictionJobs/{batch_prediction_job}'
