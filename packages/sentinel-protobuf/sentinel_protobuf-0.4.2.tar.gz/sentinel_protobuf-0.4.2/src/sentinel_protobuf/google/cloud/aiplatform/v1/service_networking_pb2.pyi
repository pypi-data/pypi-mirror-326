...
class PrivateServiceConnectConfig(_message.Message):
    __slots__ = ('enable_private_service_connect', 'project_allowlist', 'service_attachment')
    ...
    def __init__(self, enable_private_service_connect: bool=..., project_allowlist: _Optional[_Iterable[str]]=..., service_attachment: _Optional[str]=...) -> None:
        ...
