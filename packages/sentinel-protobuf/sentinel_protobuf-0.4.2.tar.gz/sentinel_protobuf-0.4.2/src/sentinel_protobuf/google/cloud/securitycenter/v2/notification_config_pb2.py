...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_NOTIFICATIONCONFIG']._serialized_end = 802
    _globals['_NOTIFICATIONCONFIG_STREAMINGCONFIG']._serialized_start = 397
    _globals['_NOTIFICATIONCONFIG_STREAMINGCONFIG']._serialized_end = 430