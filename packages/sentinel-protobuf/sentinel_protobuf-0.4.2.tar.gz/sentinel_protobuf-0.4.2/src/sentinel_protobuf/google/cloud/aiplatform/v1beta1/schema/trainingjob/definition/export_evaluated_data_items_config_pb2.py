...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_EXPORTEVALUATEDDATAITEMSCONFIG']._serialized_start = 169
    _globals['_EXPORTEVALUATEDDATAITEMSCONFIG']._serialized_end = 268