...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b"\n'com.google.cloud.networkconnectivity.v1B\x0bCommonProtoP\x01ZYcloud.google.com/go/networkconnectivity/apiv1/networkconnectivitypb;networkconnectivitypb\xaa\x02#Google.Cloud.NetworkConnectivity.V1\xca\x02#Google\\Cloud\\NetworkConnectivity\\V1\xea\x02&Google::Cloud::NetworkConnectivity::V1\xeaAz\n-compute.googleapis.com/InterconnectAttachment\x12Iprojects/{project}/regions/{region}/interconnectAttachments/{resource_id}\xeaAR\n\x1ecompute.googleapis.com/Network\x120projects/{project}/global/networks/{resource_id}"
