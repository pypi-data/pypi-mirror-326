...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 1, '', 'google/cloud/discoveryengine/v1/document.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DOCUMENT']._serialized_start = 232
    _globals['_DOCUMENT']._serialized_end = 1128
    _globals['_DOCUMENT_CONTENT']._serialized_start = 658
    _globals['_DOCUMENT_CONTENT']._serialized_end = 733
    _globals['_DOCUMENT_INDEXSTATUS']._serialized_start = 735
    _globals['_DOCUMENT_INDEXSTATUS']._serialized_end = 839