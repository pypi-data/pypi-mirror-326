...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\037com.google.cloud.retail.v2alphaB\016UserEventProtoP\001Z7cloud.google.com/go/retail/apiv2alpha/retailpb;retailpb\242\002\006RETAIL\252\002\033Google.Cloud.Retail.V2Alpha\312\002\033Google\\Cloud\\Retail\\V2alpha\352\002\036Google::Cloud::Retail::V2alpha'
  ...
  _globals['_USEREVENT'].fields_by_name['visitor_id']._serialized_options = b'\340A\002'
  _globals['_PRODUCTDETAIL'].fields_by_name['product']._loaded_options = None
  _globals['_PRODUCTDETAIL'].fields_by_name['product']._serialized_options = b'\340A\002'
  _globals['_PURCHASETRANSACTION'].fields_by_name['revenue']._loaded_options = None
  _globals['_PURCHASETRANSACTION'].fields_by_name['revenue']._serialized_options = b'\340A\002'
  _globals['_PURCHASETRANSACTION'].fields_by_name['currency_code']._loaded_options = None
  _globals['_PURCHASETRANSACTION'].fields_by_name['currency_code']._serialized_options = b'\340A\002'
