...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 1, '', 'google/cloud/aiplatform/v1/notebook_software_config.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_NOTEBOOKSOFTWARECONFIG']._serialized_start = 532
    _globals['_NOTEBOOKSOFTWARECONFIG']._serialized_end = 704