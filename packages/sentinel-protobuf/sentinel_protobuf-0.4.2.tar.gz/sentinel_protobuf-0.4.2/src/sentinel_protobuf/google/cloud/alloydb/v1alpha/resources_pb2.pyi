...
class Cluster(_message.Message):
    __slots__ = ("backup_source", "migration_source", "cloudsql_backup_run_source", "name", "display_name", "uid", "create_time", "update_time", "delete_time", "labels", "state", "cluster_type", "database_version", "network_config", "network", "etag", "annotations", "reconciling", "initial_user", "automated_backup_policy", "ssl_config", "encryption_config", "encryption_info", "continuous_backup_config", "continuous_backup_info", "secondary_config", "primary_config", "satisfies_pzi", "satisfies_pzs", "psc_config", "maintenance_update_policy", "maintenance_schedule", "gemini_config", "subscription_type", "trial_metadata", "tags")
...
class Instance(_message.Message):
    ...
    class ObservabilityInstanceConfig(_message.Message):
        __slots__ = ("enabled", "preserve_comments", "track_wait_events", "track_wait_event_types", "max_query_string_length", "record_application_tags", "query_plans_per_minute", "track_active_queries", "track_client_address")
        ENABLED_FIELD_NUMBER: _ClassVar[int]
        ...
        def __init__(self, enabled: bool = ..., preserve_comments: bool = ..., track_wait_events: bool = ..., track_wait_event_types: bool = ..., max_query_string_length: _Optional[int] = ..., record_application_tags: bool = ..., query_plans_per_minute: _Optional[int] = ..., track_active_queries: bool = ..., track_client_address: bool = ...) -> None: ...
    ...
    class PscInstanceConfig(_message.Message):
        __slots__ = ("service_attachment_link", "allowed_consumer_projects", "psc_dns_name", "psc_interface_configs")
        ...
        def __init__(self, service_attachment_link: _Optional[str] = ..., allowed_consumer_projects: _Optional[_Iterable[str]] = ..., psc_dns_name: _Optional[str] = ..., psc_interface_configs: _Optional[_Iterable[_Union[Instance.PscInterfaceConfig, _Mapping]]] = ...) -> None: ...
...
class Backup(_message.Message):
    __slots__ = ("name", "display_name", "uid", "create_time", "update_time", "delete_time", "labels", "state", "type", "description", "cluster_uid", "cluster_name", "reconciling", "encryption_config", "encryption_info", "etag", "annotations", "size_bytes", "expiry_time", "expiry_quantity", "satisfies_pzi", "satisfies_pzs", "database_version", "tags")
    class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
