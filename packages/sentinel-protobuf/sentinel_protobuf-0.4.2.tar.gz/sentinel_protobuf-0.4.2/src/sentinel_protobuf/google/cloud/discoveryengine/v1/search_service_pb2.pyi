...
class SearchResponse(_message.Message):
    ...
    class SearchResult(_message.Message):
        ...
        def __init__(self, id: _Optional[str] = ..., document: _Optional[_Union[_document_pb2.Document, _Mapping]] = ..., chunk: _Optional[_Union[_chunk_pb2.Chunk, _Mapping]] = ...) -> None: ...
    ...
    def __init__(self, results: _Optional[_Iterable[_Union[SearchResponse.SearchResult, _Mapping]]] = ..., facets: _Optional[_Iterable[_Union[SearchResponse.Facet, _Mapping]]] = ..., total_size: _Optional[int] = ..., attribution_token: _Optional[str] = ..., redirect_uri: _Optional[str] = ..., next_page_token: _Optional[str] = ..., corrected_query: _Optional[str] = ..., summary: _Optional[_Union[SearchResponse.Summary, _Mapping]] = ..., query_expansion_info: _Optional[_Union[SearchResponse.QueryExpansionInfo, _Mapping]] = ..., session_info: _Optional[_Union[SearchResponse.SessionInfo, _Mapping]] = ...) -> None: ...
