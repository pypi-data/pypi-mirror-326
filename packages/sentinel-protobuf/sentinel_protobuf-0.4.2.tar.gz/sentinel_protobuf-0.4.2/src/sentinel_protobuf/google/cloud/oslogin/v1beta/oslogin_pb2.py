...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\037com.google.cloud.oslogin.v1betaB\014OsLoginProtoP\001Z9cloud.google.com/go/oslogin/apiv1beta/osloginpb;osloginpb\252\002\033Google.Cloud.OsLogin.V1Beta\312\002\033Google\\Cloud\\OsLogin\\V1beta\352\002\036Google::Cloud::OsLogin::V1beta'
  _globals['_LOGINPROFILE_SSHPUBLICKEYSENTRY']._loaded_options = None
  _globals['_LOGINPROFILE_SSHPUBLICKEYSENTRY']._serialized_options = b'8\001'
  _globals['_LOGINPROFILE'].fields_by_name['name']._loaded_options = None
  _globals['_LOGINPROFILE'].fields_by_name['name']._serialized_options = b'\340A\002'
  _globals['_CREATESSHPUBLICKEYREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_CREATESSHPUBLICKEYREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A%\022#oslogin.googleapis.com/SshPublicKey'
  _globals['_CREATESSHPUBLICKEYREQUEST'].fields_by_name['ssh_public_key']._loaded_options = None
  _globals['_CREATESSHPUBLICKEYREQUEST'].fields_by_name['ssh_public_key']._serialized_options = b'\340A\002'
  _globals['_DELETEPOSIXACCOUNTREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_DELETEPOSIXACCOUNTREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A%\n#oslogin.googleapis.com/PosixAccount'
  _globals['_DELETESSHPUBLICKEYREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_DELETESSHPUBLICKEYREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A%\n#oslogin.googleapis.com/SshPublicKey'
  _globals['_GETLOGINPROFILEREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETLOGINPROFILEREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A\035\n\033oslogin.googleapis.com/User'
  _globals['_GETSSHPUBLICKEYREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETSSHPUBLICKEYREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A%\n#oslogin.googleapis.com/SshPublicKey'
  _globals['_IMPORTSSHPUBLICKEYREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_IMPORTSSHPUBLICKEYREQUEST'].fields_by_name['parent']._serialized_options = b'\372A%\022#oslogin.googleapis.com/SshPublicKey'
  _globals['_IMPORTSSHPUBLICKEYREQUEST'].fields_by_name['ssh_public_key']._loaded_options = None
  _globals['_IMPORTSSHPUBLICKEYREQUEST'].fields_by_name['ssh_public_key']._serialized_options = b'\340A\002'
  _globals['_IMPORTSSHPUBLICKEYREQUEST'].fields_by_name['regions']._loaded_options = None
  _globals['_IMPORTSSHPUBLICKEYREQUEST'].fields_by_name['regions']._serialized_options = b'\340A\001'
  _globals['_UPDATESSHPUBLICKEYREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_UPDATESSHPUBLICKEYREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A%\n#oslogin.googleapis.com/SshPublicKey'
  _globals['_UPDATESSHPUBLICKEYREQUEST'].fields_by_name['ssh_public_key']._loaded_options = None
  _globals['_UPDATESSHPUBLICKEYREQUEST'].fields_by_name['ssh_public_key']._serialized_options = b'\340A\002'
  _globals['_OSLOGINSERVICE']._loaded_options = None
  _globals['_OSLOGINSERVICE']._serialized_options = b'\312A\026oslogin.googleapis.com\322A\300\001https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/cloud-platform.read-only,https://www.googleapis.com/auth/compute,https://www.googleapis.com/auth/compute.readonly'
  _globals['_OSLOGINSERVICE'].methods_by_name['CreateSshPublicKey']._loaded_options = None
  _globals['_OSLOGINSERVICE'].methods_by_name['CreateSshPublicKey']._serialized_options = b'\332A\025parent,ssh_public_key\202\323\344\223\0028\"&/v1beta/{parent=users/*}/sshPublicKeys:\016ssh_public_key'
  _globals['_OSLOGINSERVICE'].methods_by_name['DeletePosixAccount']._loaded_options = None
  _globals['_OSLOGINSERVICE'].methods_by_name['DeletePosixAccount']._serialized_options = b'\332A\004name\202\323\344\223\002#*!/v1beta/{name=users/*/projects/*}'
  _globals['_OSLOGINSERVICE'].methods_by_name['DeleteSshPublicKey']._loaded_options = None
  _globals['_OSLOGINSERVICE'].methods_by_name['DeleteSshPublicKey']._serialized_options = b'\332A\004name\202\323\344\223\002(*&/v1beta/{name=users/*/sshPublicKeys/*}'
  _globals['_OSLOGINSERVICE'].methods_by_name['GetLoginProfile']._loaded_options = None
  _globals['_OSLOGINSERVICE'].methods_by_name['GetLoginProfile']._serialized_options = b'\332A\004name\202\323\344\223\002%\022#/v1beta/{name=users/*}/loginProfile'
  _globals['_OSLOGINSERVICE'].methods_by_name['GetSshPublicKey']._loaded_options = None
  _globals['_OSLOGINSERVICE'].methods_by_name['GetSshPublicKey']._serialized_options = b'\332A\004name\202\323\344\223\002(\022&/v1beta/{name=users/*/sshPublicKeys/*}'
  _globals['_OSLOGINSERVICE'].methods_by_name['ImportSshPublicKey']._loaded_options = None
  _globals['_OSLOGINSERVICE'].methods_by_name['ImportSshPublicKey']._serialized_options = b'\332A\025parent,ssh_public_key\332A parent,ssh_public_key,project_id\202\323\344\223\002=\"+/v1beta/{parent=users/*}:importSshPublicKey:\016ssh_public_key'
  _globals['_OSLOGINSERVICE'].methods_by_name['UpdateSshPublicKey']._loaded_options = None
  _globals['_OSLOGINSERVICE'].methods_by_name['UpdateSshPublicKey']._serialized_options = b'\332A\023name,ssh_public_key\332A\037name,ssh_public_key,update_mask\202\323\344\223\00282&/v1beta/{name=users/*/sshPublicKeys/*}:\016ssh_public_key'
  _globals['_OSLOGINSERVICE'].methods_by_name['SignSshPublicKey']._loaded_options = None
  _globals['_OSLOGINSERVICE'].methods_by_name['SignSshPublicKey']._serialized_options = b'\332A\025parent,ssh_public_key\202\323\344\223\002\210\001\"</v1beta/{parent=users/*/projects/*/zones/*}:signSshPublicKey:\001*ZE\"@/v1beta/{parent=users/*/projects/*/locations/*}:signSshPublicKey:\001*'
