...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n#com.google.cloud.aiplatform.v1beta1B\031ModelEvaluationSliceProtoP\001ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\252\002\037Google.Cloud.AIPlatform.V1Beta1\312\002\037Google\\Cloud\\AIPlatform\\V1beta1\352\002\"Google::Cloud::AIPlatform::V1beta1'
  _globals['_MODELEVALUATIONSLICE_SLICE_SLICESPEC_CONFIGSENTRY']._loaded_options = None
  _globals['_MODELEVALUATIONSLICE_SLICE_SLICESPEC_CONFIGSENTRY']._serialized_options = b'8\001'
  _globals['_MODELEVALUATIONSLICE_SLICE'].fields_by_name['dimension']._loaded_options = None
  _globals['_MODELEVALUATIONSLICE_SLICE'].fields_by_name['dimension']._serialized_options = b'\340A\003'
  _globals['_MODELEVALUATIONSLICE_SLICE'].fields_by_name['value']._loaded_options = None
  _globals['_MODELEVALUATIONSLICE_SLICE'].fields_by_name['value']._serialized_options = b'\340A\003'
  _globals['_MODELEVALUATIONSLICE_SLICE'].fields_by_name['slice_spec']._loaded_options = None
  _globals['_MODELEVALUATIONSLICE_SLICE'].fields_by_name['slice_spec']._serialized_options = b'\340A\003'
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['name']._loaded_options = None
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['slice']._loaded_options = None
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['slice']._serialized_options = b'\340A\003'
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['metrics_schema_uri']._loaded_options = None
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['metrics_schema_uri']._serialized_options = b'\340A\003'
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['metrics']._loaded_options = None
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['metrics']._serialized_options = b'\340A\003'
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['create_time']._loaded_options = None
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['model_explanation']._loaded_options = None
  _globals['_MODELEVALUATIONSLICE'].fields_by_name['model_explanation']._serialized_options = b'\340A\003'
  _globals['_MODELEVALUATIONSLICE']._loaded_options = None
  _globals['_MODELEVALUATIONSLICE']._serialized_options = b'\352A\220\001\n.aiplatform.googleapis.com/ModelEvaluationSlice\022^projects/{project}/locations/{location}/models/{model}/evaluations/{evaluation}/slices/{slice}'
