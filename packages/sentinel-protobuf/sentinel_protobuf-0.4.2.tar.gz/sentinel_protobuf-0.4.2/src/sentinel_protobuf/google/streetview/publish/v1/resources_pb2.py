...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n(com.google.geo.ugc.streetview.publish.v1B\032StreetViewPublishResourcesZ@cloud.google.com/go/streetview/publish/apiv1/publishpb;publishpb'
  _globals['_LEVEL'].fields_by_name['number']._loaded_options = None
  _globals['_LEVEL'].fields_by_name['number']._serialized_options = b'\340A\001'
  _globals['_LEVEL'].fields_by_name['name']._loaded_options = None
  _globals['_LEVEL'].fields_by_name['name']._serialized_options = b'\340A\002'
  _globals['_PLACE'].fields_by_name['name']._loaded_options = None
  _globals['_PLACE'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_PLACE'].fields_by_name['language_code']._loaded_options = None
  _globals['_PLACE'].fields_by_name['language_code']._serialized_options = b'\340A\003'
  _globals['_CONNECTION'].fields_by_name['target']._loaded_options = None
  _globals['_CONNECTION'].fields_by_name['target']._serialized_options = b'\340A\002'
  _globals['_PHOTO'].fields_by_name['photo_id']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['photo_id']._serialized_options = b'\340A\002\340A\003'
  _globals['_PHOTO'].fields_by_name['upload_reference']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['upload_reference']._serialized_options = b'\340A\004'
  _globals['_PHOTO'].fields_by_name['download_url']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['download_url']._serialized_options = b'\340A\003'
  _globals['_PHOTO'].fields_by_name['thumbnail_url']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['thumbnail_url']._serialized_options = b'\340A\003'
  _globals['_PHOTO'].fields_by_name['share_link']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['share_link']._serialized_options = b'\340A\003'
  _globals['_PHOTO'].fields_by_name['pose']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['pose']._serialized_options = b'\340A\001'
  _globals['_PHOTO'].fields_by_name['connections']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['connections']._serialized_options = b'\340A\001'
  _globals['_PHOTO'].fields_by_name['capture_time']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['capture_time']._serialized_options = b'\340A\001'
  _globals['_PHOTO'].fields_by_name['upload_time']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['upload_time']._serialized_options = b'\340A\003'
  _globals['_PHOTO'].fields_by_name['places']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['places']._serialized_options = b'\340A\001'
  _globals['_PHOTO'].fields_by_name['view_count']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['view_count']._serialized_options = b'\340A\003'
  _globals['_PHOTO'].fields_by_name['transfer_status']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['transfer_status']._serialized_options = b'\340A\003'
  _globals['_PHOTO'].fields_by_name['maps_publish_status']._loaded_options = None
  _globals['_PHOTO'].fields_by_name['maps_publish_status']._serialized_options = b'\340A\003'
  _globals['_PHOTOSEQUENCE'].fields_by_name['id']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['id']._serialized_options = b'\340A\003'
  _globals['_PHOTOSEQUENCE'].fields_by_name['photos']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['photos']._serialized_options = b'\340A\003'
  _globals['_PHOTOSEQUENCE'].fields_by_name['upload_reference']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['upload_reference']._serialized_options = b'\340A\004'
  _globals['_PHOTOSEQUENCE'].fields_by_name['capture_time_override']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['capture_time_override']._serialized_options = b'\340A\001'
  _globals['_PHOTOSEQUENCE'].fields_by_name['upload_time']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['upload_time']._serialized_options = b'\340A\003'
  _globals['_PHOTOSEQUENCE'].fields_by_name['raw_gps_timeline']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['raw_gps_timeline']._serialized_options = b'\340A\004'
  _globals['_PHOTOSEQUENCE'].fields_by_name['gps_source']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['gps_source']._serialized_options = b'\340A\004'
  _globals['_PHOTOSEQUENCE'].fields_by_name['imu']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['imu']._serialized_options = b'\340A\004'
  _globals['_PHOTOSEQUENCE'].fields_by_name['processing_state']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['processing_state']._serialized_options = b'\340A\003'
  _globals['_PHOTOSEQUENCE'].fields_by_name['failure_reason']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['failure_reason']._serialized_options = b'\340A\003'
  _globals['_PHOTOSEQUENCE'].fields_by_name['failure_details']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['failure_details']._serialized_options = b'\340A\003'
  _globals['_PHOTOSEQUENCE'].fields_by_name['distance_meters']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['distance_meters']._serialized_options = b'\340A\003'
  _globals['_PHOTOSEQUENCE'].fields_by_name['sequence_bounds']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['sequence_bounds']._serialized_options = b'\340A\003'
  _globals['_PHOTOSEQUENCE'].fields_by_name['view_count']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['view_count']._serialized_options = b'\340A\003'
  _globals['_PHOTOSEQUENCE'].fields_by_name['filename']._loaded_options = None
  _globals['_PHOTOSEQUENCE'].fields_by_name['filename']._serialized_options = b'\340A\003'
