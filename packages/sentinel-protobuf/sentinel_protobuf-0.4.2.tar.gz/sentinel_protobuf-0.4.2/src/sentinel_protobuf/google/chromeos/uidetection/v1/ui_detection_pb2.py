...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_UIDETECTIONREQUEST'].fields_by_name['image_png']._serialized_options = b'\340A\002'
  _globals['_UIDETECTIONREQUEST'].fields_by_name['request']._loaded_options = None
  _globals['_UIDETECTIONREQUEST'].fields_by_name['request']._serialized_options = b'\340A\002'
  _globals['_UIDETECTIONREQUEST'].fields_by_name['test_id']._loaded_options = None
  _globals['_UIDETECTIONREQUEST'].fields_by_name['test_id']._serialized_options = b'\030\001'
  _globals['_UIDETECTIONREQUEST'].fields_by_name['test_metadata']._loaded_options = None
  _globals['_UIDETECTIONREQUEST'].fields_by_name['test_metadata']._serialized_options = b'\340A\001'
  _globals['_UIDETECTIONREQUEST'].fields_by_name['force_image_resizing']._loaded_options = None
  _globals['_UIDETECTIONREQUEST'].fields_by_name['force_image_resizing']._serialized_options = b'\340A\001'
  _globals['_UIDETECTIONREQUEST'].fields_by_name['return_transformed_image']._loaded_options = None
  _globals['_UIDETECTIONREQUEST'].fields_by_name['return_transformed_image']._serialized_options = b'\340A\001'
  _globals['_WORDDETECTIONREQUEST'].fields_by_name['word']._loaded_options = None
  _globals['_WORDDETECTIONREQUEST'].fields_by_name['word']._serialized_options = b'\340A\002'
  _globals['_TEXTBLOCKDETECTIONREQUEST'].fields_by_name['words']._loaded_options = None
  _globals['_TEXTBLOCKDETECTIONREQUEST'].fields_by_name['words']._serialized_options = b'\340A\002'
  _globals['_CUSTOMICONDETECTIONREQUEST'].fields_by_name['icon_png']._loaded_options = None
  _globals['_CUSTOMICONDETECTIONREQUEST'].fields_by_name['icon_png']._serialized_options = b'\340A\002'
  _globals['_UIDETECTIONSERVICE']._loaded_options = None
  _globals['_UIDETECTIONSERVICE']._serialized_options = b'\312A\"chromeosuidetection.googleapis.com'
  _globals['_UIDETECTIONSERVICE'].methods_by_name['ExecuteDetection']._loaded_options = None
  _globals['_UIDETECTIONSERVICE'].methods_by_name['ExecuteDetection']._serialized_options = b'\202\323\344\223\002\036\022\034/v1/executeDetection:execute'
