...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n com.google.analytics.data.v1betaB\025AnalyticsDataApiProtoP\001Z@google.golang.org/genproto/googleapis/analytics/data/v1beta;data\352A?\n&analyticsadmin.googleapis.com/Property\022\025properties/{property}'
  _globals['_METADATA']._loaded_options = None
  _globals['_METADATA']._serialized_options = b'\352AG\n%analyticsdata.googleapis.com/Metadata\022\036properties/{property}/metadata'
  _globals['_RUNREPORTREQUEST'].fields_by_name['comparisons']._loaded_options = None
  _globals['_RUNREPORTREQUEST'].fields_by_name['comparisons']._serialized_options = b'\340A\001'
  _globals['_RUNPIVOTREPORTREQUEST'].fields_by_name['comparisons']._loaded_options = None
  _globals['_RUNPIVOTREPORTREQUEST'].fields_by_name['comparisons']._serialized_options = b'\340A\001'
  _globals['_GETMETADATAREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETMETADATAREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A\'\n%analyticsdata.googleapis.com/Metadata'
  _globals['_GETAUDIENCEEXPORTREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETAUDIENCEEXPORTREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A-\n+analyticsdata.googleapis.com/AudienceExport'
  _globals['_LISTAUDIENCEEXPORTSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTAUDIENCEEXPORTSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A-\022+analyticsdata.googleapis.com/AudienceExport'
  _globals['_LISTAUDIENCEEXPORTSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTAUDIENCEEXPORTSREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTAUDIENCEEXPORTSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTAUDIENCEEXPORTSREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_CREATEAUDIENCEEXPORTREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_CREATEAUDIENCEEXPORTREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A-\022+analyticsdata.googleapis.com/AudienceExport'
  _globals['_CREATEAUDIENCEEXPORTREQUEST'].fields_by_name['audience_export']._loaded_options = None
  _globals['_CREATEAUDIENCEEXPORTREQUEST'].fields_by_name['audience_export']._serialized_options = b'\340A\002'
  _globals['_AUDIENCEEXPORT'].fields_by_name['name']._loaded_options = None
  _globals['_AUDIENCEEXPORT'].fields_by_name['name']._serialized_options = b'\340A\010\340A\003'
  _globals['_AUDIENCEEXPORT'].fields_by_name['audience']._loaded_options = None
  _globals['_AUDIENCEEXPORT'].fields_by_name['audience']._serialized_options = b'\340A\002'
  _globals['_AUDIENCEEXPORT'].fields_by_name['audience_display_name']._loaded_options = None
  _globals['_AUDIENCEEXPORT'].fields_by_name['audience_display_name']._serialized_options = b'\340A\003'
  _globals['_AUDIENCEEXPORT'].fields_by_name['dimensions']._loaded_options = None
  _globals['_AUDIENCEEXPORT'].fields_by_name['dimensions']._serialized_options = b'\340A\002'
  _globals['_AUDIENCEEXPORT'].fields_by_name['state']._loaded_options = None
  _globals['_AUDIENCEEXPORT'].fields_by_name['state']._serialized_options = b'\340A\003'
  _globals['_AUDIENCEEXPORT'].fields_by_name['begin_creating_time']._loaded_options = None
  _globals['_AUDIENCEEXPORT'].fields_by_name['begin_creating_time']._serialized_options = b'\340A\003'
  _globals['_AUDIENCEEXPORT'].fields_by_name['creation_quota_tokens_charged']._loaded_options = None
  _globals['_AUDIENCEEXPORT'].fields_by_name['creation_quota_tokens_charged']._serialized_options = b'\340A\003'
  _globals['_AUDIENCEEXPORT'].fields_by_name['row_count']._loaded_options = None
  _globals['_AUDIENCEEXPORT'].fields_by_name['row_count']._serialized_options = b'\340A\003'
  _globals['_AUDIENCEEXPORT'].fields_by_name['error_message']._loaded_options = None
  _globals['_AUDIENCEEXPORT'].fields_by_name['error_message']._serialized_options = b'\340A\003'
  _globals['_AUDIENCEEXPORT'].fields_by_name['percentage_completed']._loaded_options = None
  _globals['_AUDIENCEEXPORT'].fields_by_name['percentage_completed']._serialized_options = b'\340A\003'
  _globals['_AUDIENCEEXPORT']._loaded_options = None
  _globals['_AUDIENCEEXPORT']._serialized_options = b'\352A\207\001\n+analyticsdata.googleapis.com/AudienceExport\0227properties/{property}/audienceExports/{audience_export}*\017audienceExports2\016audienceExport'
  _globals['_QUERYAUDIENCEEXPORTREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_QUERYAUDIENCEEXPORTREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002'
  _globals['_QUERYAUDIENCEEXPORTREQUEST'].fields_by_name['offset']._loaded_options = None
  _globals['_QUERYAUDIENCEEXPORTREQUEST'].fields_by_name['offset']._serialized_options = b'\340A\001'
  _globals['_QUERYAUDIENCEEXPORTREQUEST'].fields_by_name['limit']._loaded_options = None
  _globals['_QUERYAUDIENCEEXPORTREQUEST'].fields_by_name['limit']._serialized_options = b'\340A\001'
  ...
  _globals['_BETAANALYTICSDATA']._serialized_options = b'\312A\034analyticsdata.googleapis.com\322A\\https://www.googleapis.com/auth/analytics,https://www.googleapis.com/auth/analytics.readonly'
  _globals['_BETAANALYTICSDATA'].methods_by_name['RunReport']._loaded_options = None
  _globals['_BETAANALYTICSDATA'].methods_by_name['RunReport']._serialized_options = b'\202\323\344\223\002.\")/v1beta/{property=properties/*}:runReport:\001*'
  _globals['_BETAANALYTICSDATA'].methods_by_name['RunPivotReport']._loaded_options = None
  _globals['_BETAANALYTICSDATA'].methods_by_name['RunPivotReport']._serialized_options = b'\202\323\344\223\0023\"./v1beta/{property=properties/*}:runPivotReport:\001*'
  _globals['_BETAANALYTICSDATA'].methods_by_name['BatchRunReports']._loaded_options = None
  _globals['_BETAANALYTICSDATA'].methods_by_name['BatchRunReports']._serialized_options = b'\202\323\344\223\0024\"//v1beta/{property=properties/*}:batchRunReports:\001*'
  _globals['_BETAANALYTICSDATA'].methods_by_name['BatchRunPivotReports']._loaded_options = None
  _globals['_BETAANALYTICSDATA'].methods_by_name['BatchRunPivotReports']._serialized_options = b'\202\323\344\223\0029\"4/v1beta/{property=properties/*}:batchRunPivotReports:\001*'
  _globals['_BETAANALYTICSDATA'].methods_by_name['GetMetadata']._loaded_options = None
  _globals['_BETAANALYTICSDATA'].methods_by_name['GetMetadata']._serialized_options = b'\332A\004name\202\323\344\223\002&\022$/v1beta/{name=properties/*/metadata}'
  _globals['_BETAANALYTICSDATA'].methods_by_name['RunRealtimeReport']._loaded_options = None
  _globals['_BETAANALYTICSDATA'].methods_by_name['RunRealtimeReport']._serialized_options = b'\202\323\344\223\0026\"1/v1beta/{property=properties/*}:runRealtimeReport:\001*'
  _globals['_BETAANALYTICSDATA'].methods_by_name['CheckCompatibility']._loaded_options = None
  _globals['_BETAANALYTICSDATA'].methods_by_name['CheckCompatibility']._serialized_options = b'\202\323\344\223\0027\"2/v1beta/{property=properties/*}:checkCompatibility:\001*'
  _globals['_BETAANALYTICSDATA'].methods_by_name['CreateAudienceExport']._loaded_options = None
  _globals['_BETAANALYTICSDATA'].methods_by_name['CreateAudienceExport']._serialized_options = b'\312A(\n\016AudienceExport\022\026AudienceExportMetadata\332A\026parent,audience_export\202\323\344\223\002@\"-/v1beta/{parent=properties/*}/audienceExports:\017audience_export'
  _globals['_BETAANALYTICSDATA'].methods_by_name['QueryAudienceExport']._loaded_options = None
  _globals['_BETAANALYTICSDATA'].methods_by_name['QueryAudienceExport']._serialized_options = b'\332A\004name\202\323\344\223\0028\"3/v1beta/{name=properties/*/audienceExports/*}:query:\001*'
  _globals['_BETAANALYTICSDATA'].methods_by_name['GetAudienceExport']._loaded_options = None
  _globals['_BETAANALYTICSDATA'].methods_by_name['GetAudienceExport']._serialized_options = b'\332A\004name\202\323\344\223\002/\022-/v1beta/{name=properties/*/audienceExports/*}'
  _globals['_BETAANALYTICSDATA'].methods_by_name['ListAudienceExports']._loaded_options = None
  _globals['_BETAANALYTICSDATA'].methods_by_name['ListAudienceExports']._serialized_options = b'\332A\006parent\202\323\344\223\002/\022-/v1beta/{parent=properties/*}/audienceExports'
