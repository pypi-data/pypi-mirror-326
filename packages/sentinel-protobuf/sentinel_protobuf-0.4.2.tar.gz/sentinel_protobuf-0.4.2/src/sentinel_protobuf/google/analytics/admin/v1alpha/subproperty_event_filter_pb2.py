...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/analytics/admin/v1alpha/subproperty_event_filter.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\"com.google.analytics.admin.v1alphaB\033SubpropertyEventFilterProtoP\001Z>cloud.google.com/go/analytics/admin/apiv1alpha/adminpb;adminpb'
  _globals['_SUBPROPERTYEVENTFILTERCONDITION_STRINGFILTER'].fields_by_name['match_type']._loaded_options = None
  _globals['_SUBPROPERTYEVENTFILTERCONDITION_STRINGFILTER'].fields_by_name['match_type']._serialized_options = b'\340A\002'
  _globals['_SUBPROPERTYEVENTFILTERCONDITION_STRINGFILTER'].fields_by_name['value']._loaded_options = None
  _globals['_SUBPROPERTYEVENTFILTERCONDITION_STRINGFILTER'].fields_by_name['value']._serialized_options = b'\340A\002'
  _globals['_SUBPROPERTYEVENTFILTERCONDITION_STRINGFILTER'].fields_by_name['case_sensitive']._loaded_options = None
  _globals['_SUBPROPERTYEVENTFILTERCONDITION_STRINGFILTER'].fields_by_name['case_sensitive']._serialized_options = b'\340A\001'
  _globals['_SUBPROPERTYEVENTFILTERCONDITION'].fields_by_name['field_name']._loaded_options = None
  _globals['_SUBPROPERTYEVENTFILTERCONDITION'].fields_by_name['field_name']._serialized_options = b'\340A\002'
  _globals['_SUBPROPERTYEVENTFILTEREXPRESSIONLIST'].fields_by_name['filter_expressions']._loaded_options = None
  _globals['_SUBPROPERTYEVENTFILTEREXPRESSIONLIST'].fields_by_name['filter_expressions']._serialized_options = b'\340A\002\340A\006'
  _globals['_SUBPROPERTYEVENTFILTERCLAUSE'].fields_by_name['filter_clause_type']._loaded_options = None
  _globals['_SUBPROPERTYEVENTFILTERCLAUSE'].fields_by_name['filter_clause_type']._serialized_options = b'\340A\002'
  _globals['_SUBPROPERTYEVENTFILTERCLAUSE'].fields_by_name['filter_expression']._loaded_options = None
  _globals['_SUBPROPERTYEVENTFILTERCLAUSE'].fields_by_name['filter_expression']._serialized_options = b'\340A\002'
  _globals['_SUBPROPERTYEVENTFILTER'].fields_by_name['name']._loaded_options = None
  _globals['_SUBPROPERTYEVENTFILTER'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_SUBPROPERTYEVENTFILTER'].fields_by_name['apply_to_property']._loaded_options = None
  _globals['_SUBPROPERTYEVENTFILTER'].fields_by_name['apply_to_property']._serialized_options = b'\340A\005'
  _globals['_SUBPROPERTYEVENTFILTER'].fields_by_name['filter_clauses']._loaded_options = None
  _globals['_SUBPROPERTYEVENTFILTER'].fields_by_name['filter_clauses']._serialized_options = b'\340A\002\340A\006'
  _globals['_SUBPROPERTYEVENTFILTER']._loaded_options = None
  _globals['_SUBPROPERTYEVENTFILTER']._serialized_options = b'\352A\262\001\n4analyticsadmin.googleapis.com/SubpropertyEventFilter\022Iproperties/{property}/subpropertyEventFilters/{sub_property_event_filter}*\027subpropertyEventFilters2\026subpropertyEventFilter'
