...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\'com.google.shopping.merchant.lfp.v1betaB\021LfpInventoryProtoP\001Z?cloud.google.com/go/shopping/merchant/lfp/apiv1beta/lfppb;lfppb\352A8\n\"merchantapi.googleapis.com/Account\022\022accounts/{account}'
  _globals['_LFPINVENTORY'].fields_by_name['name']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['name']._serialized_options = b'\340A\003\340A\010'
  _globals['_LFPINVENTORY'].fields_by_name['target_account']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['target_account']._serialized_options = b'\340A\002'
  _globals['_LFPINVENTORY'].fields_by_name['store_code']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['store_code']._serialized_options = b'\340A\002'
  _globals['_LFPINVENTORY'].fields_by_name['offer_id']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['offer_id']._serialized_options = b'\340A\002\340A\005'
  _globals['_LFPINVENTORY'].fields_by_name['region_code']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['region_code']._serialized_options = b'\340A\002'
  _globals['_LFPINVENTORY'].fields_by_name['content_language']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['content_language']._serialized_options = b'\340A\002'
  _globals['_LFPINVENTORY'].fields_by_name['gtin']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['gtin']._serialized_options = b'\340A\001'
  _globals['_LFPINVENTORY'].fields_by_name['price']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['price']._serialized_options = b'\340A\001'
  _globals['_LFPINVENTORY'].fields_by_name['availability']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['availability']._serialized_options = b'\340A\002'
  _globals['_LFPINVENTORY'].fields_by_name['quantity']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['quantity']._serialized_options = b'\340A\001'
  _globals['_LFPINVENTORY'].fields_by_name['collection_time']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['collection_time']._serialized_options = b'\340A\001'
  _globals['_LFPINVENTORY'].fields_by_name['pickup_method']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['pickup_method']._serialized_options = b'\340A\001'
  _globals['_LFPINVENTORY'].fields_by_name['pickup_sla']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['pickup_sla']._serialized_options = b'\340A\001'
  _globals['_LFPINVENTORY'].fields_by_name['feed_label']._loaded_options = None
  _globals['_LFPINVENTORY'].fields_by_name['feed_label']._serialized_options = b'\340A\001'
  _globals['_LFPINVENTORY']._loaded_options = None
  _globals['_LFPINVENTORY']._serialized_options = b'\352A\221\001\n\'merchantapi.googleapis.com/LfpInventory\022Haccounts/{account}/lfpInventories/{target_merchant}~{store_code}~{offer}*\016lfpInventories2\014lfpInventory'
  _globals['_INSERTLFPINVENTORYREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_INSERTLFPINVENTORYREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A)\022\'merchantapi.googleapis.com/LfpInventory'
  _globals['_INSERTLFPINVENTORYREQUEST'].fields_by_name['lfp_inventory']._loaded_options = None
  _globals['_INSERTLFPINVENTORYREQUEST'].fields_by_name['lfp_inventory']._serialized_options = b'\340A\002'
  _globals['_LFPINVENTORYSERVICE']._loaded_options = None
  _globals['_LFPINVENTORYSERVICE']._serialized_options = b'\312A\032merchantapi.googleapis.com\322A\'https://www.googleapis.com/auth/content'
  _globals['_LFPINVENTORYSERVICE'].methods_by_name['InsertLfpInventory']._loaded_options = None
  _globals['_LFPINVENTORYSERVICE'].methods_by_name['InsertLfpInventory']._serialized_options = b'\202\323\344\223\002F\"5/lfp/v1beta/{parent=accounts/*}/lfpInventories:insert:\rlfp_inventory'
