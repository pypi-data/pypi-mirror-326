...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n/com.google.shopping.merchant.inventories.v1betaB\026RegionalInventoryProtoP\001ZWcloud.google.com/go/shopping/merchant/inventories/apiv1beta/inventoriespb;inventoriespb'
  _globals['_REGIONALINVENTORY'].fields_by_name['name']._loaded_options = None
  _globals['_REGIONALINVENTORY'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_REGIONALINVENTORY'].fields_by_name['account']._loaded_options = None
  _globals['_REGIONALINVENTORY'].fields_by_name['account']._serialized_options = b'\340A\003'
  _globals['_REGIONALINVENTORY'].fields_by_name['region']._loaded_options = None
  _globals['_REGIONALINVENTORY'].fields_by_name['region']._serialized_options = b'\340A\002\340A\005'
  _globals['_REGIONALINVENTORY']._loaded_options = None
  _globals['_REGIONALINVENTORY']._serialized_options = b'\352Ar\n,merchantapi.googleapis.com/RegionalInventory\022Baccounts/{account}/products/{product}/regionalInventories/{region}'
  _globals['_LISTREGIONALINVENTORIESREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTREGIONALINVENTORIESREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A.\022,merchantapi.googleapis.com/RegionalInventory'
  _globals['_INSERTREGIONALINVENTORYREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_INSERTREGIONALINVENTORYREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A.\022,merchantapi.googleapis.com/RegionalInventory'
  _globals['_INSERTREGIONALINVENTORYREQUEST'].fields_by_name['regional_inventory']._loaded_options = None
  _globals['_INSERTREGIONALINVENTORYREQUEST'].fields_by_name['regional_inventory']._serialized_options = b'\340A\002'
  _globals['_DELETEREGIONALINVENTORYREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_DELETEREGIONALINVENTORYREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A.\n,merchantapi.googleapis.com/RegionalInventory'
  _globals['_REGIONALINVENTORYSERVICE']._loaded_options = None
  _globals['_REGIONALINVENTORYSERVICE']._serialized_options = b'\312A\032merchantapi.googleapis.com\322A\'https://www.googleapis.com/auth/content'
  _globals['_REGIONALINVENTORYSERVICE'].methods_by_name['ListRegionalInventories']._loaded_options = None
  _globals['_REGIONALINVENTORYSERVICE'].methods_by_name['ListRegionalInventories']._serialized_options = b'\332A\006parent\202\323\344\223\002H\022F/inventories/v1beta/{parent=accounts/*/products/*}/regionalInventories'
  _globals['_REGIONALINVENTORYSERVICE'].methods_by_name['InsertRegionalInventory']._loaded_options = None
  _globals['_REGIONALINVENTORYSERVICE'].methods_by_name['InsertRegionalInventory']._serialized_options = b'\202\323\344\223\002c\"M/inventories/v1beta/{parent=accounts/*/products/*}/regionalInventories:insert:\022regional_inventory'
  _globals['_REGIONALINVENTORYSERVICE'].methods_by_name['DeleteRegionalInventory']._loaded_options = None
  _globals['_REGIONALINVENTORYSERVICE'].methods_by_name['DeleteRegionalInventory']._serialized_options = b'\332A\004name\202\323\344\223\002H*F/inventories/v1beta/{name=accounts/*/products/*/regionalInventories/*}'
