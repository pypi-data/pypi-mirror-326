...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n/com.google.shopping.merchant.inventories.v1betaB\023LocalInventoryProtoP\001ZWcloud.google.com/go/shopping/merchant/inventories/apiv1beta/inventoriespb;inventoriespb\352AK\n\"merchantapi.googleapis.com/Product\022%accounts/{account}/products/{product}'
  _globals['_LOCALINVENTORY'].fields_by_name['name']._loaded_options = None
  _globals['_LOCALINVENTORY'].fields_by_name['name']._serialized_options = b'\340A\003'
  _globals['_LOCALINVENTORY'].fields_by_name['account']._loaded_options = None
  _globals['_LOCALINVENTORY'].fields_by_name['account']._serialized_options = b'\340A\003'
  _globals['_LOCALINVENTORY'].fields_by_name['store_code']._loaded_options = None
  _globals['_LOCALINVENTORY'].fields_by_name['store_code']._serialized_options = b'\340A\002\340A\005'
  _globals['_LOCALINVENTORY']._loaded_options = None
  _globals['_LOCALINVENTORY']._serialized_options = b'\352Ap\n)merchantapi.googleapis.com/LocalInventory\022Caccounts/{account}/products/{product}/localInventories/{store_code}'
  _globals['_LISTLOCALINVENTORIESREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTLOCALINVENTORIESREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A+\022)merchantapi.googleapis.com/LocalInventory'
  _globals['_INSERTLOCALINVENTORYREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_INSERTLOCALINVENTORYREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A+\022)merchantapi.googleapis.com/LocalInventory'
  _globals['_INSERTLOCALINVENTORYREQUEST'].fields_by_name['local_inventory']._loaded_options = None
  _globals['_INSERTLOCALINVENTORYREQUEST'].fields_by_name['local_inventory']._serialized_options = b'\340A\002'
  _globals['_DELETELOCALINVENTORYREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_DELETELOCALINVENTORYREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A+\n)merchantapi.googleapis.com/LocalInventory'
  _globals['_LOCALINVENTORYSERVICE']._loaded_options = None
  _globals['_LOCALINVENTORYSERVICE']._serialized_options = b'\312A\032merchantapi.googleapis.com\322A\'https://www.googleapis.com/auth/content'
  _globals['_LOCALINVENTORYSERVICE'].methods_by_name['ListLocalInventories']._loaded_options = None
  _globals['_LOCALINVENTORYSERVICE'].methods_by_name['ListLocalInventories']._serialized_options = b'\332A\006parent\202\323\344\223\002E\022C/inventories/v1beta/{parent=accounts/*/products/*}/localInventories'
  _globals['_LOCALINVENTORYSERVICE'].methods_by_name['InsertLocalInventory']._loaded_options = None
  _globals['_LOCALINVENTORYSERVICE'].methods_by_name['InsertLocalInventory']._serialized_options = b'\202\323\344\223\002]\"J/inventories/v1beta/{parent=accounts/*/products/*}/localInventories:insert:\017local_inventory'
  _globals['_LOCALINVENTORYSERVICE'].methods_by_name['DeleteLocalInventory']._loaded_options = None
  _globals['_LOCALINVENTORYSERVICE'].methods_by_name['DeleteLocalInventory']._serialized_options = b'\332A\004name\202\323\344\223\002E*C/inventories/v1beta/{name=accounts/*/products/*/localInventories/*}'
