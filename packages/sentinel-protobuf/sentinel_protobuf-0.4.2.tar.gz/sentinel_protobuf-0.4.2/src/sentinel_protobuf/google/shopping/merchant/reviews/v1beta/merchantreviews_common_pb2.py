...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n+com.google.shopping.merchant.reviews.v1betaB\032MerchantReviewsCommonProtoP\001ZKcloud.google.com/go/shopping/merchant/reviews/apiv1beta/reviewspb;reviewspb\252\002\'Google.Shopping.Merchant.Reviews.V1Beta\312\002\'Google\\Shopping\\Merchant\\Reviews\\V1beta\352\002+Google::Shopping::Merchant::Reviews::V1beta'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['merchant_id']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['merchant_id']._serialized_options = b'\340A\002'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['merchant_display_name']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['merchant_display_name']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['merchant_link']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['merchant_link']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['merchant_rating_link']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['merchant_rating_link']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['min_rating']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['min_rating']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['max_rating']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['max_rating']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['rating']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['rating']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['title']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['title']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['content']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['content']._serialized_options = b'\340A\002'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['reviewer_id']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['reviewer_id']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['reviewer_username']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['reviewer_username']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['is_anonymous']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['is_anonymous']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['collection_method']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['collection_method']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['review_time']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['review_time']._serialized_options = b'\340A\002'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['review_language']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['review_language']._serialized_options = b'\340A\002'
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['review_country']._loaded_options = None
  _globals['_MERCHANTREVIEWATTRIBUTES'].fields_by_name['review_country']._serialized_options = b'\340A\001'
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWDESTINATIONSTATUS'].fields_by_name['reporting_context']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWDESTINATIONSTATUS'].fields_by_name['reporting_context']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['code']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['code']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['severity']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['severity']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['resolution']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['resolution']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['attribute']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['attribute']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['reporting_context']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['reporting_context']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['description']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['description']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['detail']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['detail']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['documentation']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS_MERCHANTREVIEWITEMLEVELISSUE'].fields_by_name['documentation']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS'].fields_by_name['destination_statuses']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS'].fields_by_name['destination_statuses']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS'].fields_by_name['item_level_issues']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS'].fields_by_name['item_level_issues']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS'].fields_by_name['create_time']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS'].fields_by_name['create_time']._serialized_options = b'\340A\003'
  _globals['_MERCHANTREVIEWSTATUS'].fields_by_name['last_update_time']._loaded_options = None
  _globals['_MERCHANTREVIEWSTATUS'].fields_by_name['last_update_time']._serialized_options = b'\340A\003'
