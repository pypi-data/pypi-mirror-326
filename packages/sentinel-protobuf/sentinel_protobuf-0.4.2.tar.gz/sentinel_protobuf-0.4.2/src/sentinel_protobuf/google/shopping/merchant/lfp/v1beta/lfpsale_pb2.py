...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/shopping/merchant/lfp/v1beta/lfpsale.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\'com.google.shopping.merchant.lfp.v1betaB\014LfpSaleProtoP\001Z?cloud.google.com/go/shopping/merchant/lfp/apiv1beta/lfppb;lfppb'
  _globals['_LFPSALE'].fields_by_name['name']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['name']._serialized_options = b'\340A\003\340A\010'
  _globals['_LFPSALE'].fields_by_name['target_account']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['target_account']._serialized_options = b'\340A\002'
  _globals['_LFPSALE'].fields_by_name['store_code']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['store_code']._serialized_options = b'\340A\002'
  _globals['_LFPSALE'].fields_by_name['offer_id']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['offer_id']._serialized_options = b'\340A\002'
  _globals['_LFPSALE'].fields_by_name['region_code']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['region_code']._serialized_options = b'\340A\002'
  _globals['_LFPSALE'].fields_by_name['content_language']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['content_language']._serialized_options = b'\340A\002'
  _globals['_LFPSALE'].fields_by_name['gtin']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['gtin']._serialized_options = b'\340A\002'
  _globals['_LFPSALE'].fields_by_name['price']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['price']._serialized_options = b'\340A\002'
  _globals['_LFPSALE'].fields_by_name['quantity']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['quantity']._serialized_options = b'\340A\002'
  _globals['_LFPSALE'].fields_by_name['sale_time']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['sale_time']._serialized_options = b'\340A\002'
  _globals['_LFPSALE'].fields_by_name['uid']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['uid']._serialized_options = b'\340A\003\342\214\317\327\010\002\010\001'
  _globals['_LFPSALE'].fields_by_name['feed_label']._loaded_options = None
  _globals['_LFPSALE'].fields_by_name['feed_label']._serialized_options = b'\340A\001'
  _globals['_LFPSALE']._loaded_options = None
  _globals['_LFPSALE']._serialized_options = b'\352A[\n\"merchantapi.googleapis.com/LfpSale\022\"accounts/{account}/lfpSales/{sale}*\010lfpSales2\007lfpSale'
  _globals['_INSERTLFPSALEREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_INSERTLFPSALEREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002'
  _globals['_INSERTLFPSALEREQUEST'].fields_by_name['lfp_sale']._loaded_options = None
  _globals['_INSERTLFPSALEREQUEST'].fields_by_name['lfp_sale']._serialized_options = b'\340A\002'
  _globals['_LFPSALESERVICE']._loaded_options = None
  _globals['_LFPSALESERVICE']._serialized_options = b'\312A\032merchantapi.googleapis.com\322A\'https://www.googleapis.com/auth/content'
  _globals['_LFPSALESERVICE'].methods_by_name['InsertLfpSale']._loaded_options = None
  _globals['_LFPSALESERVICE'].methods_by_name['InsertLfpSale']._serialized_options = b'\202\323\344\223\002;\"//lfp/v1beta/{parent=accounts/*}/lfpSales:insert:\010lfp_sale'
