...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/shopping/merchant/reviews/v1beta/productreviews.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n+com.google.shopping.merchant.reviews.v1betaB\023ProductReviewsProtoP\001ZKcloud.google.com/go/shopping/merchant/reviews/apiv1beta/reviewspb;reviewspb\252\002\'Google.Shopping.Merchant.Reviews.V1Beta\312\002\'Google\\Shopping\\Merchant\\Reviews\\V1beta\352\002+Google::Shopping::Merchant::Reviews::V1beta'
  _globals['_GETPRODUCTREVIEWREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETPRODUCTREVIEWREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A*\n(merchantapi.googleapis.com/ProductReview'
  _globals['_DELETEPRODUCTREVIEWREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_DELETEPRODUCTREVIEWREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A*\n(merchantapi.googleapis.com/ProductReview'
  _globals['_LISTPRODUCTREVIEWSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTPRODUCTREVIEWSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A*\022(merchantapi.googleapis.com/ProductReview'
  _globals['_LISTPRODUCTREVIEWSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTPRODUCTREVIEWSREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTPRODUCTREVIEWSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTPRODUCTREVIEWSREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_INSERTPRODUCTREVIEWREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_INSERTPRODUCTREVIEWREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002'
  _globals['_INSERTPRODUCTREVIEWREQUEST'].fields_by_name['product_review']._loaded_options = None
  _globals['_INSERTPRODUCTREVIEWREQUEST'].fields_by_name['product_review']._serialized_options = b'\340A\002'
  _globals['_INSERTPRODUCTREVIEWREQUEST'].fields_by_name['data_source']._loaded_options = None
  _globals['_INSERTPRODUCTREVIEWREQUEST'].fields_by_name['data_source']._serialized_options = b'\340A\002'
  _globals['_PRODUCTREVIEW'].fields_by_name['name']._loaded_options = None
  _globals['_PRODUCTREVIEW'].fields_by_name['name']._serialized_options = b'\340A\010'
  _globals['_PRODUCTREVIEW'].fields_by_name['product_review_id']._loaded_options = None
  _globals['_PRODUCTREVIEW'].fields_by_name['product_review_id']._serialized_options = b'\340A\002'
  _globals['_PRODUCTREVIEW'].fields_by_name['attributes']._loaded_options = None
  _globals['_PRODUCTREVIEW'].fields_by_name['attributes']._serialized_options = b'\340A\001'
  _globals['_PRODUCTREVIEW'].fields_by_name['custom_attributes']._loaded_options = None
  _globals['_PRODUCTREVIEW'].fields_by_name['custom_attributes']._serialized_options = b'\340A\001'
  _globals['_PRODUCTREVIEW'].fields_by_name['data_source']._loaded_options = None
  _globals['_PRODUCTREVIEW'].fields_by_name['data_source']._serialized_options = b'\340A\003'
  _globals['_PRODUCTREVIEW'].fields_by_name['product_review_status']._loaded_options = None
  _globals['_PRODUCTREVIEW'].fields_by_name['product_review_status']._serialized_options = b'\340A\003'
  _globals['_PRODUCTREVIEW']._loaded_options = None
  _globals['_PRODUCTREVIEW']._serialized_options = b'\352A|\n(merchantapi.googleapis.com/ProductReview\0221accounts/{account}/productReviews/{productreview}*\016productReviews2\rproductReview'
  _globals['_PRODUCTREVIEWSSERVICE']._loaded_options = None
  _globals['_PRODUCTREVIEWSSERVICE']._serialized_options = b'\312A\032merchantapi.googleapis.com\322A\'https://www.googleapis.com/auth/content'
  _globals['_PRODUCTREVIEWSSERVICE'].methods_by_name['GetProductReview']._loaded_options = None
  _globals['_PRODUCTREVIEWSSERVICE'].methods_by_name['GetProductReview']._serialized_options = b'\332A\004name\202\323\344\223\0024\0222/reviews/v1beta/{name=accounts/*/productReviews/*}'
  _globals['_PRODUCTREVIEWSSERVICE'].methods_by_name['ListProductReviews']._loaded_options = None
  _globals['_PRODUCTREVIEWSSERVICE'].methods_by_name['ListProductReviews']._serialized_options = b'\332A\006parent\202\323\344\223\0024\0222/reviews/v1beta/{parent=accounts/*}/productReviews'
  _globals['_PRODUCTREVIEWSSERVICE'].methods_by_name['InsertProductReview']._loaded_options = None
  _globals['_PRODUCTREVIEWSSERVICE'].methods_by_name['InsertProductReview']._serialized_options = b'\202\323\344\223\002K\"9/reviews/v1beta/{parent=accounts/*}/productReviews:insert:\016product_review'
  _globals['_PRODUCTREVIEWSSERVICE'].methods_by_name['DeleteProductReview']._loaded_options = None
  _globals['_PRODUCTREVIEWSSERVICE'].methods_by_name['DeleteProductReview']._serialized_options = b'\332A\004name\202\323\344\223\0024*2/reviews/v1beta/{name=accounts/*/productReviews/*}'
  ...
  _globals['_PRODUCTREVIEW']._serialized_end=1464
  _globals['_PRODUCTREVIEWSSERVICE']._serialized_start=1467
  _globals['_PRODUCTREVIEWSSERVICE']._serialized_end=2418
