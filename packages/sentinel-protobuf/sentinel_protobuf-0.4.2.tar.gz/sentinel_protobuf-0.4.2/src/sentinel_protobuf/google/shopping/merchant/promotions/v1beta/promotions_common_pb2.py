...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/shopping/merchant/promotions/v1beta/promotions_common.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n.com.google.shopping.merchant.promotions.v1betaB\025PromotionsCommonProtoP\001ZTcloud.google.com/go/shopping/merchant/promotions/apiv1beta/promotionspb;promotionspb'
  _globals['_ATTRIBUTES'].fields_by_name['product_applicability']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['product_applicability']._serialized_options = b'\340A\002'
  _globals['_ATTRIBUTES'].fields_by_name['offer_type']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['offer_type']._serialized_options = b'\340A\002'
  _globals['_ATTRIBUTES'].fields_by_name['generic_redemption_code']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['generic_redemption_code']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['long_title']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['long_title']._serialized_options = b'\340A\002'
  _globals['_ATTRIBUTES'].fields_by_name['coupon_value_type']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['coupon_value_type']._serialized_options = b'\340A\002'
  _globals['_ATTRIBUTES'].fields_by_name['promotion_destinations']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['promotion_destinations']._serialized_options = b'\340A\002'
  _globals['_ATTRIBUTES'].fields_by_name['item_id_inclusion']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['item_id_inclusion']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['brand_inclusion']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['brand_inclusion']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['item_group_id_inclusion']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['item_group_id_inclusion']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['product_type_inclusion']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['product_type_inclusion']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['item_id_exclusion']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['item_id_exclusion']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['brand_exclusion']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['brand_exclusion']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['item_group_id_exclusion']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['item_group_id_exclusion']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['product_type_exclusion']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['product_type_exclusion']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['minimum_purchase_amount']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['minimum_purchase_amount']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['minimum_purchase_quantity']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['minimum_purchase_quantity']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['limit_quantity']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['limit_quantity']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['limit_value']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['limit_value']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['percent_off']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['percent_off']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['money_off_amount']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['money_off_amount']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['get_this_quantity_discounted']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['get_this_quantity_discounted']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['free_gift_value']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['free_gift_value']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['free_gift_description']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['free_gift_description']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['free_gift_item_id']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['free_gift_item_id']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['promotion_effective_time_period']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['promotion_effective_time_period']._serialized_options = b'\340A\002'
  _globals['_ATTRIBUTES'].fields_by_name['promotion_display_time_period']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['promotion_display_time_period']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['store_applicability']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['store_applicability']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['store_codes_inclusion']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['store_codes_inclusion']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['store_codes_exclusion']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['store_codes_exclusion']._serialized_options = b'\340A\001'
  _globals['_ATTRIBUTES'].fields_by_name['promotion_url']._loaded_options = None
  _globals['_ATTRIBUTES'].fields_by_name['promotion_url']._serialized_options = b'\340A\001'
  _globals['_PROMOTIONSTATUS_DESTINATIONSTATUS'].fields_by_name['reporting_context']._loaded_options = None
  _globals['_PROMOTIONSTATUS_DESTINATIONSTATUS'].fields_by_name['reporting_context']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS_DESTINATIONSTATUS'].fields_by_name['status']._loaded_options = None
  _globals['_PROMOTIONSTATUS_DESTINATIONSTATUS'].fields_by_name['status']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['code']._loaded_options = None
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['code']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['severity']._loaded_options = None
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['severity']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['resolution']._loaded_options = None
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['resolution']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['attribute']._loaded_options = None
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['attribute']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['reporting_context']._loaded_options = None
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['reporting_context']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['description']._loaded_options = None
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['description']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['detail']._loaded_options = None
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['detail']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['documentation']._loaded_options = None
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['documentation']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['applicable_countries']._loaded_options = None
  _globals['_PROMOTIONSTATUS_ITEMLEVELISSUE'].fields_by_name['applicable_countries']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS'].fields_by_name['destination_statuses']._loaded_options = None
  _globals['_PROMOTIONSTATUS'].fields_by_name['destination_statuses']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS'].fields_by_name['item_level_issues']._loaded_options = None
  _globals['_PROMOTIONSTATUS'].fields_by_name['item_level_issues']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS'].fields_by_name['creation_date']._loaded_options = None
  _globals['_PROMOTIONSTATUS'].fields_by_name['creation_date']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSTATUS'].fields_by_name['last_update_date']._loaded_options = None
  _globals['_PROMOTIONSTATUS'].fields_by_name['last_update_date']._serialized_options = b'\340A\003'
