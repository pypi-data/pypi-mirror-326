...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n\032com.google.shopping.css.v1B\025CssProductInputsProtoP\001Z2cloud.google.com/go/shopping/css/apiv1/csspb;csspb\252\002\026Google.Shopping.Css.V1\312\002\026Google\\Shopping\\Css\\V1\352\002\031Google::Shopping::Css::V1'
  _globals['_CSSPRODUCTINPUT'].fields_by_name['final_name']._loaded_options = None
  _globals['_CSSPRODUCTINPUT'].fields_by_name['final_name']._serialized_options = b'\340A\003'
  _globals['_CSSPRODUCTINPUT'].fields_by_name['raw_provided_id']._loaded_options = None
  _globals['_CSSPRODUCTINPUT'].fields_by_name['raw_provided_id']._serialized_options = b'\340A\002'
  _globals['_CSSPRODUCTINPUT'].fields_by_name['content_language']._loaded_options = None
  _globals['_CSSPRODUCTINPUT'].fields_by_name['content_language']._serialized_options = b'\340A\002'
  _globals['_CSSPRODUCTINPUT'].fields_by_name['feed_label']._loaded_options = None
  _globals['_CSSPRODUCTINPUT'].fields_by_name['feed_label']._serialized_options = b'\340A\002'
  _globals['_CSSPRODUCTINPUT'].fields_by_name['freshness_time']._loaded_options = None
  _globals['_CSSPRODUCTINPUT'].fields_by_name['freshness_time']._serialized_options = b'\030\001'
  _globals['_CSSPRODUCTINPUT']._loaded_options = None
  _globals['_CSSPRODUCTINPUT']._serialized_options = b'\352A]\n\"css.googleapis.com/CssProductInput\0227accounts/{account}/cssProductInputs/{css_product_input}'
  _globals['_INSERTCSSPRODUCTINPUTREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_INSERTCSSPRODUCTINPUTREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A$\022\"css.googleapis.com/CssProductInput'
  _globals['_INSERTCSSPRODUCTINPUTREQUEST'].fields_by_name['css_product_input']._loaded_options = None
  _globals['_INSERTCSSPRODUCTINPUTREQUEST'].fields_by_name['css_product_input']._serialized_options = b'\340A\002'
  _globals['_INSERTCSSPRODUCTINPUTREQUEST'].fields_by_name['feed_id']._loaded_options = None
  _globals['_INSERTCSSPRODUCTINPUTREQUEST'].fields_by_name['feed_id']._serialized_options = b'\030\001\340A\001'
  _globals['_UPDATECSSPRODUCTINPUTREQUEST'].fields_by_name['css_product_input']._loaded_options = None
  _globals['_UPDATECSSPRODUCTINPUTREQUEST'].fields_by_name['css_product_input']._serialized_options = b'\340A\002'
  _globals['_DELETECSSPRODUCTINPUTREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_DELETECSSPRODUCTINPUTREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A$\n\"css.googleapis.com/CssProductInput'
  _globals['_CSSPRODUCTINPUTSSERVICE']._loaded_options = None
  _globals['_CSSPRODUCTINPUTSSERVICE']._serialized_options = b'\312A\022css.googleapis.com\322A\'https://www.googleapis.com/auth/content'
  _globals['_CSSPRODUCTINPUTSSERVICE'].methods_by_name['InsertCssProductInput']._loaded_options = None
  _globals['_CSSPRODUCTINPUTSSERVICE'].methods_by_name['InsertCssProductInput']._serialized_options = b'\202\323\344\223\002D\"//v1/{parent=accounts/*}/cssProductInputs:insert:\021css_product_input'
  _globals['_CSSPRODUCTINPUTSSERVICE'].methods_by_name['UpdateCssProductInput']._loaded_options = None
  _globals['_CSSPRODUCTINPUTSSERVICE'].methods_by_name['UpdateCssProductInput']._serialized_options = b'\332A\035css_product_input,update_mask\202\323\344\223\002O2:/v1/{css_product_input.name=accounts/*/cssProductInputs/*}:\021css_product_input'
  _globals['_CSSPRODUCTINPUTSSERVICE'].methods_by_name['DeleteCssProductInput']._loaded_options = None
  _globals['_CSSPRODUCTINPUTSSERVICE'].methods_by_name['DeleteCssProductInput']._serialized_options = b'\332A\004name\202\323\344\223\002**(/v1/{name=accounts/*/cssProductInputs/*}'
