...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/shopping/merchant/promotions/v1beta/promotions.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n.com.google.shopping.merchant.promotions.v1betaB\017PromotionsProtoP\001ZTcloud.google.com/go/shopping/merchant/promotions/apiv1beta/promotionspb;promotionspb\352A8\n\"merchantapi.googleapis.com/Account\022\022accounts/{account}'
  _globals['_PROMOTION'].fields_by_name['name']._loaded_options = None
  _globals['_PROMOTION'].fields_by_name['name']._serialized_options = b'\340A\010'
  _globals['_PROMOTION'].fields_by_name['promotion_id']._loaded_options = None
  _globals['_PROMOTION'].fields_by_name['promotion_id']._serialized_options = b'\340A\002'
  _globals['_PROMOTION'].fields_by_name['content_language']._loaded_options = None
  _globals['_PROMOTION'].fields_by_name['content_language']._serialized_options = b'\340A\002'
  _globals['_PROMOTION'].fields_by_name['target_country']._loaded_options = None
  _globals['_PROMOTION'].fields_by_name['target_country']._serialized_options = b'\340A\002'
  _globals['_PROMOTION'].fields_by_name['redemption_channel']._loaded_options = None
  _globals['_PROMOTION'].fields_by_name['redemption_channel']._serialized_options = b'\340A\002'
  _globals['_PROMOTION'].fields_by_name['data_source']._loaded_options = None
  _globals['_PROMOTION'].fields_by_name['data_source']._serialized_options = b'\340A\003'
  _globals['_PROMOTION'].fields_by_name['attributes']._loaded_options = None
  _globals['_PROMOTION'].fields_by_name['attributes']._serialized_options = b'\340A\001'
  _globals['_PROMOTION'].fields_by_name['custom_attributes']._loaded_options = None
  _globals['_PROMOTION'].fields_by_name['custom_attributes']._serialized_options = b'\340A\001'
  _globals['_PROMOTION'].fields_by_name['promotion_status']._loaded_options = None
  _globals['_PROMOTION'].fields_by_name['promotion_status']._serialized_options = b'\340A\003'
  _globals['_PROMOTION'].fields_by_name['version_number']._loaded_options = None
  _globals['_PROMOTION'].fields_by_name['version_number']._serialized_options = b'\340A\001'
  _globals['_PROMOTION']._loaded_options = None
  _globals['_PROMOTION']._serialized_options = b'\352Ah\n$merchantapi.googleapis.com/Promotion\022)accounts/{account}/promotions/{promotion}*\npromotions2\tpromotion'
  _globals['_INSERTPROMOTIONREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_INSERTPROMOTIONREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002'
  _globals['_INSERTPROMOTIONREQUEST'].fields_by_name['promotion']._loaded_options = None
  _globals['_INSERTPROMOTIONREQUEST'].fields_by_name['promotion']._serialized_options = b'\340A\002'
  _globals['_INSERTPROMOTIONREQUEST'].fields_by_name['data_source']._loaded_options = None
  _globals['_INSERTPROMOTIONREQUEST'].fields_by_name['data_source']._serialized_options = b'\340A\002'
  _globals['_GETPROMOTIONREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETPROMOTIONREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A&\n$merchantapi.googleapis.com/Promotion'
  _globals['_LISTPROMOTIONSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTPROMOTIONSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002'
  _globals['_LISTPROMOTIONSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTPROMOTIONSREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\003'
  _globals['_LISTPROMOTIONSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTPROMOTIONSREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\003'
  _globals['_PROMOTIONSSERVICE']._loaded_options = None
  _globals['_PROMOTIONSSERVICE']._serialized_options = b'\312A\032merchantapi.googleapis.com\322A\'https://www.googleapis.com/auth/content'
  _globals['_PROMOTIONSSERVICE'].methods_by_name['InsertPromotion']._loaded_options = None
  _globals['_PROMOTIONSSERVICE'].methods_by_name['InsertPromotion']._serialized_options = b'\202\323\344\223\002=\"8/promotions/v1beta/{parent=accounts/*}/promotions:insert:\001*'
  _globals['_PROMOTIONSSERVICE'].methods_by_name['GetPromotion']._loaded_options = None
  _globals['_PROMOTIONSSERVICE'].methods_by_name['GetPromotion']._serialized_options = b'\332A\004name\202\323\344\223\0023\0221/promotions/v1beta/{name=accounts/*/promotions/*}'
  _globals['_PROMOTIONSSERVICE'].methods_by_name['ListPromotions']._loaded_options = None
  _globals['_PROMOTIONSSERVICE'].methods_by_name['ListPromotions']._serialized_options = b'\332A\006parent\202\323\344\223\0023\0221/promotions/v1beta/{parent=accounts/*}/promotions'
