...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'google/shopping/merchant/accounts/v1beta/regions.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n,com.google.shopping.merchant.accounts.v1betaB\014RegionsProtoP\001ZNcloud.google.com/go/shopping/merchant/accounts/apiv1beta/accountspb;accountspb'
  _globals['_GETREGIONREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETREGIONREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A#\n!merchantapi.googleapis.com/Region'
  _globals['_CREATEREGIONREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_CREATEREGIONREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A$\n\"merchantapi.googleapis.com/Account'
  _globals['_CREATEREGIONREQUEST'].fields_by_name['region_id']._loaded_options = None
  _globals['_CREATEREGIONREQUEST'].fields_by_name['region_id']._serialized_options = b'\340A\002'
  _globals['_CREATEREGIONREQUEST'].fields_by_name['region']._loaded_options = None
  _globals['_CREATEREGIONREQUEST'].fields_by_name['region']._serialized_options = b'\340A\002'
  _globals['_UPDATEREGIONREQUEST'].fields_by_name['region']._loaded_options = None
  _globals['_UPDATEREGIONREQUEST'].fields_by_name['region']._serialized_options = b'\340A\002'
  _globals['_UPDATEREGIONREQUEST'].fields_by_name['update_mask']._loaded_options = None
  _globals['_UPDATEREGIONREQUEST'].fields_by_name['update_mask']._serialized_options = b'\340A\001'
  _globals['_DELETEREGIONREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_DELETEREGIONREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A#\n!merchantapi.googleapis.com/Region'
  _globals['_LISTREGIONSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTREGIONSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A$\n\"merchantapi.googleapis.com/Account'
  _globals['_LISTREGIONSREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTREGIONSREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTREGIONSREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTREGIONSREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_REGION_POSTALCODEAREA_POSTALCODERANGE'].fields_by_name['begin']._loaded_options = None
  _globals['_REGION_POSTALCODEAREA_POSTALCODERANGE'].fields_by_name['begin']._serialized_options = b'\340A\002'
  _globals['_REGION_POSTALCODEAREA_POSTALCODERANGE'].fields_by_name['end']._loaded_options = None
  _globals['_REGION_POSTALCODEAREA_POSTALCODERANGE'].fields_by_name['end']._serialized_options = b'\340A\001'
  _globals['_REGION_POSTALCODEAREA'].fields_by_name['region_code']._loaded_options = None
  _globals['_REGION_POSTALCODEAREA'].fields_by_name['region_code']._serialized_options = b'\340A\002'
  _globals['_REGION_POSTALCODEAREA'].fields_by_name['postal_codes']._loaded_options = None
  _globals['_REGION_POSTALCODEAREA'].fields_by_name['postal_codes']._serialized_options = b'\340A\002'
  _globals['_REGION_GEOTARGETAREA'].fields_by_name['geotarget_criteria_ids']._loaded_options = None
  _globals['_REGION_GEOTARGETAREA'].fields_by_name['geotarget_criteria_ids']._serialized_options = b'\340A\002'
  _globals['_REGION'].fields_by_name['name']._loaded_options = None
  _globals['_REGION'].fields_by_name['name']._serialized_options = b'\340A\010'
  _globals['_REGION'].fields_by_name['display_name']._loaded_options = None
  _globals['_REGION'].fields_by_name['display_name']._serialized_options = b'\340A\001'
  _globals['_REGION'].fields_by_name['postal_code_area']._loaded_options = None
  _globals['_REGION'].fields_by_name['postal_code_area']._serialized_options = b'\340A\001'
  _globals['_REGION'].fields_by_name['geotarget_area']._loaded_options = None
  _globals['_REGION'].fields_by_name['geotarget_area']._serialized_options = b'\340A\001'
  _globals['_REGION'].fields_by_name['regional_inventory_eligible']._loaded_options = None
  _globals['_REGION'].fields_by_name['regional_inventory_eligible']._serialized_options = b'\340A\003'
  _globals['_REGION'].fields_by_name['shipping_eligible']._loaded_options = None
  _globals['_REGION'].fields_by_name['shipping_eligible']._serialized_options = b'\340A\003'
  _globals['_REGION']._loaded_options = None
  _globals['_REGION']._serialized_options = b'\352AY\n!merchantapi.googleapis.com/Region\022#accounts/{account}/regions/{region}*\007regions2\006region'
  _globals['_REGIONSSERVICE']._loaded_options = None
  _globals['_REGIONSSERVICE']._serialized_options = b'\312A\032merchantapi.googleapis.com\322A\'https://www.googleapis.com/auth/content'
  _globals['_REGIONSSERVICE'].methods_by_name['GetRegion']._loaded_options = None
  _globals['_REGIONSSERVICE'].methods_by_name['GetRegion']._serialized_options = b'\332A\004name\202\323\344\223\002.\022,/accounts/v1beta/{name=accounts/*/regions/*}'
  _globals['_REGIONSSERVICE'].methods_by_name['CreateRegion']._loaded_options = None
  _globals['_REGIONSSERVICE'].methods_by_name['CreateRegion']._serialized_options = b'\332A\027parent,region,region_id\202\323\344\223\0026\",/accounts/v1beta/{parent=accounts/*}/regions:\006region'
  _globals['_REGIONSSERVICE'].methods_by_name['UpdateRegion']._loaded_options = None
  _globals['_REGIONSSERVICE'].methods_by_name['UpdateRegion']._serialized_options = b'\332A\022region,update_mask\202\323\344\223\002=23/accounts/v1beta/{region.name=accounts/*/regions/*}:\006region'
  _globals['_REGIONSSERVICE'].methods_by_name['DeleteRegion']._loaded_options = None
  _globals['_REGIONSSERVICE'].methods_by_name['DeleteRegion']._serialized_options = b'\332A\004name\202\323\344\223\002.*,/accounts/v1beta/{name=accounts/*/regions/*}'
  _globals['_REGIONSSERVICE'].methods_by_name['ListRegions']._loaded_options = None
  _globals['_REGIONSSERVICE'].methods_by_name['ListRegions']._serialized_options = b'\332A\006parent\202\323\344\223\002.\022,/accounts/v1beta/{parent=accounts/*}/regions'
