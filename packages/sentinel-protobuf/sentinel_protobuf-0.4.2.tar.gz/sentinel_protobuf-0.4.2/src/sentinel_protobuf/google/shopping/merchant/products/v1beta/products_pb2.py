...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n,com.google.shopping.merchant.products.v1betaB\rProductsProtoP\001ZNcloud.google.com/go/shopping/merchant/products/apiv1beta/productspb;productspb\352A8\n\"merchantapi.googleapis.com/Account\022\022accounts/{account}'
  _globals['_PRODUCT'].fields_by_name['channel']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['channel']._serialized_options = b'\340A\003'
  _globals['_PRODUCT'].fields_by_name['offer_id']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['offer_id']._serialized_options = b'\340A\003'
  _globals['_PRODUCT'].fields_by_name['content_language']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['content_language']._serialized_options = b'\340A\003'
  _globals['_PRODUCT'].fields_by_name['feed_label']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['feed_label']._serialized_options = b'\340A\003'
  _globals['_PRODUCT'].fields_by_name['data_source']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['data_source']._serialized_options = b'\340A\003'
  _globals['_PRODUCT'].fields_by_name['version_number']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['version_number']._serialized_options = b'\340A\003'
  _globals['_PRODUCT'].fields_by_name['attributes']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['attributes']._serialized_options = b'\340A\003'
  _globals['_PRODUCT'].fields_by_name['custom_attributes']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['custom_attributes']._serialized_options = b'\340A\003'
  _globals['_PRODUCT'].fields_by_name['product_status']._loaded_options = None
  _globals['_PRODUCT'].fields_by_name['product_status']._serialized_options = b'\340A\003'
  _globals['_PRODUCT']._loaded_options = None
  _globals['_PRODUCT']._serialized_options = b'\352AK\n\"merchantapi.googleapis.com/Product\022%accounts/{account}/products/{product}'
  _globals['_GETPRODUCTREQUEST'].fields_by_name['name']._loaded_options = None
  _globals['_GETPRODUCTREQUEST'].fields_by_name['name']._serialized_options = b'\340A\002\372A$\n\"merchantapi.googleapis.com/Product'
  _globals['_LISTPRODUCTSREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTPRODUCTSREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A$\022\"merchantapi.googleapis.com/Product'
  _globals['_PRODUCTSSERVICE']._loaded_options = None
  _globals['_PRODUCTSSERVICE']._serialized_options = b'\312A\032merchantapi.googleapis.com\322A\'https://www.googleapis.com/auth/content'
  _globals['_PRODUCTSSERVICE'].methods_by_name['GetProduct']._loaded_options = None
  _globals['_PRODUCTSSERVICE'].methods_by_name['GetProduct']._serialized_options = b'\332A\004name\202\323\344\223\002/\022-/products/v1beta/{name=accounts/*/products/*}'
  _globals['_PRODUCTSSERVICE'].methods_by_name['ListProducts']._loaded_options = None
  _globals['_PRODUCTSSERVICE'].methods_by_name['ListProducts']._serialized_options = b'\332A\006parent\202\323\344\223\002/\022-/products/v1beta/{parent=accounts/*}/products'
  _globals['_PRODUCT']._serialized_start=315
  _globals['_PRODUCT']._serialized_end=877
  _globals['_GETPRODUCTREQUEST']._serialized_start=879
  _globals['_GETPRODUCTREQUEST']._serialized_end=956
  _globals['_LISTPRODUCTSREQUEST']._serialized_start=958
  _globals['_LISTPRODUCTSREQUEST']._serialized_end=1078
  _globals['_LISTPRODUCTSRESPONSE']._serialized_start=1080
  _globals['_LISTPRODUCTSRESPONSE']._serialized_end=1196
  _globals['_PRODUCTSSERVICE']._serialized_start=1199
  _globals['_PRODUCTSSERVICE']._serialized_end=1686
