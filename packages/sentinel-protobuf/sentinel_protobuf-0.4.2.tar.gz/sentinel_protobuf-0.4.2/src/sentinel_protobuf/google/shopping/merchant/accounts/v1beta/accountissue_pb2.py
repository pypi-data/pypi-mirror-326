...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'\n,com.google.shopping.merchant.accounts.v1betaB\021AccountIssueProtoP\001ZNcloud.google.com/go/shopping/merchant/accounts/apiv1beta/accountspb;accountspb'
  _globals['_ACCOUNTISSUE'].fields_by_name['name']._loaded_options = None
  _globals['_ACCOUNTISSUE'].fields_by_name['name']._serialized_options = b'\340A\010'
  _globals['_ACCOUNTISSUE']._loaded_options = None
  _globals['_ACCOUNTISSUE']._serialized_options = b'\352Ai\n\'merchantapi.googleapis.com/AccountIssue\022!accounts/{account}/issues/{issue}*\raccountIssues2\014accountIssue'
  _globals['_LISTACCOUNTISSUESREQUEST'].fields_by_name['parent']._loaded_options = None
  _globals['_LISTACCOUNTISSUESREQUEST'].fields_by_name['parent']._serialized_options = b'\340A\002\372A$\n\"merchantapi.googleapis.com/Account'
  _globals['_LISTACCOUNTISSUESREQUEST'].fields_by_name['page_size']._loaded_options = None
  _globals['_LISTACCOUNTISSUESREQUEST'].fields_by_name['page_size']._serialized_options = b'\340A\001'
  _globals['_LISTACCOUNTISSUESREQUEST'].fields_by_name['page_token']._loaded_options = None
  _globals['_LISTACCOUNTISSUESREQUEST'].fields_by_name['page_token']._serialized_options = b'\340A\001'
  _globals['_LISTACCOUNTISSUESREQUEST'].fields_by_name['language_code']._loaded_options = None
  _globals['_LISTACCOUNTISSUESREQUEST'].fields_by_name['language_code']._serialized_options = b'\340A\001'
  _globals['_LISTACCOUNTISSUESREQUEST'].fields_by_name['time_zone']._loaded_options = None
  _globals['_LISTACCOUNTISSUESREQUEST'].fields_by_name['time_zone']._serialized_options = b'\340A\001'
  _globals['_ACCOUNTISSUESERVICE']._loaded_options = None
  _globals['_ACCOUNTISSUESERVICE']._serialized_options = b'\312A\032merchantapi.googleapis.com\322A\'https://www.googleapis.com/auth/content'
  _globals['_ACCOUNTISSUESERVICE'].methods_by_name['ListAccountIssues']._loaded_options = None
  _globals['_ACCOUNTISSUESERVICE'].methods_by_name['ListAccountIssues']._serialized_options = b'\332A\006parent\202\323\344\223\002-\022+/accounts/v1beta/{parent=accounts/*}/issues'
