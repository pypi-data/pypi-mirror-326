...
class NodeConfig(_message.Message):
    __slots__ = ("machine_type", "disk_size_gb", "oauth_scopes", "service_account", "metadata", "image_type", "labels", "local_ssd_count", "tags", "preemptible", "accelerators", "sandbox_config", "node_group", "reservation_affinity", "disk_type", "min_cpu_platform", "workload_metadata_config", "taints", "boot_disk_kms_key", "shielded_instance_config", "linux_node_config", "kubelet_config", "ephemeral_storage_config", "gcfs_config", "advanced_machine_features", "gvnic", "spot", "confidential_nodes", "fast_socket", "resource_labels", "logging_config", "windows_node_config", "local_nvme_ssd_block_config", "ephemeral_storage_local_ssd_config", "sole_tenant_config", "containerd_config", "host_maintenance_policy", "resource_manager_tags", "enable_confidential_storage", "secondary_boot_disks", "secondary_boot_disk_update_strategy")
    ...
    EPHEMERAL_STORAGE_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, machine_type: _Optional[str] = ..., disk_size_gb: _Optional[int] = ..., oauth_scopes: _Optional[_Iterable[str]] = ..., service_account: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ..., image_type: _Optional[str] = ..., labels: _Optional[_Mapping[str, str]] = ..., local_ssd_count: _Optional[int] = ..., tags: _Optional[_Iterable[str]] = ..., preemptible: bool = ..., accelerators: _Optional[_Iterable[_Union[AcceleratorConfig, _Mapping]]] = ..., sandbox_config: _Optional[_Union[SandboxConfig, _Mapping]] = ..., node_group: _Optional[str] = ..., reservation_affinity: _Optional[_Union[ReservationAffinity, _Mapping]] = ..., disk_type: _Optional[str] = ..., min_cpu_platform: _Optional[str] = ..., workload_metadata_config: _Optional[_Union[WorkloadMetadataConfig, _Mapping]] = ..., taints: _Optional[_Iterable[_Union[NodeTaint, _Mapping]]] = ..., boot_disk_kms_key: _Optional[str] = ..., shielded_instance_config: _Optional[_Union[ShieldedInstanceConfig, _Mapping]] = ..., linux_node_config: _Optional[_Union[LinuxNodeConfig, _Mapping]] = ..., kubelet_config: _Optional[_Union[NodeKubeletConfig, _Mapping]] = ..., ephemeral_storage_config: _Optional[_Union[EphemeralStorageConfig, _Mapping]] = ..., gcfs_config: _Optional[_Union[GcfsConfig, _Mapping]] = ..., advanced_machine_features: _Optional[_Union[AdvancedMachineFeatures, _Mapping]] = ..., gvnic: _Optional[_Union[VirtualNIC, _Mapping]] = ..., spot: bool = ..., confidential_nodes: _Optional[_Union[ConfidentialNodes, _Mapping]] = ..., fast_socket: _Optional[_Union[FastSocket, _Mapping]] = ..., resource_labels: _Optional[_Mapping[str, str]] = ..., logging_config: _Optional[_Union[NodePoolLoggingConfig, _Mapping]] = ..., windows_node_config: _Optional[_Union[WindowsNodeConfig, _Mapping]] = ..., local_nvme_ssd_block_config: _Optional[_Union[LocalNvmeSsdBlockConfig, _Mapping]] = ..., ephemeral_storage_local_ssd_config: _Optional[_Union[EphemeralStorageLocalSsdConfig, _Mapping]] = ..., sole_tenant_config: _Optional[_Union[SoleTenantConfig, _Mapping]] = ..., containerd_config: _Optional[_Union[ContainerdConfig, _Mapping]] = ..., host_maintenance_policy: _Optional[_Union[HostMaintenancePolicy, _Mapping]] = ..., resource_manager_tags: _Optional[_Union[ResourceManagerTags, _Mapping]] = ..., enable_confidential_storage: bool = ..., secondary_boot_disks: _Optional[_Iterable[_Union[SecondaryBootDisk, _Mapping]]] = ..., secondary_boot_disk_update_strategy: _Optional[_Union[SecondaryBootDiskUpdateStrategy, _Mapping]] = ...) -> None: ...
...
class NodeNetworkConfig(_message.Message):
    ...
    class NetworkPerformanceConfig(_message.Message):
        __slots__ = ("total_egress_bandwidth_tier", "external_ip_egress_bandwidth_tier")
        ...
        EXTERNAL_IP_EGRESS_BANDWIDTH_TIER_FIELD_NUMBER: _ClassVar[int]
        total_egress_bandwidth_tier: NodeNetworkConfig.NetworkPerformanceConfig.Tier
        external_ip_egress_bandwidth_tier: NodeNetworkConfig.NetworkPerformanceConfig.Tier
        def __init__(self, total_egress_bandwidth_tier: _Optional[_Union[NodeNetworkConfig.NetworkPerformanceConfig.Tier, str]] = ..., external_ip_egress_bandwidth_tier: _Optional[_Union[NodeNetworkConfig.NetworkPerformanceConfig.Tier, str]] = ...) -> None: ...
...
class SandboxConfig(_message.Message):
    ...
    SANDBOX_TYPE_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    sandbox_type: str
    type: SandboxConfig.Type
    def __init__(self, sandbox_type: _Optional[str] = ..., type: _Optional[_Union[SandboxConfig.Type, str]] = ...) -> None: ...

class EphemeralStorageConfig(_message.Message):
...
class HostMaintenancePolicy(_message.Message):
    __slots__ = ("maintenance_interval", "opportunistic_maintenance_strategy")
    class MaintenanceInterval(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        MAINTENANCE_INTERVAL_UNSPECIFIED: _ClassVar[HostMaintenancePolicy.MaintenanceInterval]
        AS_NEEDED: _ClassVar[HostMaintenancePolicy.MaintenanceInterval]
        PERIODIC: _ClassVar[HostMaintenancePolicy.MaintenanceInterval]
    MAINTENANCE_INTERVAL_UNSPECIFIED: HostMaintenancePolicy.MaintenanceInterval
    AS_NEEDED: HostMaintenancePolicy.MaintenanceInterval
    PERIODIC: HostMaintenancePolicy.MaintenanceInterval
    class OpportunisticMaintenanceStrategy(_message.Message):
        __slots__ = ("node_idle_time_window", "maintenance_availability_window", "min_nodes_per_pool")
        NODE_IDLE_TIME_WINDOW_FIELD_NUMBER: _ClassVar[int]
        MAINTENANCE_AVAILABILITY_WINDOW_FIELD_NUMBER: _ClassVar[int]
        MIN_NODES_PER_POOL_FIELD_NUMBER: _ClassVar[int]
        node_idle_time_window: _duration_pb2.Duration
        maintenance_availability_window: _duration_pb2.Duration
        min_nodes_per_pool: int
        def __init__(self, node_idle_time_window: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., maintenance_availability_window: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., min_nodes_per_pool: _Optional[int] = ...) -> None: ...
    MAINTENANCE_INTERVAL_FIELD_NUMBER: _ClassVar[int]
    OPPORTUNISTIC_MAINTENANCE_STRATEGY_FIELD_NUMBER: _ClassVar[int]
    maintenance_interval: HostMaintenancePolicy.MaintenanceInterval
    opportunistic_maintenance_strategy: HostMaintenancePolicy.OpportunisticMaintenanceStrategy
    def __init__(self, maintenance_interval: _Optional[_Union[HostMaintenancePolicy.MaintenanceInterval, str]] = ..., opportunistic_maintenance_strategy: _Optional[_Union[HostMaintenancePolicy.OpportunisticMaintenanceStrategy, _Mapping]] = ...) -> None: ...
...
class AddonsConfig(_message.Message):
    __slots__ = ("http_load_balancing", "horizontal_pod_autoscaling", "kubernetes_dashboard", "network_policy_config", "istio_config", "cloud_run_config", "dns_cache_config", "config_connector_config", "gce_persistent_disk_csi_driver_config", "kalm_config", "gcp_filestore_csi_driver_config", "gke_backup_agent_config", "gcs_fuse_csi_driver_config", "stateful_ha_config", "ray_operator_config")
    ...
    ISTIO_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    KALM_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, http_load_balancing: _Optional[_Union[HttpLoadBalancing, _Mapping]] = ..., horizontal_pod_autoscaling: _Optional[_Union[HorizontalPodAutoscaling, _Mapping]] = ..., kubernetes_dashboard: _Optional[_Union[KubernetesDashboard, _Mapping]] = ..., network_policy_config: _Optional[_Union[NetworkPolicyConfig, _Mapping]] = ..., istio_config: _Optional[_Union[IstioConfig, _Mapping]] = ..., cloud_run_config: _Optional[_Union[CloudRunConfig, _Mapping]] = ..., dns_cache_config: _Optional[_Union[DnsCacheConfig, _Mapping]] = ..., config_connector_config: _Optional[_Union[ConfigConnectorConfig, _Mapping]] = ..., gce_persistent_disk_csi_driver_config: _Optional[_Union[GcePersistentDiskCsiDriverConfig, _Mapping]] = ..., kalm_config: _Optional[_Union[KalmConfig, _Mapping]] = ..., gcp_filestore_csi_driver_config: _Optional[_Union[GcpFilestoreCsiDriverConfig, _Mapping]] = ..., gke_backup_agent_config: _Optional[_Union[GkeBackupAgentConfig, _Mapping]] = ..., gcs_fuse_csi_driver_config: _Optional[_Union[GcsFuseCsiDriverConfig, _Mapping]] = ..., stateful_ha_config: _Optional[_Union[StatefulHAConfig, _Mapping]] = ..., ray_operator_config: _Optional[_Union[RayOperatorConfig, _Mapping]] = ...) -> None: ...
...
class KalmConfig(_message.Message):
    __slots__ = ("enabled",)
    ENABLED_FIELD_NUMBER: _ClassVar[int]
    enabled: bool
    def __init__(self, enabled: bool = ...) -> None: ...
...
class IstioConfig(_message.Message):
    __slots__ = ("disabled", "auth")
    class IstioAuthMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        AUTH_NONE: _ClassVar[IstioConfig.IstioAuthMode]
        AUTH_MUTUAL_TLS: _ClassVar[IstioConfig.IstioAuthMode]
    AUTH_NONE: IstioConfig.IstioAuthMode
    AUTH_MUTUAL_TLS: IstioConfig.IstioAuthMode
    DISABLED_FIELD_NUMBER: _ClassVar[int]
    AUTH_FIELD_NUMBER: _ClassVar[int]
    disabled: bool
    auth: IstioConfig.IstioAuthMode
    def __init__(self, disabled: bool = ..., auth: _Optional[_Union[IstioConfig.IstioAuthMode, str]] = ...) -> None: ...
...
class MasterAuthorizedNetworksConfig(_message.Message):
    __slots__ = ("enabled", "cidr_blocks", "gcp_public_cidrs_access_enabled")
    ...
    def __init__(self, enabled: bool = ..., cidr_blocks: _Optional[_Iterable[_Union[MasterAuthorizedNetworksConfig.CidrBlock, _Mapping]]] = ..., gcp_public_cidrs_access_enabled: bool = ...) -> None: ...
...
class IPAllocationPolicy(_message.Message):
    __slots__ = ("use_ip_aliases", "create_subnetwork", "subnetwork_name", "cluster_ipv4_cidr", "node_ipv4_cidr", "services_ipv4_cidr", "cluster_secondary_range_name", "services_secondary_range_name", "cluster_ipv4_cidr_block", "node_ipv4_cidr_block", "services_ipv4_cidr_block", "allow_route_overlap", "tpu_ipv4_cidr_block", "use_routes", "stack_type", "ipv6_access_type", "pod_cidr_overprovision_config", "subnet_ipv6_cidr_block", "services_ipv6_cidr_block", "additional_pod_ranges_config", "default_pod_ipv4_range_utilization")
    class StackType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        STACK_TYPE_UNSPECIFIED: _ClassVar[IPAllocationPolicy.StackType]
        IPV4: _ClassVar[IPAllocationPolicy.StackType]
        IPV4_IPV6: _ClassVar[IPAllocationPolicy.StackType]
    STACK_TYPE_UNSPECIFIED: IPAllocationPolicy.StackType
    IPV4: IPAllocationPolicy.StackType
    IPV4_IPV6: IPAllocationPolicy.StackType
    class IPv6AccessType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        IPV6_ACCESS_TYPE_UNSPECIFIED: _ClassVar[IPAllocationPolicy.IPv6AccessType]
        INTERNAL: _ClassVar[IPAllocationPolicy.IPv6AccessType]
        EXTERNAL: _ClassVar[IPAllocationPolicy.IPv6AccessType]
    IPV6_ACCESS_TYPE_UNSPECIFIED: IPAllocationPolicy.IPv6AccessType
    INTERNAL: IPAllocationPolicy.IPv6AccessType
    EXTERNAL: IPAllocationPolicy.IPv6AccessType
    ...
    ALLOW_ROUTE_OVERLAP_FIELD_NUMBER: _ClassVar[int]
    ...
    use_routes: bool
    stack_type: IPAllocationPolicy.StackType
    ipv6_access_type: IPAllocationPolicy.IPv6AccessType
    pod_cidr_overprovision_config: PodCIDROverprovisionConfig
    ...
    def __init__(self, use_ip_aliases: bool = ..., create_subnetwork: bool = ..., subnetwork_name: _Optional[str] = ..., cluster_ipv4_cidr: _Optional[str] = ..., node_ipv4_cidr: _Optional[str] = ..., services_ipv4_cidr: _Optional[str] = ..., cluster_secondary_range_name: _Optional[str] = ..., services_secondary_range_name: _Optional[str] = ..., cluster_ipv4_cidr_block: _Optional[str] = ..., node_ipv4_cidr_block: _Optional[str] = ..., services_ipv4_cidr_block: _Optional[str] = ..., allow_route_overlap: bool = ..., tpu_ipv4_cidr_block: _Optional[str] = ..., use_routes: bool = ..., stack_type: _Optional[_Union[IPAllocationPolicy.StackType, str]] = ..., ipv6_access_type: _Optional[_Union[IPAllocationPolicy.IPv6AccessType, str]] = ..., pod_cidr_overprovision_config: _Optional[_Union[PodCIDROverprovisionConfig, _Mapping]] = ..., subnet_ipv6_cidr_block: _Optional[str] = ..., services_ipv6_cidr_block: _Optional[str] = ..., additional_pod_ranges_config: _Optional[_Union[AdditionalPodRangesConfig, _Mapping]] = ..., default_pod_ipv4_range_utilization: _Optional[float] = ...) -> None: ...

class BinaryAuthorization(_message.Message):
    __slots__ = ("enabled", "evaluation_mode", "policy_bindings")
    class EvaluationMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        POLICY_BINDINGS: _ClassVar[BinaryAuthorization.EvaluationMode]
        POLICY_BINDINGS_AND_PROJECT_SINGLETON_POLICY_ENFORCE: _ClassVar[BinaryAuthorization.EvaluationMode]
    ...
    POLICY_BINDINGS: BinaryAuthorization.EvaluationMode
    POLICY_BINDINGS_AND_PROJECT_SINGLETON_POLICY_ENFORCE: BinaryAuthorization.EvaluationMode
    ...
    policy_bindings: _containers.RepeatedCompositeFieldContainer[BinaryAuthorization.PolicyBinding]
    def __init__(self, enabled: bool = ..., evaluation_mode: _Optional[_Union[BinaryAuthorization.EvaluationMode, str]] = ..., policy_bindings: _Optional[_Iterable[_Union[BinaryAuthorization.PolicyBinding, _Mapping]]] = ...) -> None: ...
...
class ClusterTelemetry(_message.Message):
    __slots__ = ("type",)
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        UNSPECIFIED: _ClassVar[ClusterTelemetry.Type]
        DISABLED: _ClassVar[ClusterTelemetry.Type]
        ENABLED: _ClassVar[ClusterTelemetry.Type]
        SYSTEM_ONLY: _ClassVar[ClusterTelemetry.Type]
    UNSPECIFIED: ClusterTelemetry.Type
    DISABLED: ClusterTelemetry.Type
    ENABLED: ClusterTelemetry.Type
    SYSTEM_ONLY: ClusterTelemetry.Type
    TYPE_FIELD_NUMBER: _ClassVar[int]
    type: ClusterTelemetry.Type
    def __init__(self, type: _Optional[_Union[ClusterTelemetry.Type, str]] = ...) -> None: ...

class Cluster(_message.Message):
    __slots__ = ("name", "description", "initial_node_count", "node_config", "master_auth", "logging_service", "monitoring_service", "network", "cluster_ipv4_cidr", "addons_config", "subnetwork", "node_pools", "locations", "enable_kubernetes_alpha", "enable_k8s_beta_apis", "resource_labels", "label_fingerprint", "legacy_abac", "network_policy", "ip_allocation_policy", "master_authorized_networks_config", "maintenance_policy", "binary_authorization", "pod_security_policy_config", "autoscaling", "network_config", "private_cluster", "master_ipv4_cidr_block", "default_max_pods_constraint", "resource_usage_export_config", "authenticator_groups_config", "private_cluster_config", "vertical_pod_autoscaling", "shielded_nodes", "release_channel", "workload_identity_config", "workload_certificates", "mesh_certificates", "workload_alts_config", "cost_management_config", "cluster_telemetry", "tpu_config", "notification_config", "confidential_nodes", "identity_service_config", "self_link", "zone", "endpoint", "initial_cluster_version", "current_master_version", "current_node_version", "create_time", "status", "status_message", "node_ipv4_cidr_size", "services_ipv4_cidr", "instance_group_urls", "current_node_count", "expire_time", "location", "enable_tpu", "tpu_ipv4_cidr_block", "database_encryption", "conditions", "master", "autopilot", "id", "node_pool_defaults", "logging_config", "monitoring_config", "node_pool_auto_config", "protect_config", "etag", "fleet", "security_posture_config", "enterprise_config", "secret_manager_config", "compliance_posture_config", "satisfies_pzs", "satisfies_pzi")
    ...
    PRIVATE_CLUSTER_FIELD_NUMBER: _ClassVar[int]
    MASTER_IPV4_CIDR_BLOCK_FIELD_NUMBER: _ClassVar[int]
    ...
    WORKLOAD_CERTIFICATES_FIELD_NUMBER: _ClassVar[int]
    MESH_CERTIFICATES_FIELD_NUMBER: _ClassVar[int]
    WORKLOAD_ALTS_CONFIG_FIELD_NUMBER: _ClassVar[int]
    COST_MANAGEMENT_CONFIG_FIELD_NUMBER: _ClassVar[int]
    CLUSTER_TELEMETRY_FIELD_NUMBER: _ClassVar[int]
    TPU_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    PROTECT_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    workload_certificates: WorkloadCertificates
    ...
    satisfies_pzs: bool
    satisfies_pzi: bool
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., initial_node_count: _Optional[int] = ..., node_config: _Optional[_Union[NodeConfig, _Mapping]] = ..., master_auth: _Optional[_Union[MasterAuth, _Mapping]] = ..., logging_service: _Optional[str] = ..., monitoring_service: _Optional[str] = ..., network: _Optional[str] = ..., cluster_ipv4_cidr: _Optional[str] = ..., addons_config: _Optional[_Union[AddonsConfig, _Mapping]] = ..., subnetwork: _Optional[str] = ..., node_pools: _Optional[_Iterable[_Union[NodePool, _Mapping]]] = ..., locations: _Optional[_Iterable[str]] = ..., enable_kubernetes_alpha: bool = ..., enable_k8s_beta_apis: _Optional[_Union[K8sBetaAPIConfig, _Mapping]] = ..., resource_labels: _Optional[_Mapping[str, str]] = ..., label_fingerprint: _Optional[str] = ..., legacy_abac: _Optional[_Union[LegacyAbac, _Mapping]] = ..., network_policy: _Optional[_Union[NetworkPolicy, _Mapping]] = ..., ip_allocation_policy: _Optional[_Union[IPAllocationPolicy, _Mapping]] = ..., master_authorized_networks_config: _Optional[_Union[MasterAuthorizedNetworksConfig, _Mapping]] = ..., maintenance_policy: _Optional[_Union[MaintenancePolicy, _Mapping]] = ..., binary_authorization: _Optional[_Union[BinaryAuthorization, _Mapping]] = ..., pod_security_policy_config: _Optional[_Union[PodSecurityPolicyConfig, _Mapping]] = ..., autoscaling: _Optional[_Union[ClusterAutoscaling, _Mapping]] = ..., network_config: _Optional[_Union[NetworkConfig, _Mapping]] = ..., private_cluster: bool = ..., master_ipv4_cidr_block: _Optional[str] = ..., default_max_pods_constraint: _Optional[_Union[MaxPodsConstraint, _Mapping]] = ..., resource_usage_export_config: _Optional[_Union[ResourceUsageExportConfig, _Mapping]] = ..., authenticator_groups_config: _Optional[_Union[AuthenticatorGroupsConfig, _Mapping]] = ..., private_cluster_config: _Optional[_Union[PrivateClusterConfig, _Mapping]] = ..., vertical_pod_autoscaling: _Optional[_Union[VerticalPodAutoscaling, _Mapping]] = ..., shielded_nodes: _Optional[_Union[ShieldedNodes, _Mapping]] = ..., release_channel: _Optional[_Union[ReleaseChannel, _Mapping]] = ..., workload_identity_config: _Optional[_Union[WorkloadIdentityConfig, _Mapping]] = ..., workload_certificates: _Optional[_Union[WorkloadCertificates, _Mapping]] = ..., mesh_certificates: _Optional[_Union[MeshCertificates, _Mapping]] = ..., workload_alts_config: _Optional[_Union[WorkloadALTSConfig, _Mapping]] = ..., cost_management_config: _Optional[_Union[CostManagementConfig, _Mapping]] = ..., cluster_telemetry: _Optional[_Union[ClusterTelemetry, _Mapping]] = ..., tpu_config: _Optional[_Union[TpuConfig, _Mapping]] = ..., notification_config: _Optional[_Union[NotificationConfig, _Mapping]] = ..., confidential_nodes: _Optional[_Union[ConfidentialNodes, _Mapping]] = ..., identity_service_config: _Optional[_Union[IdentityServiceConfig, _Mapping]] = ..., self_link: _Optional[str] = ..., zone: _Optional[str] = ..., endpoint: _Optional[str] = ..., initial_cluster_version: _Optional[str] = ..., current_master_version: _Optional[str] = ..., current_node_version: _Optional[str] = ..., create_time: _Optional[str] = ..., status: _Optional[_Union[Cluster.Status, str]] = ..., status_message: _Optional[str] = ..., node_ipv4_cidr_size: _Optional[int] = ..., services_ipv4_cidr: _Optional[str] = ..., instance_group_urls: _Optional[_Iterable[str]] = ..., current_node_count: _Optional[int] = ..., expire_time: _Optional[str] = ..., location: _Optional[str] = ..., enable_tpu: bool = ..., tpu_ipv4_cidr_block: _Optional[str] = ..., database_encryption: _Optional[_Union[DatabaseEncryption, _Mapping]] = ..., conditions: _Optional[_Iterable[_Union[StatusCondition, _Mapping]]] = ..., master: _Optional[_Union[Master, _Mapping]] = ..., autopilot: _Optional[_Union[Autopilot, _Mapping]] = ..., id: _Optional[str] = ..., node_pool_defaults: _Optional[_Union[NodePoolDefaults, _Mapping]] = ..., logging_config: _Optional[_Union[LoggingConfig, _Mapping]] = ..., monitoring_config: _Optional[_Union[MonitoringConfig, _Mapping]] = ..., node_pool_auto_config: _Optional[_Union[NodePoolAutoConfig, _Mapping]] = ..., protect_config: _Optional[_Union[ProtectConfig, _Mapping]] = ..., etag: _Optional[str] = ..., fleet: _Optional[_Union[Fleet, _Mapping]] = ..., security_posture_config: _Optional[_Union[SecurityPostureConfig, _Mapping]] = ..., enterprise_config: _Optional[_Union[EnterpriseConfig, _Mapping]] = ..., secret_manager_config: _Optional[_Union[SecretManagerConfig, _Mapping]] = ..., compliance_posture_config: _Optional[_Union[CompliancePostureConfig, _Mapping]] = ..., satisfies_pzs: bool = ..., satisfies_pzi: bool = ...) -> None: ...
...
class WorkloadConfig(_message.Message):
    __slots__ = ("audit_mode",)
    class Mode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        MODE_UNSPECIFIED: _ClassVar[WorkloadConfig.Mode]
        DISABLED: _ClassVar[WorkloadConfig.Mode]
        BASIC: _ClassVar[WorkloadConfig.Mode]
        BASELINE: _ClassVar[WorkloadConfig.Mode]
        RESTRICTED: _ClassVar[WorkloadConfig.Mode]
    MODE_UNSPECIFIED: WorkloadConfig.Mode
    DISABLED: WorkloadConfig.Mode
    BASIC: WorkloadConfig.Mode
    BASELINE: WorkloadConfig.Mode
    RESTRICTED: WorkloadConfig.Mode
    AUDIT_MODE_FIELD_NUMBER: _ClassVar[int]
    audit_mode: WorkloadConfig.Mode
    def __init__(self, audit_mode: _Optional[_Union[WorkloadConfig.Mode, str]] = ...) -> None: ...

class ProtectConfig(_message.Message):
    __slots__ = ("workload_config", "workload_vulnerability_mode")
    class WorkloadVulnerabilityMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        WORKLOAD_VULNERABILITY_MODE_UNSPECIFIED: _ClassVar[ProtectConfig.WorkloadVulnerabilityMode]
        DISABLED: _ClassVar[ProtectConfig.WorkloadVulnerabilityMode]
        BASIC: _ClassVar[ProtectConfig.WorkloadVulnerabilityMode]
    WORKLOAD_VULNERABILITY_MODE_UNSPECIFIED: ProtectConfig.WorkloadVulnerabilityMode
    DISABLED: ProtectConfig.WorkloadVulnerabilityMode
    BASIC: ProtectConfig.WorkloadVulnerabilityMode
    WORKLOAD_CONFIG_FIELD_NUMBER: _ClassVar[int]
    WORKLOAD_VULNERABILITY_MODE_FIELD_NUMBER: _ClassVar[int]
    workload_config: WorkloadConfig
    workload_vulnerability_mode: ProtectConfig.WorkloadVulnerabilityMode
    def __init__(self, workload_config: _Optional[_Union[WorkloadConfig, _Mapping]] = ..., workload_vulnerability_mode: _Optional[_Union[ProtectConfig.WorkloadVulnerabilityMode, str]] = ...) -> None: ...
...
class NodeConfigDefaults(_message.Message):
    __slots__ = ("gcfs_config", "logging_config", "containerd_config", "host_maintenance_policy", "node_kubelet_config")
    GCFS_CONFIG_FIELD_NUMBER: _ClassVar[int]
    LOGGING_CONFIG_FIELD_NUMBER: _ClassVar[int]
    CONTAINERD_CONFIG_FIELD_NUMBER: _ClassVar[int]
    HOST_MAINTENANCE_POLICY_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, gcfs_config: _Optional[_Union[GcfsConfig, _Mapping]] = ..., logging_config: _Optional[_Union[NodePoolLoggingConfig, _Mapping]] = ..., containerd_config: _Optional[_Union[ContainerdConfig, _Mapping]] = ..., host_maintenance_policy: _Optional[_Union[HostMaintenancePolicy, _Mapping]] = ..., node_kubelet_config: _Optional[_Union[NodeKubeletConfig, _Mapping]] = ...) -> None: ...

class NodePoolAutoConfig(_message.Message):
    __slots__ = ("network_tags", "resource_manager_tags", "node_kubelet_config")
    ...
    resource_manager_tags: ResourceManagerTags
    node_kubelet_config: NodeKubeletConfig
    def __init__(self, network_tags: _Optional[_Union[NetworkTags, _Mapping]] = ..., resource_manager_tags: _Optional[_Union[ResourceManagerTags, _Mapping]] = ..., node_kubelet_config: _Optional[_Union[NodeKubeletConfig, _Mapping]] = ...) -> None: ...

class ClusterUpdate(_message.Message):
    __slots__ = ("desired_node_version", "desired_monitoring_service", "desired_addons_config", "desired_node_pool_id", "desired_image_type", "desired_node_pool_autoscaling", "desired_locations", "desired_master_authorized_networks_config", "desired_pod_security_policy_config", "desired_cluster_autoscaling", "desired_binary_authorization", "desired_logging_service", "desired_resource_usage_export_config", "desired_vertical_pod_autoscaling", "desired_private_cluster_config", "desired_intra_node_visibility_config", "desired_default_snat_status", "desired_cluster_telemetry", "desired_release_channel", "private_cluster_config", "desired_tpu_config", "desired_l4ilb_subsetting_config", "desired_datapath_provider", "desired_private_ipv6_google_access", "desired_notification_config", "desired_master_version", "desired_gcfs_config", "desired_database_encryption", "desired_workload_identity_config", "desired_workload_certificates", "desired_mesh_certificates", "desired_workload_alts_config", "desired_shielded_nodes", "desired_cost_management_config", "desired_master", "desired_dns_config", "desired_service_external_ips_config", "desired_authenticator_groups_config", "desired_logging_config", "desired_monitoring_config", "desired_identity_service_config", "desired_enable_private_endpoint", "desired_node_pool_auto_config_network_tags", "desired_protect_config", "desired_gateway_api_config", "etag", "desired_node_pool_logging_config", "desired_fleet", "desired_stack_type", "additional_pod_ranges_config", "removed_additional_pod_ranges_config", "enable_k8s_beta_apis", "desired_security_posture_config", "desired_network_performance_config", "desired_enable_fqdn_network_policy", "desired_autopilot_workload_policy_config", "desired_k8s_beta_apis", "desired_host_maintenance_policy", "desired_containerd_config", "desired_enable_multi_networking", "desired_node_pool_auto_config_resource_manager_tags", "desired_in_transit_encryption_config", "desired_enable_cilium_clusterwide_network_policy", "desired_secret_manager_config", "desired_node_kubelet_config", "desired_node_pool_auto_config_kubelet_config")
    ...
    DESIRED_CLUSTER_TELEMETRY_FIELD_NUMBER: _ClassVar[int]
    DESIRED_RELEASE_CHANNEL_FIELD_NUMBER: _ClassVar[int]
    PRIVATE_CLUSTER_CONFIG_FIELD_NUMBER: _ClassVar[int]
    DESIRED_TPU_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    DESIRED_WORKLOAD_CERTIFICATES_FIELD_NUMBER: _ClassVar[int]
    DESIRED_MESH_CERTIFICATES_FIELD_NUMBER: _ClassVar[int]
    DESIRED_WORKLOAD_ALTS_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    DESIRED_PROTECT_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    DESIRED_HOST_MAINTENANCE_POLICY_FIELD_NUMBER: _ClassVar[int]
...
class ServerConfig(_message.Message):
    __slots__ = ("default_cluster_version", "valid_node_versions", "default_image_type", "valid_image_types", "valid_master_versions", "channels", "windows_version_maps")
    class ReleaseChannelConfig(_message.Message):
        __slots__ = ("channel", "default_version", "available_versions", "valid_versions")
        class AvailableVersion(_message.Message):
        ...
        default_version: str
        available_versions: _containers.RepeatedCompositeFieldContainer[ServerConfig.ReleaseChannelConfig.AvailableVersion]
        valid_versions: _containers.RepeatedScalarFieldContainer[str]
        def __init__(self, channel: _Optional[_Union[ReleaseChannel.Channel, str]] = ..., default_version: _Optional[str] = ..., available_versions: _Optional[_Iterable[_Union[ServerConfig.ReleaseChannelConfig.AvailableVersion, _Mapping]]] = ..., valid_versions: _Optional[_Iterable[str]] = ...) -> None: ...
    class WindowsVersionMapsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: str
        value: WindowsVersions
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[WindowsVersions, _Mapping]] = ...) -> None: ...
    ...
    WINDOWS_VERSION_MAPS_FIELD_NUMBER: _ClassVar[int]
...
class WindowsVersions(_message.Message):
    __slots__ = ("windows_versions",)
    class WindowsVersion(_message.Message):
        __slots__ = ("image_type", "os_version", "support_end_date")
        IMAGE_TYPE_FIELD_NUMBER: _ClassVar[int]
        OS_VERSION_FIELD_NUMBER: _ClassVar[int]
        ...
        def __init__(self, image_type: _Optional[str] = ..., os_version: _Optional[str] = ..., support_end_date: _Optional[_Union[_date_pb2.Date, _Mapping]] = ...) -> None: ...
    WINDOWS_VERSIONS_FIELD_NUMBER: _ClassVar[int]
    windows_versions: _containers.RepeatedCompositeFieldContainer[WindowsVersions.WindowsVersion]
    def __init__(self, windows_versions: _Optional[_Iterable[_Union[WindowsVersions.WindowsVersion, _Mapping]]] = ...) -> None: ...
...
class BlueGreenSettings(_message.Message):
    __slots__ = ("standard_rollout_policy", "autoscaled_rollout_policy", "node_pool_soak_duration")
    ...
    class AutoscaledRolloutPolicy(_message.Message):
        __slots__ = ()
        def __init__(self) -> None: ...
    STANDARD_ROLLOUT_POLICY_FIELD_NUMBER: _ClassVar[int]
    AUTOSCALED_ROLLOUT_POLICY_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, standard_rollout_policy: _Optional[_Union[BlueGreenSettings.StandardRolloutPolicy, _Mapping]] = ..., autoscaled_rollout_policy: _Optional[_Union[BlueGreenSettings.AutoscaledRolloutPolicy, _Mapping]] = ..., node_pool_soak_duration: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
    ...
    class UpdateInfo(_message.Message):
        ...
        class BlueGreenInfo(_message.Message):
            ...
            class Phase(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                ...
                WAITING_TO_DRAIN_BLUE_POOL: _ClassVar[NodePool.UpdateInfo.BlueGreenInfo.Phase]
            ...
            WAITING_TO_DRAIN_BLUE_POOL: NodePool.UpdateInfo.BlueGreenInfo.Phase
...
class AcceleratorConfig(_message.Message):
    __slots__ = ("accelerator_count", "accelerator_type", "gpu_partition_size", "max_time_shared_clients_per_gpu", "gpu_sharing_config", "gpu_driver_installation_config")
    ...
    MAX_TIME_SHARED_CLIENTS_PER_GPU_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, accelerator_count: _Optional[int] = ..., accelerator_type: _Optional[str] = ..., gpu_partition_size: _Optional[str] = ..., max_time_shared_clients_per_gpu: _Optional[int] = ..., gpu_sharing_config: _Optional[_Union[GPUSharingConfig, _Mapping]] = ..., gpu_driver_installation_config: _Optional[_Union[GPUDriverInstallationConfig, _Mapping]] = ...) -> None: ...
...
class WorkloadMetadataConfig(_message.Message):
    __slots__ = ("node_metadata", "mode")
    class NodeMetadata(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        UNSPECIFIED: _ClassVar[WorkloadMetadataConfig.NodeMetadata]
        SECURE: _ClassVar[WorkloadMetadataConfig.NodeMetadata]
        EXPOSE: _ClassVar[WorkloadMetadataConfig.NodeMetadata]
        GKE_METADATA_SERVER: _ClassVar[WorkloadMetadataConfig.NodeMetadata]
    UNSPECIFIED: WorkloadMetadataConfig.NodeMetadata
    SECURE: WorkloadMetadataConfig.NodeMetadata
    EXPOSE: WorkloadMetadataConfig.NodeMetadata
    GKE_METADATA_SERVER: WorkloadMetadataConfig.NodeMetadata
    class Mode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
    ...
    MODE_FIELD_NUMBER: _ClassVar[int]
    node_metadata: WorkloadMetadataConfig.NodeMetadata
    mode: WorkloadMetadataConfig.Mode
    def __init__(self, node_metadata: _Optional[_Union[WorkloadMetadataConfig.NodeMetadata, str]] = ..., mode: _Optional[_Union[WorkloadMetadataConfig.Mode, str]] = ...) -> None: ...
...
class Location(_message.Message):
    __slots__ = ("type", "name", "recommended")
    class LocationType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        ZONE: _ClassVar[Location.LocationType]
        REGION: _ClassVar[Location.LocationType]
    LOCATION_TYPE_UNSPECIFIED: Location.LocationType
    ZONE: Location.LocationType
    REGION: Location.LocationType
    TYPE_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    name: str
    recommended: bool
    def __init__(self, type: _Optional[_Union[Location.LocationType, str]] = ..., name: _Optional[str] = ..., recommended: bool = ...) -> None: ...
...
class WorkloadIdentityConfig(_message.Message):
    __slots__ = ("identity_namespace", "workload_pool", "identity_provider")
    IDENTITY_NAMESPACE_FIELD_NUMBER: _ClassVar[int]
    WORKLOAD_POOL_FIELD_NUMBER: _ClassVar[int]
    IDENTITY_PROVIDER_FIELD_NUMBER: _ClassVar[int]
    identity_namespace: str
    workload_pool: str
    identity_provider: str
    def __init__(self, identity_namespace: _Optional[str] = ..., workload_pool: _Optional[str] = ..., identity_provider: _Optional[str] = ...) -> None: ...

class WorkloadALTSConfig(_message.Message):
    __slots__ = ("enable_alts",)
    ENABLE_ALTS_FIELD_NUMBER: _ClassVar[int]
    enable_alts: _wrappers_pb2.BoolValue
    def __init__(self, enable_alts: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ...) -> None: ...

class WorkloadCertificates(_message.Message):
...
class TpuConfig(_message.Message):
    __slots__ = ("enabled", "use_service_networking", "ipv4_cidr_block")
    ENABLED_FIELD_NUMBER: _ClassVar[int]
    ...
    ipv4_cidr_block: str
    def __init__(self, enabled: bool = ..., use_service_networking: bool = ..., ipv4_cidr_block: _Optional[str] = ...) -> None: ...

class Master(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class AutopilotConversionStatus(_message.Message):
    __slots__ = ("state",)
    class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        STATE_UNSPECIFIED: _ClassVar[AutopilotConversionStatus.State]
        DONE: _ClassVar[AutopilotConversionStatus.State]
    STATE_UNSPECIFIED: AutopilotConversionStatus.State
    DONE: AutopilotConversionStatus.State
    STATE_FIELD_NUMBER: _ClassVar[int]
    state: AutopilotConversionStatus.State
    def __init__(self, state: _Optional[_Union[AutopilotConversionStatus.State, str]] = ...) -> None: ...

class Autopilot(_message.Message):
    __slots__ = ("enabled", "workload_policy_config", "conversion_status")
    ENABLED_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, enabled: bool = ..., workload_policy_config: _Optional[_Union[WorkloadPolicyConfig, _Mapping]] = ..., conversion_status: _Optional[_Union[AutopilotConversionStatus, _Mapping]] = ...) -> None: ...
...
class UpgradeAvailableEvent(_message.Message):
    __slots__ = ("version", "resource_type", "release_channel", "resource", "windows_versions")
    VERSION_FIELD_NUMBER: _ClassVar[int]
    RESOURCE_TYPE_FIELD_NUMBER: _ClassVar[int]
    RELEASE_CHANNEL_FIELD_NUMBER: _ClassVar[int]
    RESOURCE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, version: _Optional[str] = ..., resource_type: _Optional[_Union[UpgradeResourceType, str]] = ..., release_channel: _Optional[_Union[ReleaseChannel, _Mapping]] = ..., resource: _Optional[str] = ..., windows_versions: _Optional[_Union[WindowsVersions, _Mapping]] = ...) -> None: ...
...
class MonitoringComponentConfig(_message.Message):
    ...
    class Component(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        WORKLOADS: _ClassVar[MonitoringComponentConfig.Component]
    ...
    WORKLOADS: MonitoringComponentConfig.Component
...
class EnterpriseConfig(_message.Message):
    ...
    def __init__(self, cluster_tier: _Optional[_Union[EnterpriseConfig.ClusterTier, str]] = ...) -> None: ...
