...
- unique_list: Remove duplicates from a list while preserving order using object ids (default), hash or str
"""
...
# Functions
def unique_list(list_to_clean: list[Any], method: Literal["id", "hash", "str"] = "id") -> list[Any]:
    ...
    >>> s2 = {2, 3, 4}
    >>> s3 = {1, 2, 3}
    >>> unique_list([s1, s2, s1, s1, s3, s2, s3])
    [{1, 2, 3}, {2, 3, 4}, {1, 2, 3}]
