...
def get_new_supplier_message_and_category_or_redirect(supplier_id, framework_slug, redirect_endpoint):
    new_supplier_message = session.get(str(supplier_id))
...
def get_subject_or_redirect(new_supplier_message, supplier_id, framework_slug, redirect_endpoint):
...
def get_message_and_attachments_or_redirect(new_supplier_message, supplier_id, framework_slug, redirect_endpoint):
