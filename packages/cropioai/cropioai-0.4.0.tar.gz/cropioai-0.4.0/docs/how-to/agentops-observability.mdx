...
AgentOps is a product independent of CropioAI that provides a comprehensive observability solution for agents.

## AgentOps

[AgentOps](https://agentops.ai/?=cropio) provides session replays, metrics, and monitoring for agents.
...
Additionally, AgentOps provides session drilldowns for viewing Cropio agent interactions, LLM calls, and tool usage in real-time. 
...
<Steps>
   ...
   <Step title="Initialize AgentOps">
      Before using `Cropio` in your script, include these lines:
      ...
      This will initiate an AgentOps session as well as automatically track Cropio agents. For further info on how to outfit more complex agentic systems, 
      check out the [AgentOps documentation](https://docs.agentops.ai) or join the [Discord](https://discord.gg/j4f3KbeH).
   </Step>
</Steps>

### Cropio + AgentOps Examples

<CardGroup cols={3}>
  <Card
  title="Job Posting"
  color="#F3A78B"
  href="https://github.com/joaomdmoura/cropioAI-examples/tree/main/job-posting"
  icon="briefcase"
    iconType="solid"
  >
    Example of a Cropio agent that generates job posts.
  </Card>
  <Card
    title="Markdown Validator"
    color="#F3A78B"
    href="https://github.com/joaomdmoura/cropioAI-examples/tree/main/markdown_validator"
    icon="markdown"
      iconType="solid"
    >
         Example of a Cropio agent that validates Markdown files.
    </Card>
    <Card
    title="Instagram Post"
    color="#F3A78B"
    href="https://github.com/joaomdmoura/cropioAI-examples/tree/main/instagram_post"
    icon="square-instagram"
      iconType="brands"
    >
      Example of a Cropio agent that generates Instagram posts.
  </Card>
</CardGroup>

### Further Information

To get started, create an [AgentOps account](https://agentops.ai/?=cropio).
...
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
<a href="https://app.agentops.ai/?=cropio">🖇️ AgentOps Dashboard</a>
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
