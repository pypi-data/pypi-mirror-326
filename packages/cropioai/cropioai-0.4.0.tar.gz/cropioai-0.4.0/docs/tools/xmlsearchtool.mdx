...
To start using the XMLSearchTool, you must first install the cropioai_tools package. This can be easily done with the following command:
...
```python Code
from cropioai_tools import XMLSearchTool
