...
from cropioai.memory.storage.interface import Storage
...
class Mem0Storage(Storage):
    ...
    def __init__(self, type, cropio=None):
        super().__init__()
        ...
        self.cropio = cropio
        self.memory_config = cropio.memory_config
    ...
    def search(
        ...
        # automatically when the cropio is created.
    ...
    def _get_agent_name(self):
        agents = self.cropio.agents if self.cropio else []
