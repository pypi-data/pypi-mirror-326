...
from cropioai.utilities.converter import (
    Converter,
    ConverterError,
    convert_to_model,
...
from cropioai.utilities.pydantic_schema_parser import PydanticSchemaParser
...
def test_convert_to_model_with_invalid_json():
    ...
    with patch("cropioai.utilities.converter.handle_partial_json") as mock_handle:
...
def test_handle_partial_json_with_invalid_partial(mock_agent):
    ...
    with patch("cropioai.utilities.converter.convert_with_instructions") as mock_convert:
...
@patch("cropioai.utilities.converter.create_converter")
@patch("cropioai.utilities.converter.get_conversion_instructions")
...
def test_convert_with_instructions_failure(
    ...
    result = "Some text to convert"
    with patch("cropioai.utilities.converter.Printer") as mock_printer:
        output = convert_with_instructions(result, SimpleModel, False, mock_agent)
