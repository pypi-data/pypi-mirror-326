...
from cropioai.cli.authentication.utils import TokenManager, validate_token


class TestValidateToken(unittest.TestCase):
    @patch("cropioai.cli.authentication.utils.AsymmetricSignatureVerifier")
    @patch("cropioai.cli.authentication.utils.TokenVerifier")
...
class TestTokenManager(unittest.TestCase):
    ...
    @patch("cropioai.cli.authentication.utils.TokenManager.read_secure_file")
    @patch("cropioai.cli.authentication.utils.TokenManager.save_secure_file")
    @patch("cropioai.cli.authentication.utils.TokenManager._get_or_create_key")
    ...
    @patch("cropioai.cli.authentication.utils.Fernet.generate_key")
    @patch("cropioai.cli.authentication.utils.TokenManager.read_secure_file")
    @patch("cropioai.cli.authentication.utils.TokenManager.save_secure_file")
    ...
    @patch("cropioai.cli.authentication.utils.TokenManager.get_secure_storage_path")
    @patch("builtins.open", new_callable=unittest.mock.mock_open)
    @patch("cropioai.cli.authentication.utils.os.chmod")
