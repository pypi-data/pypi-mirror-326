...
import cropioai.utilities.events as events
...
from cropioai.tools.tool_calling import InstructorToolCalling, ToolCalling
from cropioai.tools.tool_usage_events import ToolUsageError, ToolUsageFinished
from cropioai.utilities import I18N, Converter, ConverterError, Printer
...
class ToolUsage:
    ...
    def use(
        ...
        if isinstance(tool, CropioStructuredTool) and tool.name == self._i18n.tools("add_image")["name"]:  # type: ignore
            try:
