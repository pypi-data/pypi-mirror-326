...
from cropioai.cli.authentication.token import get_auth_token
from cropioai.cli.plus_api import PlusAPI
from cropioai.telemetry.telemetry import Telemetry
...
class PlusAPIMixin:
    def __init__(self, telemetry):
        try:
            ...
            console.print(
                "Please sign up/login to CropioAI+ before using the CLI.",
                style="bold red",
            )
            console.print("Run 'cropioai signup' to sign up/login.", style="bold green")
            raise SystemExit
