...
from cropioai.agents.agent_builder.utilities.base_output_converter import OutputConverter
...
class Converter(OutputConverter):
    ...
    def _create_instructor(self):
        ...
        from cropioai.utilities import InternalInstructor
    ...
    def _convert_with_instructions(self):
        """Create a chain."""
        from cropioai.utilities.cropio_pydantic_output_parser import (
            CropioPydanticOutputParser,
        )

        parser = CropioPydanticOutputParser(pydantic_object=self.model)
