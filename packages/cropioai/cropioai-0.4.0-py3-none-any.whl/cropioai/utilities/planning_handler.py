...
"""Handles planning and coordination of cropio tasks."""
...
class CropioPlanner:
    """Plans and coordinates the execution of cropio tasks."""
    ...
    def _handle_cropio_planning(self) -> PlannerTaskPydanticOutput:
        """Handles the Cropio planning by creating detailed step-by-step plans for each task."""
    ...
    def _create_planning_agent(self) -> Agent:
        """Creates the planning agent for the cropio planning."""
        return Agent(
            ...
            backstory="Planner agent for cropio planning",
