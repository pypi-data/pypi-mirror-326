...
class CropioEvaluator:
    """
    A class to evaluate the performance of the agents in the cropio based on the tasks they have performed.

    Attributes:
        cropio (Cropio): The cropio of agents to evaluate.
    ...
    def __init__(self, cropio, openai_model_name: str):
        self.cropio = cropio
    ...
    def _setup_for_evaluating(self) -> None:
        """Sets up the cropio for evaluating."""
        for task in self.cropio.tasks:
    ...
    def _evaluator_agent(self):
        return Agent(
            ...
            backstory="Evaluator agent for cropio evaluation with precise capabilities to evaluate the performance of the agents in the cropio based on the tasks they have performed",
            verbose=False,
    ...
    def print_cropio_evaluation_result(self) -> None:
        """
        Prints the evaluation result of the cropio in a table.
        A Cropio with 2 tasks using the command cropioai test -n 3
        will output the following table:

                        Tasks Scores
                    (1-10 Higher is better)
        ┏━━━━━━━━━━━━━━━━━━━━┳━━━━━━━┳━━━━━━━┳━━━━━━━┳━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Tasks/Cropio/Agents  ┃ Run 1 ┃ Run 2 ┃ Run 3 ┃ Avg. Total ┃ Agents                       ┃
        ┡━━━━━━━━━━━━━━━━━━━━╇━━━━━━━╇━━━━━━━╇━━━━━━━╇━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┩
        ...
        cropio_average = sum(task_averages) / len(task_averages)

        table = Table(title="Tasks Scores \n (1-10 Higher is better)", box=HEAVY_EDGE)

        table.add_column("Tasks/Cropio/Agents", style="cyan")
        ...
        for task_index, task in enumerate(self.cropio.tasks):
            task_scores = [
            ...
            if task_index < len(self.cropio.tasks) - 1:
                table.add_row("", "", "", "", "", "")

        # Add Cropio and Execution Time rows
        cropio_scores = [
        ...
        table.add_row(
            "Cropio",
            *[f"{score:.2f}" for score in cropio_scores],
            f"{cropio_average:.1f}",
            "",
        )
    ...
    def evaluate(self, task_output: TaskOutput):
        """Evaluates the performance of the agents in the cropio based on the tasks they have performed."""
        current_task = None
        for task in self.cropio.tasks:
