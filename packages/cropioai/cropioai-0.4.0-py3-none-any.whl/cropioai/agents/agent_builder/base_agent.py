...
from cropioai.agents.agent_builder.utilities.base_token_process import TokenProcess
from cropioai.agents.cache.cache_handler import CacheHandler
...
from cropioai.utilities import I18N, Logger, RPMController
from cropioai.utilities.config import process_config

T = TypeVar("T", bound="BaseAgent")


class BaseAgent(ABC, BaseModel):
    """Abstract Base Class for all third party agents compatible with CropioAI.
    ...
    Attributes:
        ...
        agent_executor (InstanceOf): An instance of the CropioAgentExecutor class.
        llm (Any): Language model that will run the agent.
        cropio (Any): Cropio to which the agent belongs.
    ...
    Methods:
        ...
        get_delegation_tools(agents: List["BaseAgent"]):
            Abstract method to set the agents task tools for handling delegation and question asking to other agents in cropio.
    ...
    agent_executor: InstanceOf = Field(
        default=None, description="An instance of the CropioAgentExecutor class."
    )
    llm: Any = Field(
        default=None, description="Language model that will run the agent."
    )
    cropio: Any = Field(default=None, description="Cropio to which the agent belongs.")
