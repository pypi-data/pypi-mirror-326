...
from cropioai.flow.config import COLORS, NODE_STYLES
from cropioai.flow.html_template_handler import HTMLTemplateHandler
from cropioai.flow.legend_generator import generate_legend_items_html, get_legend_items
from cropioai.flow.path_utils import safe_path_join, validate_path_exists
from cropioai.flow.utils import calculate_node_levels
from cropioai.flow.visualization_utils import (
    add_edges,
...
class FlowPlot:
    ...
    def _generate_final_html(self, network_html):
        ...
        try:
            ...
            template_path = safe_path_join("assets", "cropioai_flow_visual_template.html", root=current_dir)
            logo_path = safe_path_join("assets", "cropioai_logo.svg", root=current_dir)
