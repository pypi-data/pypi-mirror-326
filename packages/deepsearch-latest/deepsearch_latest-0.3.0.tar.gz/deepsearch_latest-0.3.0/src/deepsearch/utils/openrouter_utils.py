...
@log_cancellation
async def split_and_extract_information(query: str, document: str, session=None,
                                        max_tokens: int = 9000, overlap: int = 1000):
    ...
    async def process_chunk(chunk):
        try:
            ...
            return await make_api_call(formatted_prompt, model="openai/o3-mini", session=session)
        except Exception as e:
