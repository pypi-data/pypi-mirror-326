...
def retrieve_and_analyze_documents(query: str, min_normalized_score: float = 0.25) -> Tuple[List[Dict[str, Any]], Dict[str, List[float]], Dict[str, List[float]], Dict[str, str]]:
    """
    ...
    try:
        ...
        search_results = pinecone.search_documents(query, min_score=0.2)
