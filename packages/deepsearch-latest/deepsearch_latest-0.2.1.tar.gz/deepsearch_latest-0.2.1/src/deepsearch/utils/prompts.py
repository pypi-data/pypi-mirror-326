...
If there is no information in the document that is relevant to the query, respond with:
[NO RELEVANT INFORMATION IN THIS FILE]
followed by a brief explanation of why the document's content is not relevant to the query.
