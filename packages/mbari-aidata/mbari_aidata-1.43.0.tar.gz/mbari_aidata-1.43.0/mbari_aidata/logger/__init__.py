...
class CustomLogger(Singleton):
    logger = None
    output_path = Path.home() / "mbari_aidata" / "logs"
...
def create_logger_file(prefix: str = "mbari_aidata"):
    """
    ...
    if ENVIRONMENT and ENVIRONMENT.upper() == "TESTING":
        ...
        log_path = Path.home() / "mbari_aidata" / "logs"
        ...
        try:
            ...
            log_path = Path(temp_dir) / "mbari_aidata" / "logs"
